...
(lib.課程 = function() {
	...
	// 圖層 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
...
(lib.男2做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("#", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 195;
	this.text_1.setTransform(111.5,184.8);
...
(lib.男2做答5 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(55.3,186.1,1.215,1.215);
...
(lib.男2做答4 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("縮小視窗", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 194;
	this.text_1.setTransform(108.9,181.2);
...
(lib.男2做答3 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("關機", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 185;
	this.text_1.setTransform(105.8,180.9);
...
(lib.男2做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("Windows", "bold 36px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 41;
	this.text_1.lineWidth = 180;
	this.text_1.setTransform(109.3,191.7);
...
(lib.女做答6 = function(mode,startPosition,loop) {
	...
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 195;
	this.text_1.setTransform(110.3,176.4);
...
(lib.女做答5 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(48.2,185.6,1.213,1.213);
...
(lib.女做答4 = function(mode,startPosition,loop) {
	...
	this.text_1 = new cjs.Text("換行", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 195;
	this.text_1.setTransform(109.7,180.6);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.text_1},{t:this.shape}]},15).wait(1));
...
(lib.女做答3 = function(mode,startPosition,loop) {
	...
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 185;
	this.text_1.setTransform(109.4,180.2);
...
(lib.女做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.text_1 = new cjs.Text("小畫家", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(109.9,180.1);
...
(lib.煙花點 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(10).call(this.frame_10).wait(3).call(this.frame_13).wait(2).call(this.frame_15).wait(3).call(this.frame_18).wait(24).call(this.frame_42));

	// Layer 1
	this.instance = new lib.煙火7("synched",0);
	this.instance.setTransform(23,40.4,0.467,0.467);

	this.instance_1 = new lib.煙火6("synched",0);
	this.instance_1.setTransform(23.3,-12.5,0.205,0.188,105);

	this.instance_2 = new lib.煙火6("synched",0);
	this.instance_2.setTransform(23.3,-12.5,0.205,0.188,75);

	this.instance_3 = new lib.煙火6("synched",0);
	this.instance_3.setTransform(23.3,-12.5,0.178,0.163,15);

	this.instance_4 = new lib.煙火6("synched",0);
	this.instance_4.setTransform(23.3,-12.5,0.191,0.175,-44.9);

	this.instance_5 = new lib.煙火6("synched",0);
	this.instance_5.setTransform(23.3,-12.5,0.191,0.175,-44.9);

	this.instance_6 = new lib.煙火6("synched",0);
	this.instance_6.setTransform(23.3,-12.5,0.173,0.159,-119.9);

	this.instance_7 = new lib.煙火6("synched",0);
	this.instance_7.setTransform(23.3,-12.5,0.2,0.184,180);

	this.instance_8 = new lib.煙火6("synched",0);
	this.instance_8.setTransform(23.3,-12.5,0.316,0.29,120);

	this.instance_9 = new lib.煙火6("synched",0);
	this.instance_9.setTransform(23.3,-12.5,0.263,0.241,150);

	this.instance_10 = new lib.煙火6("synched",0);
	this.instance_10.setTransform(23.3,-12.5,0.239,0.226,0,-179.9,180);

	this.instance_11 = new lib.煙火6("synched",0);
	this.instance_11.setTransform(23.3,-12.5,0.256,0.256,-149.9);

	this.instance_12 = new lib.煙火6("synched",0);
	this.instance_12.setTransform(23.3,-12.5,0.366,0.366,-119.9);

	this.instance_13 = new lib.煙火6("synched",0);
	this.instance_13.setTransform(23.3,-12.5,0.309,0.309,-74.9);

	this.instance_14 = new lib.煙火6("synched",0);
	this.instance_14.setTransform(23.3,-12.6,0.294,0.294,-14.9);

	this.instance_15 = new lib.煙火6("synched",0);
	this.instance_15.setTransform(23.3,-12.6,0.346,0.346,30);

	this.instance_16 = new lib.煙火6("synched",0);
	this.instance_16.setTransform(23.3,-12.5,0.246,0.226,45);

	this.instance_17 = new lib.煙火6("synched",0);
	this.instance_17.setTransform(23.3,-12.5,0.246,0.226,15);

	this.instance_18 = new lib.煙火6("synched",0);
	this.instance_18.setTransform(23.3,-12.5,0.214,0.196,-44.9);

	this.instance_19 = new lib.煙火6("synched",0);
	this.instance_19.setTransform(23.3,-12.5,0.229,0.211,-104.9);

	this.instance_20 = new lib.煙火6("synched",0);
	this.instance_20.setTransform(23.3,-12.5,0.229,0.211,-104.9);

	this.instance_21 = new lib.煙火6("synched",0);
	this.instance_21.setTransform(23.3,-12.5,0.209,0.191,0,-179.9,180);

	this.instance_22 = new lib.煙火6("synched",0);
	this.instance_22.setTransform(23.3,-12.5,0.241,0.221,120);

	this.instance_23 = new lib.煙火6("synched",0);
	this.instance_23.setTransform(23.3,-12.5,0.38,0.349,60);

	this.instance_24 = new lib.煙火6("synched",0);
	this.instance_24.setTransform(23.3,-12.5,0.317,0.291,90);

	this.instance_25 = new lib.煙火6("synched",0);
	this.instance_25.setTransform(23.3,-12.5,0.288,0.272,120);

	this.instance_26 = new lib.煙火6("synched",0);
	this.instance_26.setTransform(23.3,-12.5,0.308,0.308,150);

	this.instance_27 = new lib.煙火6("synched",0);
	this.instance_27.setTransform(23.3,-12.5,0.441,0.441,180);

	this.instance_28 = new lib.煙火6("synched",0);
	this.instance_28.setTransform(23.3,-12.5,0.371,0.371,-134.9);

	this.instance_29 = new lib.煙火6("synched",0);
	this.instance_29.setTransform(23.2,-12.5,0.354,0.354,-74.9);

	this.instance_30 = new lib.煙火6("synched",0);
	this.instance_30.setTransform(23.2,-12.5,0.416,0.416,-29.9);

	this.instance_31 = new lib.煙火6("synched",0);
	this.instance_31.setTransform(23.3,-13.3,0.343,0.315,135);

	this.instance_32 = new lib.煙火6("synched",0);
	this.instance_32.setTransform(23.3,-13.3,0.343,0.315,105);

	this.instance_33 = new lib.煙火6("synched",0);
	this.instance_33.setTransform(23.3,-13.3,0.298,0.274,45);

	this.instance_34 = new lib.煙火6("synched",0);
	this.instance_34.setTransform(23.3,-13.3,0.319,0.293,-14.9);

	this.instance_35 = new lib.煙火6("synched",0);
	this.instance_35.setTransform(23.3,-13.3,0.319,0.293,-14.9);

	this.instance_36 = new lib.煙火6("synched",0);
	this.instance_36.setTransform(23.3,-13.3,0.29,0.267,-89.9);

	this.instance_37 = new lib.煙火6("synched",0);
	this.instance_37.setTransform(23.3,-13.3,0.335,0.308,-149.9);

	this.instance_38 = new lib.煙火6("synched",0);
	this.instance_38.setTransform(23.3,-13.3,0.529,0.486,150);

	this.instance_39 = new lib.煙火6("synched",0);
	this.instance_39.setTransform(23.3,-13.3,0.441,0.405,-179.9);

	this.instance_40 = new lib.煙火6("synched",0);
	this.instance_40.setTransform(23.3,-13.3,0.401,0.379,-149.9);

	this.instance_41 = new lib.煙火6("synched",0);
	this.instance_41.setTransform(23.3,-13.3,0.429,0.429,-119.9);

	this.instance_42 = new lib.煙火6("synched",0);
	this.instance_42.setTransform(23.3,-13.3,0.614,0.614,-89.9);

	this.instance_43 = new lib.煙火6("synched",0);
	this.instance_43.setTransform(23.3,-13.3,0.517,0.517,-44.9);

	this.instance_44 = new lib.煙火6("synched",0);
	this.instance_44.setTransform(23.3,-13.3,0.493,0.493,15);

	this.instance_45 = new lib.煙火6("synched",0);
	this.instance_45.setTransform(23.3,-13.3,0.579,0.579,60);

	this.instance_46 = new lib.煙火6("synched",0);
	this.instance_46.setTransform(23.3,-13.3,0.413,0.379,75);

	this.instance_47 = new lib.煙火6("synched",0);
	this.instance_47.setTransform(23.3,-13.3,0.413,0.379,45);

	this.instance_48 = new lib.煙火6("synched",0);
	this.instance_48.setTransform(23.3,-13.3,0.359,0.329,-14.9);

	this.instance_49 = new lib.煙火6("synched",0);
	this.instance_49.setTransform(23.3,-13.3,0.384,0.353,-74.9);

	this.instance_50 = new lib.煙火6("synched",0);
	this.instance_50.setTransform(23.3,-13.3,0.384,0.353,-74.9);

	this.instance_51 = new lib.煙火6("synched",0);
	this.instance_51.setTransform(23.3,-13.3,0.349,0.321,-149.9);

	this.instance_52 = new lib.煙火6("synched",0);
	this.instance_52.setTransform(23.3,-13.3,0.403,0.37,150);

	this.instance_53 = new lib.煙火6("synched",0);
	this.instance_53.setTransform(23.3,-13.3,0.637,0.584,90);

	this.instance_54 = new lib.煙火6("synched",0);
	this.instance_54.setTransform(23.3,-13.3,0.531,0.487,120);

	this.instance_55 = new lib.煙火6("synched",0);
	this.instance_55.setTransform(23.3,-13.3,0.482,0.456,150);

	this.instance_56 = new lib.煙火6("synched",0);
	this.instance_56.setTransform(23.3,-13.3,0.517,0.517,-179.9);

	this.instance_57 = new lib.煙火6("synched",0);
	this.instance_57.setTransform(23.3,-13.3,0.738,0.738,-149.9);

	this.instance_58 = new lib.煙火6("synched",0);
	this.instance_58.setTransform(23.3,-13.3,0.622,0.622,-104.9);

	this.instance_59 = new lib.煙火6("synched",0);
	this.instance_59.setTransform(23.3,-13.3,0.593,0.593,-44.9);

	this.instance_60 = new lib.煙火6("synched",0);
	this.instance_60.setTransform(23.3,-13.3,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{y:40.4,x:23}}]}).to({state:[{t:this.instance,p:{y:34.4,x:23}}]},1).to({state:[{t:this.instance,p:{y:28.5,x:23}}]},1).to({state:[{t:this.instance,p:{y:22.5,x:23.1}}]},1).to({state:[{t:this.instance,p:{y:16.5,x:23.1}}]},1).to({state:[{t:this.instance,p:{y:10.5,x:23.1}}]},1).to({state:[{t:this.instance,p:{y:4.6,x:23.2}}]},1).to({state:[{t:this.instance,p:{y:-1.3,x:23.2}}]},1).to({state:[{t:this.instance,p:{y:-7.3,x:23.3}}]},1).to({state:[{t:this.instance,p:{y:-13.3,x:23.3}}]},1).to({state:[{t:this.instance_60},{t:this.instance_59},{t:this.instance_58},{t:this.instance_57},{t:this.instance_56},{t:this.instance_55},{t:this.instance_54},{t:this.instance_53},{t:this.instance_52},{t:this.instance_51},{t:this.instance_50},{t:this.instance_49},{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40},{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36},{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]},1).to({state:[]},24).wait(9));

	// Layer 1
	this.instance_61 = new lib.煙火7("synched",0);
	this.instance_61.setTransform(-23.1,60.4,0.467,0.467);

	this.instance_62 = new lib.煙火6("synched",0);
	this.instance_62.setTransform(-22.8,7.4,0.205,0.188,105);

	this.instance_63 = new lib.煙火6("synched",0);
	this.instance_63.setTransform(-22.8,7.4,0.205,0.188,75);

	this.instance_64 = new lib.煙火6("synched",0);
	this.instance_64.setTransform(-22.8,7.4,0.178,0.163,15);

	this.instance_65 = new lib.煙火6("synched",0);
	this.instance_65.setTransform(-22.8,7.4,0.191,0.175,-44.9);

	this.instance_66 = new lib.煙火6("synched",0);
	this.instance_66.setTransform(-22.8,7.4,0.191,0.175,-44.9);

	this.instance_67 = new lib.煙火6("synched",0);
	this.instance_67.setTransform(-22.8,7.4,0.173,0.159,-119.9);

	this.instance_68 = new lib.煙火6("synched",0);
	this.instance_68.setTransform(-22.8,7.4,0.2,0.184,180);

	this.instance_69 = new lib.煙火6("synched",0);
	this.instance_69.setTransform(-22.8,7.4,0.316,0.29,120);

	this.instance_70 = new lib.煙火6("synched",0);
	this.instance_70.setTransform(-22.8,7.4,0.263,0.241,150);

	this.instance_71 = new lib.煙火6("synched",0);
	this.instance_71.setTransform(-22.8,7.4,0.239,0.226,0,-179.9,180);

	this.instance_72 = new lib.煙火6("synched",0);
	this.instance_72.setTransform(-22.8,7.4,0.256,0.256,-149.9);

	this.instance_73 = new lib.煙火6("synched",0);
	this.instance_73.setTransform(-22.8,7.4,0.366,0.366,-119.9);

	this.instance_74 = new lib.煙火6("synched",0);
	this.instance_74.setTransform(-22.8,7.4,0.309,0.309,-74.9);

	this.instance_75 = new lib.煙火6("synched",0);
	this.instance_75.setTransform(-22.8,7.3,0.294,0.294,-14.9);

	this.instance_76 = new lib.煙火6("synched",0);
	this.instance_76.setTransform(-22.8,7.3,0.346,0.346,30);

	this.instance_77 = new lib.煙火6("synched",0);
	this.instance_77.setTransform(-22.8,7.4,0.246,0.226,45);

	this.instance_78 = new lib.煙火6("synched",0);
	this.instance_78.setTransform(-22.8,7.4,0.246,0.226,15);

	this.instance_79 = new lib.煙火6("synched",0);
	this.instance_79.setTransform(-22.8,7.4,0.214,0.196,-44.9);

	this.instance_80 = new lib.煙火6("synched",0);
	this.instance_80.setTransform(-22.8,7.4,0.229,0.211,-104.9);

	this.instance_81 = new lib.煙火6("synched",0);
	this.instance_81.setTransform(-22.8,7.4,0.229,0.211,-104.9);

	this.instance_82 = new lib.煙火6("synched",0);
	this.instance_82.setTransform(-22.8,7.4,0.209,0.191,0,-179.9,180);

	this.instance_83 = new lib.煙火6("synched",0);
	this.instance_83.setTransform(-22.8,7.4,0.241,0.221,120);

	this.instance_84 = new lib.煙火6("synched",0);
	this.instance_84.setTransform(-22.8,7.4,0.38,0.349,60);

	this.instance_85 = new lib.煙火6("synched",0);
	this.instance_85.setTransform(-22.8,7.4,0.317,0.291,90);

	this.instance_86 = new lib.煙火6("synched",0);
	this.instance_86.setTransform(-22.8,7.4,0.288,0.272,120);

	this.instance_87 = new lib.煙火6("synched",0);
	this.instance_87.setTransform(-22.8,7.4,0.308,0.308,150);

	this.instance_88 = new lib.煙火6("synched",0);
	this.instance_88.setTransform(-22.8,7.4,0.441,0.441,180);

	this.instance_89 = new lib.煙火6("synched",0);
	this.instance_89.setTransform(-22.8,7.4,0.371,0.371,-134.9);

	this.instance_90 = new lib.煙火6("synched",0);
	this.instance_90.setTransform(-22.9,7.4,0.354,0.354,-74.9);

	this.instance_91 = new lib.煙火6("synched",0);
	this.instance_91.setTransform(-22.9,7.4,0.416,0.416,-29.9);

	this.instance_92 = new lib.煙火6("synched",0);
	this.instance_92.setTransform(-22.8,6.6,0.343,0.315,135);

	this.instance_93 = new lib.煙火6("synched",0);
	this.instance_93.setTransform(-22.8,6.6,0.343,0.315,105);

	this.instance_94 = new lib.煙火6("synched",0);
	this.instance_94.setTransform(-22.8,6.6,0.298,0.274,45);

	this.instance_95 = new lib.煙火6("synched",0);
	this.instance_95.setTransform(-22.8,6.6,0.319,0.293,-14.9);

	this.instance_96 = new lib.煙火6("synched",0);
	this.instance_96.setTransform(-22.8,6.6,0.319,0.293,-14.9);

	this.instance_97 = new lib.煙火6("synched",0);
	this.instance_97.setTransform(-22.8,6.6,0.29,0.267,-89.9);

	this.instance_98 = new lib.煙火6("synched",0);
	this.instance_98.setTransform(-22.8,6.6,0.335,0.308,-149.9);

	this.instance_99 = new lib.煙火6("synched",0);
	this.instance_99.setTransform(-22.8,6.6,0.529,0.486,150);

	this.instance_100 = new lib.煙火6("synched",0);
	this.instance_100.setTransform(-22.8,6.6,0.441,0.405,-179.9);

	this.instance_101 = new lib.煙火6("synched",0);
	this.instance_101.setTransform(-22.8,6.6,0.401,0.379,-149.9);

	this.instance_102 = new lib.煙火6("synched",0);
	this.instance_102.setTransform(-22.8,6.6,0.429,0.429,-119.9);

	this.instance_103 = new lib.煙火6("synched",0);
	this.instance_103.setTransform(-22.8,6.6,0.614,0.614,-89.9);

	this.instance_104 = new lib.煙火6("synched",0);
	this.instance_104.setTransform(-22.8,6.6,0.517,0.517,-44.9);

	this.instance_105 = new lib.煙火6("synched",0);
	this.instance_105.setTransform(-22.8,6.6,0.493,0.493,15);

	this.instance_106 = new lib.煙火6("synched",0);
	this.instance_106.setTransform(-22.8,6.6,0.579,0.579,60);

	this.instance_107 = new lib.煙火6("synched",0);
	this.instance_107.setTransform(-22.8,6.6,0.413,0.379,75);

	this.instance_108 = new lib.煙火6("synched",0);
	this.instance_108.setTransform(-22.8,6.6,0.413,0.379,45);

	this.instance_109 = new lib.煙火6("synched",0);
	this.instance_109.setTransform(-22.8,6.6,0.359,0.329,-14.9);

	this.instance_110 = new lib.煙火6("synched",0);
	this.instance_110.setTransform(-22.8,6.6,0.384,0.353,-74.9);

	this.instance_111 = new lib.煙火6("synched",0);
	this.instance_111.setTransform(-22.8,6.6,0.384,0.353,-74.9);

	this.instance_112 = new lib.煙火6("synched",0);
	this.instance_112.setTransform(-22.8,6.6,0.349,0.321,-149.9);

	this.instance_113 = new lib.煙火6("synched",0);
	this.instance_113.setTransform(-22.8,6.6,0.403,0.37,150);

	this.instance_114 = new lib.煙火6("synched",0);
	this.instance_114.setTransform(-22.8,6.6,0.637,0.584,90);

	this.instance_115 = new lib.煙火6("synched",0);
	this.instance_115.setTransform(-22.8,6.6,0.531,0.487,120);

	this.instance_116 = new lib.煙火6("synched",0);
	this.instance_116.setTransform(-22.8,6.6,0.482,0.456,150);

	this.instance_117 = new lib.煙火6("synched",0);
	this.instance_117.setTransform(-22.8,6.6,0.517,0.517,-179.9);

	this.instance_118 = new lib.煙火6("synched",0);
	this.instance_118.setTransform(-22.8,6.6,0.738,0.738,-149.9);

	this.instance_119 = new lib.煙火6("synched",0);
	this.instance_119.setTransform(-22.8,6.6,0.622,0.622,-104.9);

	this.instance_120 = new lib.煙火6("synched",0);
	this.instance_120.setTransform(-22.8,6.6,0.593,0.593,-44.9);

	this.instance_121 = new lib.煙火6("synched",0);
	this.instance_121.setTransform(-22.8,6.6,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_61,p:{y:60.4,x:-23.1}}]},3).to({state:[{t:this.instance_61,p:{y:54.4,x:-23.1}}]},1).to({state:[{t:this.instance_61,p:{y:48.4,x:-23}}]},1).to({state:[{t:this.instance_61,p:{y:42.4,x:-23}}]},1).to({state:[{t:this.instance_61,p:{y:36.5,x:-22.9}}]},1).to({state:[{t:this.instance_61,p:{y:30.5,x:-22.9}}]},1).to({state:[{t:this.instance_61,p:{y:24.5,x:-22.9}}]},1).to({state:[{t:this.instance_61,p:{y:18.5,x:-22.8}}]},1).to({state:[{t:this.instance_61,p:{y:12.6,x:-22.8}}]},1).to({state:[{t:this.instance_61,p:{y:6.6,x:-22.8}}]},1).to({state:[{t:this.instance_121},{t:this.instance_120},{t:this.instance_119},{t:this.instance_118},{t:this.instance_117},{t:this.instance_116},{t:this.instance_115},{t:this.instance_114},{t:this.instance_113},{t:this.instance_112},{t:this.instance_111},{t:this.instance_110},{t:this.instance_109},{t:this.instance_108},{t:this.instance_107},{t:this.instance_106},{t:this.instance_105},{t:this.instance_104},{t:this.instance_103},{t:this.instance_102},{t:this.instance_101},{t:this.instance_100},{t:this.instance_99},{t:this.instance_98},{t:this.instance_97},{t:this.instance_96},{t:this.instance_95},{t:this.instance_94},{t:this.instance_93},{t:this.instance_92},{t:this.instance_91},{t:this.instance_90},{t:this.instance_89},{t:this.instance_88},{t:this.instance_87},{t:this.instance_86},{t:this.instance_85},{t:this.instance_84},{t:this.instance_83},{t:this.instance_82},{t:this.instance_81},{t:this.instance_80},{t:this.instance_79},{t:this.instance_78},{t:this.instance_77},{t:this.instance_76},{t:this.instance_75},{t:this.instance_74},{t:this.instance_73},{t:this.instance_72},{t:this.instance_71},{t:this.instance_70},{t:this.instance_69},{t:this.instance_68},{t:this.instance_67},{t:this.instance_66},{t:this.instance_65},{t:this.instance_64},{t:this.instance_63},{t:this.instance_62}]},1).to({state:[]},24).to({state:[]},2).wait(4));

	// Layer 1
	this.instance_122 = new lib.煙火7("synched",0);
	this.instance_122.setTransform(-62.9,58.4,0.467,0.467);

	this.instance_123 = new lib.煙火6("synched",0);
	this.instance_123.setTransform(-62.6,5.4,0.205,0.188,105);

	this.instance_124 = new lib.煙火6("synched",0);
	this.instance_124.setTransform(-62.6,5.4,0.205,0.188,75);

	this.instance_125 = new lib.煙火6("synched",0);
	this.instance_125.setTransform(-62.6,5.4,0.178,0.163,15);

	this.instance_126 = new lib.煙火6("synched",0);
	this.instance_126.setTransform(-62.6,5.4,0.191,0.175,-44.9);

	this.instance_127 = new lib.煙火6("synched",0);
	this.instance_127.setTransform(-62.6,5.4,0.191,0.175,-44.9);

	this.instance_128 = new lib.煙火6("synched",0);
	this.instance_128.setTransform(-62.6,5.4,0.173,0.159,-119.9);

	this.instance_129 = new lib.煙火6("synched",0);
	this.instance_129.setTransform(-62.6,5.4,0.2,0.184,180);

	this.instance_130 = new lib.煙火6("synched",0);
	this.instance_130.setTransform(-62.6,5.4,0.316,0.29,120);

	this.instance_131 = new lib.煙火6("synched",0);
	this.instance_131.setTransform(-62.6,5.4,0.263,0.241,150);

	this.instance_132 = new lib.煙火6("synched",0);
	this.instance_132.setTransform(-62.6,5.4,0.239,0.226,0,-179.9,180);

	this.instance_133 = new lib.煙火6("synched",0);
	this.instance_133.setTransform(-62.6,5.4,0.256,0.256,-149.9);

	this.instance_134 = new lib.煙火6("synched",0);
	this.instance_134.setTransform(-62.6,5.4,0.366,0.366,-119.9);

	this.instance_135 = new lib.煙火6("synched",0);
	this.instance_135.setTransform(-62.6,5.4,0.309,0.309,-74.9);

	this.instance_136 = new lib.煙火6("synched",0);
	this.instance_136.setTransform(-62.5,5.4,0.294,0.294,-14.9);

	this.instance_137 = new lib.煙火6("synched",0);
	this.instance_137.setTransform(-62.5,5.4,0.346,0.346,30);

	this.instance_138 = new lib.煙火6("synched",0);
	this.instance_138.setTransform(-62.6,5.4,0.246,0.226,45);

	this.instance_139 = new lib.煙火6("synched",0);
	this.instance_139.setTransform(-62.6,5.4,0.246,0.226,15);

	this.instance_140 = new lib.煙火6("synched",0);
	this.instance_140.setTransform(-62.6,5.4,0.214,0.196,-44.9);

	this.instance_141 = new lib.煙火6("synched",0);
	this.instance_141.setTransform(-62.6,5.4,0.229,0.211,-104.9);

	this.instance_142 = new lib.煙火6("synched",0);
	this.instance_142.setTransform(-62.6,5.4,0.229,0.211,-104.9);

	this.instance_143 = new lib.煙火6("synched",0);
	this.instance_143.setTransform(-62.6,5.4,0.209,0.191,0,-179.9,180);

	this.instance_144 = new lib.煙火6("synched",0);
	this.instance_144.setTransform(-62.6,5.4,0.241,0.221,120);

	this.instance_145 = new lib.煙火6("synched",0);
	this.instance_145.setTransform(-62.6,5.4,0.38,0.349,60);

	this.instance_146 = new lib.煙火6("synched",0);
	this.instance_146.setTransform(-62.6,5.4,0.317,0.291,90);

	this.instance_147 = new lib.煙火6("synched",0);
	this.instance_147.setTransform(-62.6,5.4,0.288,0.272,120);

	this.instance_148 = new lib.煙火6("synched",0);
	this.instance_148.setTransform(-62.6,5.4,0.308,0.308,150);

	this.instance_149 = new lib.煙火6("synched",0);
	this.instance_149.setTransform(-62.6,5.4,0.441,0.441,180);

	this.instance_150 = new lib.煙火6("synched",0);
	this.instance_150.setTransform(-62.6,5.4,0.371,0.371,-134.9);

	this.instance_151 = new lib.煙火6("synched",0);
	this.instance_151.setTransform(-62.6,5.4,0.354,0.354,-74.9);

	this.instance_152 = new lib.煙火6("synched",0);
	this.instance_152.setTransform(-62.6,5.4,0.416,0.416,-29.9);

	this.instance_153 = new lib.煙火6("synched",0);
	this.instance_153.setTransform(-62.6,4.7,0.343,0.315,135);

	this.instance_154 = new lib.煙火6("synched",0);
	this.instance_154.setTransform(-62.6,4.7,0.343,0.315,105);

	this.instance_155 = new lib.煙火6("synched",0);
	this.instance_155.setTransform(-62.6,4.7,0.298,0.274,45);

	this.instance_156 = new lib.煙火6("synched",0);
	this.instance_156.setTransform(-62.6,4.7,0.319,0.293,-14.9);

	this.instance_157 = new lib.煙火6("synched",0);
	this.instance_157.setTransform(-62.6,4.7,0.319,0.293,-14.9);

	this.instance_158 = new lib.煙火6("synched",0);
	this.instance_158.setTransform(-62.6,4.7,0.29,0.267,-89.9);

	this.instance_159 = new lib.煙火6("synched",0);
	this.instance_159.setTransform(-62.6,4.7,0.335,0.308,-149.9);

	this.instance_160 = new lib.煙火6("synched",0);
	this.instance_160.setTransform(-62.6,4.7,0.529,0.486,150);

	this.instance_161 = new lib.煙火6("synched",0);
	this.instance_161.setTransform(-62.6,4.7,0.441,0.405,-179.9);

	this.instance_162 = new lib.煙火6("synched",0);
	this.instance_162.setTransform(-62.6,4.7,0.401,0.379,-149.9);

	this.instance_163 = new lib.煙火6("synched",0);
	this.instance_163.setTransform(-62.6,4.7,0.429,0.429,-119.9);

	this.instance_164 = new lib.煙火6("synched",0);
	this.instance_164.setTransform(-62.6,4.7,0.614,0.614,-89.9);

	this.instance_165 = new lib.煙火6("synched",0);
	this.instance_165.setTransform(-62.6,4.7,0.517,0.517,-44.9);

	this.instance_166 = new lib.煙火6("synched",0);
	this.instance_166.setTransform(-62.5,4.7,0.493,0.493,15);

	this.instance_167 = new lib.煙火6("synched",0);
	this.instance_167.setTransform(-62.5,4.7,0.579,0.579,60);

	this.instance_168 = new lib.煙火6("synched",0);
	this.instance_168.setTransform(-62.6,4.7,0.413,0.379,75);

	this.instance_169 = new lib.煙火6("synched",0);
	this.instance_169.setTransform(-62.6,4.7,0.413,0.379,45);

	this.instance_170 = new lib.煙火6("synched",0);
	this.instance_170.setTransform(-62.6,4.7,0.359,0.329,-14.9);

	this.instance_171 = new lib.煙火6("synched",0);
	this.instance_171.setTransform(-62.6,4.7,0.384,0.353,-74.9);

	this.instance_172 = new lib.煙火6("synched",0);
	this.instance_172.setTransform(-62.6,4.7,0.384,0.353,-74.9);

	this.instance_173 = new lib.煙火6("synched",0);
	this.instance_173.setTransform(-62.6,4.7,0.349,0.321,-149.9);

	this.instance_174 = new lib.煙火6("synched",0);
	this.instance_174.setTransform(-62.6,4.7,0.403,0.37,150);

	this.instance_175 = new lib.煙火6("synched",0);
	this.instance_175.setTransform(-62.6,4.7,0.637,0.584,90);

	this.instance_176 = new lib.煙火6("synched",0);
	this.instance_176.setTransform(-62.6,4.7,0.531,0.487,120);

	this.instance_177 = new lib.煙火6("synched",0);
	this.instance_177.setTransform(-62.6,4.7,0.482,0.456,150);

	this.instance_178 = new lib.煙火6("synched",0);
	this.instance_178.setTransform(-62.6,4.7,0.517,0.517,-179.9);

	this.instance_179 = new lib.煙火6("synched",0);
	this.instance_179.setTransform(-62.6,4.7,0.738,0.738,-149.9);

	this.instance_180 = new lib.煙火6("synched",0);
	this.instance_180.setTransform(-62.6,4.7,0.622,0.622,-104.9);

	this.instance_181 = new lib.煙火6("synched",0);
	this.instance_181.setTransform(-62.6,4.6,0.593,0.593,-44.9);

	this.instance_182 = new lib.煙火6("synched",0);
	this.instance_182.setTransform(-62.6,4.6,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_122,p:{x:-62.9,y:58.4}}]},8).to({state:[{t:this.instance_122,p:{x:-62.8,y:52.4}}]},1).to({state:[{t:this.instance_122,p:{x:-62.8,y:46.5}}]},1).to({state:[{t:this.instance_122,p:{x:-62.7,y:40.5}}]},1).to({state:[{t:this.instance_122,p:{x:-62.7,y:34.5}}]},1).to({state:[{t:this.instance_122,p:{x:-62.7,y:28.5}}]},1).to({state:[{t:this.instance_122,p:{x:-62.6,y:22.6}}]},1).to({state:[{t:this.instance_122,p:{x:-62.6,y:16.6}}]},1).to({state:[{t:this.instance_122,p:{x:-62.5,y:10.6}}]},1).to({state:[{t:this.instance_122,p:{x:-62.5,y:4.7}}]},1).to({state:[{t:this.instance_182},{t:this.instance_181},{t:this.instance_180},{t:this.instance_179},{t:this.instance_178},{t:this.instance_177},{t:this.instance_176},{t:this.instance_175},{t:this.instance_174},{t:this.instance_173},{t:this.instance_172},{t:this.instance_171},{t:this.instance_170},{t:this.instance_169},{t:this.instance_168},{t:this.instance_167},{t:this.instance_166},{t:this.instance_165},{t:this.instance_164},{t:this.instance_163},{t:this.instance_162},{t:this.instance_161},{t:this.instance_160},{t:this.instance_159},{t:this.instance_158},{t:this.instance_157},{t:this.instance_156},{t:this.instance_155},{t:this.instance_154},{t:this.instance_153},{t:this.instance_152},{t:this.instance_151},{t:this.instance_150},{t:this.instance_149},{t:this.instance_148},{t:this.instance_147},{t:this.instance_146},{t:this.instance_145},{t:this.instance_144},{t:this.instance_143},{t:this.instance_142},{t:this.instance_141},{t:this.instance_140},{t:this.instance_139},{t:this.instance_138},{t:this.instance_137},{t:this.instance_136},{t:this.instance_135},{t:this.instance_134},{t:this.instance_133},{t:this.instance_132},{t:this.instance_131},{t:this.instance_130},{t:this.instance_129},{t:this.instance_128},{t:this.instance_127},{t:this.instance_126},{t:this.instance_125},{t:this.instance_124},{t:this.instance_123}]},1).to({state:[]},24).wait(1));

	// Layer 1
	this.instance_183 = new lib.煙火7("synched",0);
	this.instance_183.setTransform(61.6,59.9,0.467,0.467);

	this.instance_184 = new lib.煙火6("synched",0);
	this.instance_184.setTransform(61.9,6.9,0.205,0.188,105);

	this.instance_185 = new lib.煙火6("synched",0);
	this.instance_185.setTransform(61.9,6.9,0.205,0.188,75);

	this.instance_186 = new lib.煙火6("synched",0);
	this.instance_186.setTransform(61.9,6.9,0.178,0.163,15);

	this.instance_187 = new lib.煙火6("synched",0);
	this.instance_187.setTransform(61.9,6.9,0.191,0.175,-44.9);

	this.instance_188 = new lib.煙火6("synched",0);
	this.instance_188.setTransform(61.9,6.9,0.191,0.175,-44.9);

	this.instance_189 = new lib.煙火6("synched",0);
	this.instance_189.setTransform(61.9,6.9,0.173,0.159,-119.9);

	this.instance_190 = new lib.煙火6("synched",0);
	this.instance_190.setTransform(61.9,6.9,0.2,0.184,180);

	this.instance_191 = new lib.煙火6("synched",0);
	this.instance_191.setTransform(61.9,6.9,0.316,0.29,120);

	this.instance_192 = new lib.煙火6("synched",0);
	this.instance_192.setTransform(61.9,6.9,0.263,0.241,150);

	this.instance_193 = new lib.煙火6("synched",0);
	this.instance_193.setTransform(61.9,6.9,0.239,0.226,0,-179.9,180);

	this.instance_194 = new lib.煙火6("synched",0);
	this.instance_194.setTransform(61.9,6.9,0.256,0.256,-149.9);

	this.instance_195 = new lib.煙火6("synched",0);
	this.instance_195.setTransform(61.9,6.9,0.366,0.366,-119.9);

	this.instance_196 = new lib.煙火6("synched",0);
	this.instance_196.setTransform(61.9,6.9,0.309,0.309,-74.9);

	this.instance_197 = new lib.煙火6("synched",0);
	this.instance_197.setTransform(62,6.9,0.294,0.294,-14.9);

	this.instance_198 = new lib.煙火6("synched",0);
	this.instance_198.setTransform(62,6.9,0.346,0.346,30);

	this.instance_199 = new lib.煙火6("synched",0);
	this.instance_199.setTransform(61.9,6.9,0.246,0.226,45);

	this.instance_200 = new lib.煙火6("synched",0);
	this.instance_200.setTransform(61.9,6.9,0.246,0.226,15);

	this.instance_201 = new lib.煙火6("synched",0);
	this.instance_201.setTransform(61.9,6.9,0.214,0.196,-44.9);

	this.instance_202 = new lib.煙火6("synched",0);
	this.instance_202.setTransform(61.9,6.9,0.229,0.211,-104.9);

	this.instance_203 = new lib.煙火6("synched",0);
	this.instance_203.setTransform(61.9,6.9,0.229,0.211,-104.9);

	this.instance_204 = new lib.煙火6("synched",0);
	this.instance_204.setTransform(61.9,6.9,0.209,0.191,0,-179.9,180);

	this.instance_205 = new lib.煙火6("synched",0);
	this.instance_205.setTransform(61.9,6.9,0.241,0.221,120);

	this.instance_206 = new lib.煙火6("synched",0);
	this.instance_206.setTransform(61.9,6.9,0.38,0.349,60);

	this.instance_207 = new lib.煙火6("synched",0);
	this.instance_207.setTransform(61.9,6.9,0.317,0.291,90);

	this.instance_208 = new lib.煙火6("synched",0);
	this.instance_208.setTransform(61.9,6.9,0.288,0.272,120);

	this.instance_209 = new lib.煙火6("synched",0);
	this.instance_209.setTransform(61.9,6.9,0.308,0.308,150);

	this.instance_210 = new lib.煙火6("synched",0);
	this.instance_210.setTransform(61.9,6.9,0.441,0.441,180);

	this.instance_211 = new lib.煙火6("synched",0);
	this.instance_211.setTransform(61.9,6.9,0.371,0.371,-134.9);

	this.instance_212 = new lib.煙火6("synched",0);
	this.instance_212.setTransform(61.9,6.9,0.354,0.354,-74.9);

	this.instance_213 = new lib.煙火6("synched",0);
	this.instance_213.setTransform(61.9,6.9,0.416,0.416,-29.9);

	this.instance_214 = new lib.煙火6("synched",0);
	this.instance_214.setTransform(61.9,6.2,0.343,0.315,135);

	this.instance_215 = new lib.煙火6("synched",0);
	this.instance_215.setTransform(61.9,6.2,0.343,0.315,105);

	this.instance_216 = new lib.煙火6("synched",0);
	this.instance_216.setTransform(61.9,6.2,0.298,0.274,45);

	this.instance_217 = new lib.煙火6("synched",0);
	this.instance_217.setTransform(61.9,6.2,0.319,0.293,-14.9);

	this.instance_218 = new lib.煙火6("synched",0);
	this.instance_218.setTransform(61.9,6.2,0.319,0.293,-14.9);

	this.instance_219 = new lib.煙火6("synched",0);
	this.instance_219.setTransform(61.9,6.2,0.29,0.267,-89.9);

	this.instance_220 = new lib.煙火6("synched",0);
	this.instance_220.setTransform(61.9,6.2,0.335,0.308,-149.9);

	this.instance_221 = new lib.煙火6("synched",0);
	this.instance_221.setTransform(61.9,6.2,0.529,0.486,150);

	this.instance_222 = new lib.煙火6("synched",0);
	this.instance_222.setTransform(61.9,6.2,0.441,0.405,-179.9);

	this.instance_223 = new lib.煙火6("synched",0);
	this.instance_223.setTransform(61.9,6.2,0.401,0.379,-149.9);

	this.instance_224 = new lib.煙火6("synched",0);
	this.instance_224.setTransform(61.9,6.2,0.429,0.429,-119.9);

	this.instance_225 = new lib.煙火6("synched",0);
	this.instance_225.setTransform(61.9,6.2,0.614,0.614,-89.9);

	this.instance_226 = new lib.煙火6("synched",0);
	this.instance_226.setTransform(61.9,6.2,0.517,0.517,-44.9);

	this.instance_227 = new lib.煙火6("synched",0);
	this.instance_227.setTransform(62,6.2,0.493,0.493,15);

	this.instance_228 = new lib.煙火6("synched",0);
	this.instance_228.setTransform(62,6.2,0.579,0.579,60);

	this.instance_229 = new lib.煙火6("synched",0);
	this.instance_229.setTransform(61.9,6.2,0.413,0.379,75);

	this.instance_230 = new lib.煙火6("synched",0);
	this.instance_230.setTransform(61.9,6.2,0.413,0.379,45);

	this.instance_231 = new lib.煙火6("synched",0);
	this.instance_231.setTransform(61.9,6.2,0.359,0.329,-14.9);

	this.instance_232 = new lib.煙火6("synched",0);
	this.instance_232.setTransform(61.9,6.2,0.384,0.353,-74.9);

	this.instance_233 = new lib.煙火6("synched",0);
	this.instance_233.setTransform(61.9,6.2,0.384,0.353,-74.9);

	this.instance_234 = new lib.煙火6("synched",0);
	this.instance_234.setTransform(61.9,6.2,0.349,0.321,-149.9);

	this.instance_235 = new lib.煙火6("synched",0);
	this.instance_235.setTransform(61.9,6.2,0.403,0.37,150);

	this.instance_236 = new lib.煙火6("synched",0);
	this.instance_236.setTransform(61.9,6.2,0.637,0.584,90);

	this.instance_237 = new lib.煙火6("synched",0);
	this.instance_237.setTransform(61.9,6.2,0.531,0.487,120);

	this.instance_238 = new lib.煙火6("synched",0);
	this.instance_238.setTransform(61.9,6.2,0.482,0.456,150);

	this.instance_239 = new lib.煙火6("synched",0);
	this.instance_239.setTransform(61.9,6.2,0.517,0.517,-179.9);

	this.instance_240 = new lib.煙火6("synched",0);
	this.instance_240.setTransform(61.9,6.2,0.738,0.738,-149.9);

	this.instance_241 = new lib.煙火6("synched",0);
	this.instance_241.setTransform(61.9,6.2,0.622,0.622,-104.9);

	this.instance_242 = new lib.煙火6("synched",0);
	this.instance_242.setTransform(61.9,6.1,0.593,0.593,-44.9);

	this.instance_243 = new lib.煙火6("synched",0);
	this.instance_243.setTransform(61.9,6.1,0.697,0.697);

	this.rest = new lib.重播鈕();
	this.rest.setTransform(-1.5,29.7,0.296,0.296);
	new cjs.ButtonHelper(this.rest, 0, 1, 2, false, new lib.重播鈕(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_183,p:{y:59.9,x:61.6}}]},5).to({state:[{t:this.instance_183,p:{y:53.9,x:61.6}}]},1).to({state:[{t:this.instance_183,p:{y:48,x:61.7}}]},1).to({state:[{t:this.instance_183,p:{y:42,x:61.7}}]},1).to({state:[{t:this.instance_183,p:{y:36,x:61.8}}]},1).to({state:[{t:this.instance_183,p:{y:30,x:61.8}}]},1).to({state:[{t:this.instance_183,p:{y:24.1,x:61.8}}]},1).to({state:[{t:this.instance_183,p:{y:18.1,x:61.9}}]},1).to({state:[{t:this.instance_183,p:{y:12.1,x:61.9}}]},1).to({state:[{t:this.instance_183,p:{y:6.2,x:62}}]},1).to({state:[{t:this.instance_243},{t:this.instance_242},{t:this.instance_241},{t:this.instance_240},{t:this.instance_239},{t:this.instance_238},{t:this.instance_237},{t:this.instance_236},{t:this.instance_235},{t:this.instance_234},{t:this.instance_233},{t:this.instance_232},{t:this.instance_231},{t:this.instance_230},{t:this.instance_229},{t:this.instance_228},{t:this.instance_227},{t:this.instance_226},{t:this.instance_225},{t:this.instance_224},{t:this.instance_223},{t:this.instance_222},{t:this.instance_221},{t:this.instance_220},{t:this.instance_219},{t:this.instance_218},{t:this.instance_217},{t:this.instance_216},{t:this.instance_215},{t:this.instance_214},{t:this.instance_213},{t:this.instance_212},{t:this.instance_211},{t:this.instance_210},{t:this.instance_209},{t:this.instance_208},{t:this.instance_207},{t:this.instance_206},{t:this.instance_205},{t:this.instance_204},{t:this.instance_203},{t:this.instance_202},{t:this.instance_201},{t:this.instance_200},{t:this.instance_199},{t:this.instance_198},{t:this.instance_197},{t:this.instance_196},{t:this.instance_195},{t:this.instance_194},{t:this.instance_193},{t:this.instance_192},{t:this.instance_191},{t:this.instance_190},{t:this.instance_189},{t:this.instance_188},{t:this.instance_187},{t:this.instance_186},{t:this.instance_185},{t:this.instance_184}]},1).to({state:[]},24).to({state:[{t:this.rest}]},3).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(21.6,39,2.8,2.8);
...
(lib.男做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("ㄉ", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 195;
	this.text_1.setTransform(109.1,182);
...
(lib.男做答5 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(57.4,183.7,1.247,1.247);
...
(lib.男做答4 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("空一格", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 184;
	this.text_1.setTransform(106.9,180.9);
...
(lib.男做答3 = function(mode,startPosition,loop) {
	...
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 185;
	this.text_1.setTransform(105.8,181.6);
...
(lib.男做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("WordPad", "bold 36px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 41;
	this.text_1.lineWidth = 178;
	this.text_1.setTransform(108.2,192.1);
...
(lib.題目 = function(mode,startPosition,loop) {
	...
	// 圖層 1
	this.text = new cjs.Text("下面哪個是文書軟體？", "bold 48px Microsoft JhengHei", "#FFFF00");
	this.text.lineHeight = 53;
	this.text.lineWidth = 508;
	this.text.setTransform(-21.7,-266.4);

	this.instance = new lib.img1();
	this.instance.setTransform(126.2,-251.8);

	this.text_1 = new cjs.Text("按一下　　，可以做什", "bold 48px Microsoft JhengHei", "#FFFF00");
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 508;
	this.text_1.setTransform(-21.7,-266.4);

	this.instance_1 = new lib.img2();
	this.instance_1.setTransform(123.7,-251.2);

	this.instance_2 = new lib.img3();
	this.instance_2.setTransform(31.4,-253.4);

	this.instance_3 = new lib.img6();
	this.instance_3.setTransform(174.6,-254);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.text,p:{y:-266.4,text:"下面哪個是文書軟體？",lineWidth:508,x:-21.7}}]},1).to({state:[{t:this.text_1,p:{text:"按一下　　，可以做什",lineWidth:508,x:-21.7}},{t:this.text,p:{y:-214.7,text:"麼？",lineWidth:508,x:-21.7}},{t:this.instance}]},1).to({state:[{t:this.text_1,p:{text:"按一下　　　  (空白鍵)",lineWidth:515,x:-21.7}},{t:this.text,p:{y:-209.8,text:"可以做什麼？",lineWidth:500,x:-21.7}},{t:this.instance_1}]},1).to({state:[{t:this.text_1,p:{text:"按住哪個鍵，可以輸入",lineWidth:500,x:-20.4}},{t:this.text,p:{y:-214.7,text:"大寫英文？",lineWidth:492,x:-20.4}}]},1).to({state:[{t:this.text_1,p:{text:"按　　 +　，可輸入哪",lineWidth:500,x:-21.7}},{t:this.text,p:{y:-211.5,text:"個符號？",lineWidth:500,x:-21.7}},{t:this.instance_3},{t:this.instance_2}]},1).to({state:[]},1).wait(1));

	// 圖層 2
	this.instance_4 = new lib.男2做答1("single",0);
	this.instance_4.setTransform(365,-82.8,0.9,0.9);

	this.instance_5 = new lib.男做答1("single",0);
	this.instance_5.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_6 = new lib.女做答1("single",0);
	this.instance_6.setTransform(-92.4,-81.1,0.9,0.9);

	this.instance_7 = new lib.男2做答2("single",14);
	this.instance_7.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_8 = new lib.男做答2("single",14);
	this.instance_8.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_9 = new lib.女做答2("single",15);
	this.instance_9.setTransform(-92.4,-82.9,0.9,0.9);

	this.instance_10 = new lib.男2做答3("single",14);
	this.instance_10.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_11 = new lib.男做答3("single",14);
	this.instance_11.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_12 = new lib.女做答3("single",15);
	this.instance_12.setTransform(-92.4,-82.9,0.9,0.9);

	this.instance_13 = new lib.男2做答4("single",14);
	this.instance_13.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_14 = new lib.男做答4("single",14);
	this.instance_14.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_15 = new lib.女做答4("single",15);
	this.instance_15.setTransform(-92.4,-82.9,0.9,0.9);

	this.instance_16 = new lib.男2做答5("single",14);
	this.instance_16.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_17 = new lib.男做答5("single",14);
	this.instance_17.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_18 = new lib.女做答5("single",15);
	this.instance_18.setTransform(-92.4,-82.9,0.9,0.9);

	this.instance_19 = new lib.男2做答6("single",14);
	this.instance_19.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_20 = new lib.男做答6("single",14);
	this.instance_20.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_21 = new lib.女做答6("single",15);
	this.instance_21.setTransform(-92.4,-82.9,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6,p:{y:-81.1}},{t:this.instance_5},{t:this.instance_4,p:{x:365,y:-82.8}}]}).to({state:[{t:this.instance_9},{t:this.instance_8},{t:this.instance_7}]},1).to({state:[{t:this.instance_12},{t:this.instance_11},{t:this.instance_10}]},1).to({state:[{t:this.instance_15},{t:this.instance_14},{t:this.instance_13}]},1).to({state:[{t:this.instance_18},{t:this.instance_17},{t:this.instance_16}]},1).to({state:[{t:this.instance_21},{t:this.instance_20},{t:this.instance_19}]},1).to({state:[{t:this.instance_6,p:{y:-82.9}},{t:this.instance_5},{t:this.instance_4,p:{x:364.9,y:-82.6}}]},1).wait(1));
