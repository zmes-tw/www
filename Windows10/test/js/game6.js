...
(lib.game6 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(703.6,60.5);

	this.star = new lib.星星燈號組正式();
	this.star.setTransform(766.1,35.4,1,1,0,0,0,5.7,4);
	...
	this.instance_4.setTransform(896.4,56.8,1.854,1.636,0,0,0,140.3,15.7);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_10,p:{regX:55.1,regY:27.9,scaleX:4.101,scaleY:4.101,x:644.4,y:261.2}},{t:this.instance_9,p:{scaleX:2,scaleY:2,x:640.1,y:344.3}}]}).to({state:[{t:this.instance_11},{t:this.instance_10,p:{regX:54.6,regY:27.3,scaleX:1.667,scaleY:1.667,x:124.5,y:84.6}},{t:this.instance_9,p:{scaleX:1,scaleY:1,x:111.9,y:159.7}}]},1).to({state:[]},30).to({state:[{t:this.instance_12},{t:this.restart_btn},{t:this.shape_1}]},1).to({state:[{t:this.instance_10,p:{regX:55.1,regY:27.9,scaleX:4,scaleY:4,x:646.1,y:212.9}},{t:this.instance_9,p:{scaleX:2,scaleY:2,x:636.4,y:294.3}}]},9).wait(5));
	...
	this.shape_2.graphics.lf(["rgba(0,0,0,0.702)","rgba(1,1,1,0)"],[0,1],0,-51,0,51.1).s().p("EhkAAH+IAAv7MDIBAAAIAAP7g");
	this.shape_2.setTransform(640.1,-62);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["rgba(0,0,0,0.702)","rgba(1,1,1,0)"],[0,1],0,-91.2,0,91.3).s().p("EhkAAOQIAA8fMDIBAAAIAAcfg");
	this.shape_3.setTransform(640.1,-3.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["rgba(0,0,0,0.702)","rgba(1,1,1,0)"],[0,1],0,-131.4,0,131.4).s().p("EhkAAUiMAAAgpDMDIBAAAMAAAApDg");
	this.shape_4.setTransform(640.1,54.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["rgba(0,0,0,0.702)","rgba(1,1,1,0)"],[0,1],0,-171.5,0,171.6).s().p("EhkAAa0MAAAg1nMDIBAAAMAAAA1ng");
	this.shape_5.setTransform(640.1,112.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["rgba(0,0,0,0.702)","rgba(1,1,1,0)"],[0,1],0,-211.7,0,211.8).s().p("EhkAAhGMAAAhCLMDIBAAAMAAABCLg");
	this.shape_6.setTransform(640.1,170.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["rgba(0,0,0,0.702)","rgba(1,1,1,0)"],[0,1],0,-251.8,0,252).s().p("EhkAAnYMAAAhOvMDIBAAAMAAABOvg");
	this.shape_7.setTransform(640.1,228.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.start_btn}]}).to({state:[{t:this.instance_13}]},1).to({state:[{t:this.shape_2}]},30).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[]},5).wait(5));
...
(lib.img13 = function() {
	this.initialize(img.img13);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,71,80);


(lib.img14 = function() {
	this.initialize(img.img14);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,74,72);


(lib.img15 = function() {
	this.initialize(img.img15);
}).prototype = p = new cjs.Bitmap();
...
(lib.課程 = function() {
	...
	// 圖層 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
...
(lib.重播鈕 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#003366").s().p("");
	this.shape.setTransform(-8.5,-1.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#003366").s().p("Ag2hvIBtBvIhtBvg");
	this.shape_1.setTransform(36,-1.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#CC0000").s().p("");
	this.shape_2.setTransform(-8.5,-1.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#CC0000").s().p("Ag2hvIBtBvIhtBvg");
	this.shape_3.setTransform(36,-1.5);
...
p.nominalBounds = new cjs.Rectangle(-76.3,-42.9,152.9,110.2);
...
p.nominalBounds = new cjs.Rectangle(-56.9,-22.6,114,60.1);
...
p.nominalBounds = new cjs.Rectangle(-30.6,-30,61.4,41.9);
...
(lib.男2做答6 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},14).wait(1));

	// 圖層 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#990000").s().p("");
	this.shape_1.setTransform(110.2,215.2);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FF9900").ss(3,1,1).p("APEosIAARZI+HAAIAAxZg");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.instance_1},{t:this.instance},{t:this.shape_1}]},14).wait(1));
...
(lib.男2做答5 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#990000").s().p("");
	this.shape_1.setTransform(112.2,215.5);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FF9900").ss(3,1,1).p("AvDItIAAxZIeHAAIAARZg");
	this.shape_2.setTransform(109.5,215.5);
...
(lib.男2做答4 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#990000").s().p("");
	this.shape_1.setTransform(111.1,216);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FF9900").ss(3,1,1).p("AvDosIeHAAIAARZI+HAAg");
	this.shape_2.setTransform(109.5,215.5);
...
(lib.男2做答3 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#CCCCCC").ss(10,1,1).p("ADXgKInBAAADmgHIkEFSAgdlKIEIFD");
	this.shape_1.setTransform(107.4,213.3);
...
(lib.男2做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.instance = new lib.img15();
	this.instance.setTransform(66.7,175.5,1.131,1.131);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]},14).wait(1));
...
(lib.女做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 5
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#990000").s().p("AglBmIAAiZIgaAAIAAgVQARAAAHgGQAHgFADgSIASAAIAADLgAAiBkIAAgdIAdAAIAAAdg");
	this.shape.setTransform(33.9,174.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},15).wait(1));

	// 圖層 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#990000").s().p("");
	this.shape_1.setTransform(114.7,215);
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#CC6699").ss(3,1,1).p("AvEIpIAAxRIeJAAIAARRg");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]},15).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1,p:{mode:"independent",startPosition:undefined}},{t:this.instance}]}).to({state:[{t:this.instance},{t:this.instance_1,p:{mode:"single",startPosition:14}}]},15).wait(1));
...
(lib.女做答5 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#990000").s().p("");
	this.shape_1.setTransform(111.5,215.3);
...
(lib.女做答4 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#990000").s().p("");
	this.shape_1.setTransform(115,216);
...
(lib.女做答3 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#CCCCCC").ss(10,1,1).p("ACAgGIkEFRAiDlKIEIFE");
	this.shape_1.setTransform(110.2,213.2);
...
(lib.女做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.instance = new lib.img13();
	this.instance.setTransform(72.3,169,1.131,1.131);
	...
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#CC6699").ss(3,1,1).p("APFIpI+JAAIAAxRIeJAAg");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.instance}]},15).wait(1));
...
p.nominalBounds = new cjs.Rectangle(-156.1,-152,326.6,325.7);
...
p.nominalBounds = new cjs.Rectangle(-177.4,-177.4,354.9,355);
...
(lib.煙花點 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(10).call(this.frame_10).wait(3).call(this.frame_13).wait(1).call(this.frame_14).wait(3).call(this.frame_17).wait(1).call(this.frame_18).wait(1).call(this.frame_19).wait(24).call(this.frame_43));

	// Layer 1
	this.instance = new lib.煙火7("synched",0);
	this.instance.setTransform(22.6,40.1,0.467,0.467);

	this.instance_1 = new lib.煙火6("synched",0);
	this.instance_1.setTransform(22.9,-12.8,0.205,0.188,105);

	this.instance_2 = new lib.煙火6("synched",0);
	this.instance_2.setTransform(22.9,-12.8,0.205,0.188,75);

	this.instance_3 = new lib.煙火6("synched",0);
	this.instance_3.setTransform(22.9,-12.8,0.178,0.163,15);

	this.instance_4 = new lib.煙火6("synched",0);
	this.instance_4.setTransform(22.9,-12.8,0.191,0.175,-44.9);

	this.instance_5 = new lib.煙火6("synched",0);
	this.instance_5.setTransform(22.9,-12.8,0.191,0.175,-44.9);

	this.instance_6 = new lib.煙火6("synched",0);
	this.instance_6.setTransform(22.9,-12.8,0.173,0.159,-119.9);

	this.instance_7 = new lib.煙火6("synched",0);
	this.instance_7.setTransform(22.9,-12.8,0.2,0.184,180);

	this.instance_8 = new lib.煙火6("synched",0);
	this.instance_8.setTransform(22.9,-12.8,0.316,0.29,120);

	this.instance_9 = new lib.煙火6("synched",0);
	this.instance_9.setTransform(22.9,-12.8,0.263,0.241,150);

	this.instance_10 = new lib.煙火6("synched",0);
	this.instance_10.setTransform(22.9,-12.8,0.239,0.226,0,-179.9,180);

	this.instance_11 = new lib.煙火6("synched",0);
	this.instance_11.setTransform(22.9,-12.8,0.256,0.256,-149.9);

	this.instance_12 = new lib.煙火6("synched",0);
	this.instance_12.setTransform(22.9,-12.8,0.366,0.366,-119.9);

	this.instance_13 = new lib.煙火6("synched",0);
	this.instance_13.setTransform(22.9,-12.8,0.309,0.309,-74.9);

	this.instance_14 = new lib.煙火6("synched",0);
	this.instance_14.setTransform(22.9,-12.9,0.294,0.294,-14.9);

	this.instance_15 = new lib.煙火6("synched",0);
	this.instance_15.setTransform(22.9,-12.9,0.346,0.346,30);

	this.instance_16 = new lib.煙火6("synched",0);
	this.instance_16.setTransform(22.9,-12.8,0.246,0.226,45);

	this.instance_17 = new lib.煙火6("synched",0);
	this.instance_17.setTransform(22.9,-12.8,0.246,0.226,15);

	this.instance_18 = new lib.煙火6("synched",0);
	this.instance_18.setTransform(22.9,-12.8,0.214,0.196,-44.9);

	this.instance_19 = new lib.煙火6("synched",0);
	this.instance_19.setTransform(22.9,-12.8,0.229,0.211,-104.9);

	this.instance_20 = new lib.煙火6("synched",0);
	this.instance_20.setTransform(22.9,-12.8,0.229,0.211,-104.9);

	this.instance_21 = new lib.煙火6("synched",0);
	this.instance_21.setTransform(22.9,-12.8,0.209,0.191,0,-179.9,180);

	this.instance_22 = new lib.煙火6("synched",0);
	this.instance_22.setTransform(22.9,-12.8,0.241,0.221,120);

	this.instance_23 = new lib.煙火6("synched",0);
	this.instance_23.setTransform(22.9,-12.8,0.38,0.349,60);

	this.instance_24 = new lib.煙火6("synched",0);
	this.instance_24.setTransform(22.9,-12.8,0.317,0.291,90);

	this.instance_25 = new lib.煙火6("synched",0);
	this.instance_25.setTransform(22.9,-12.8,0.288,0.272,120);

	this.instance_26 = new lib.煙火6("synched",0);
	this.instance_26.setTransform(22.9,-12.8,0.308,0.308,150);

	this.instance_27 = new lib.煙火6("synched",0);
	this.instance_27.setTransform(22.9,-12.8,0.441,0.441,180);

	this.instance_28 = new lib.煙火6("synched",0);
	this.instance_28.setTransform(22.9,-12.8,0.371,0.371,-134.9);

	this.instance_29 = new lib.煙火6("synched",0);
	this.instance_29.setTransform(22.8,-12.8,0.354,0.354,-74.9);

	this.instance_30 = new lib.煙火6("synched",0);
	this.instance_30.setTransform(22.8,-12.8,0.416,0.416,-29.9);

	this.instance_31 = new lib.煙火6("synched",0);
	this.instance_31.setTransform(22.9,-13.6,0.343,0.315,135);

	this.instance_32 = new lib.煙火6("synched",0);
	this.instance_32.setTransform(22.9,-13.6,0.343,0.315,105);

	this.instance_33 = new lib.煙火6("synched",0);
	this.instance_33.setTransform(22.9,-13.6,0.298,0.274,45);

	this.instance_34 = new lib.煙火6("synched",0);
	this.instance_34.setTransform(22.9,-13.6,0.319,0.293,-14.9);

	this.instance_35 = new lib.煙火6("synched",0);
	this.instance_35.setTransform(22.9,-13.6,0.319,0.293,-14.9);

	this.instance_36 = new lib.煙火6("synched",0);
	this.instance_36.setTransform(22.9,-13.6,0.29,0.267,-89.9);

	this.instance_37 = new lib.煙火6("synched",0);
	this.instance_37.setTransform(22.9,-13.6,0.335,0.308,-149.9);

	this.instance_38 = new lib.煙火6("synched",0);
	this.instance_38.setTransform(22.9,-13.6,0.529,0.486,150);

	this.instance_39 = new lib.煙火6("synched",0);
	this.instance_39.setTransform(22.9,-13.6,0.441,0.405,-179.9);

	this.instance_40 = new lib.煙火6("synched",0);
	this.instance_40.setTransform(22.9,-13.6,0.401,0.379,-149.9);

	this.instance_41 = new lib.煙火6("synched",0);
	this.instance_41.setTransform(22.9,-13.6,0.429,0.429,-119.9);

	this.instance_42 = new lib.煙火6("synched",0);
	this.instance_42.setTransform(22.9,-13.6,0.614,0.614,-89.9);

	this.instance_43 = new lib.煙火6("synched",0);
	this.instance_43.setTransform(22.9,-13.6,0.517,0.517,-44.9);

	this.instance_44 = new lib.煙火6("synched",0);
	this.instance_44.setTransform(22.9,-13.6,0.493,0.493,15);

	this.instance_45 = new lib.煙火6("synched",0);
	this.instance_45.setTransform(22.9,-13.6,0.579,0.579,60);

	this.instance_46 = new lib.煙火6("synched",0);
	this.instance_46.setTransform(22.9,-13.6,0.413,0.379,75);

	this.instance_47 = new lib.煙火6("synched",0);
	this.instance_47.setTransform(22.9,-13.6,0.413,0.379,45);

	this.instance_48 = new lib.煙火6("synched",0);
	this.instance_48.setTransform(22.9,-13.6,0.359,0.329,-14.9);

	this.instance_49 = new lib.煙火6("synched",0);
	this.instance_49.setTransform(22.9,-13.6,0.384,0.353,-74.9);

	this.instance_50 = new lib.煙火6("synched",0);
	this.instance_50.setTransform(22.9,-13.6,0.384,0.353,-74.9);

	this.instance_51 = new lib.煙火6("synched",0);
	this.instance_51.setTransform(22.9,-13.6,0.349,0.321,-149.9);

	this.instance_52 = new lib.煙火6("synched",0);
	this.instance_52.setTransform(22.9,-13.6,0.403,0.37,150);

	this.instance_53 = new lib.煙火6("synched",0);
	this.instance_53.setTransform(22.9,-13.6,0.637,0.584,90);

	this.instance_54 = new lib.煙火6("synched",0);
	this.instance_54.setTransform(22.9,-13.6,0.531,0.487,120);

	this.instance_55 = new lib.煙火6("synched",0);
	this.instance_55.setTransform(22.9,-13.6,0.482,0.456,150);

	this.instance_56 = new lib.煙火6("synched",0);
	this.instance_56.setTransform(22.9,-13.6,0.517,0.517,-179.9);

	this.instance_57 = new lib.煙火6("synched",0);
	this.instance_57.setTransform(22.9,-13.6,0.738,0.738,-149.9);

	this.instance_58 = new lib.煙火6("synched",0);
	this.instance_58.setTransform(22.9,-13.6,0.622,0.622,-104.9);

	this.instance_59 = new lib.煙火6("synched",0);
	this.instance_59.setTransform(22.9,-13.6,0.593,0.593,-44.9);

	this.instance_60 = new lib.煙火6("synched",0);
	this.instance_60.setTransform(22.9,-13.6,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{y:40.1,x:22.6}}]}).to({state:[{t:this.instance,p:{y:34.1,x:22.6}}]},1).to({state:[{t:this.instance,p:{y:28.2,x:22.6}}]},1).to({state:[{t:this.instance,p:{y:22.2,x:22.7}}]},1).to({state:[{t:this.instance,p:{y:16.2,x:22.7}}]},1).to({state:[{t:this.instance,p:{y:10.2,x:22.7}}]},1).to({state:[{t:this.instance,p:{y:4.3,x:22.8}}]},1).to({state:[{t:this.instance,p:{y:-1.6,x:22.8}}]},1).to({state:[{t:this.instance,p:{y:-7.6,x:22.9}}]},1).to({state:[{t:this.instance,p:{y:-13.6,x:22.9}}]},1).to({state:[{t:this.instance_60},{t:this.instance_59},{t:this.instance_58},{t:this.instance_57},{t:this.instance_56},{t:this.instance_55},{t:this.instance_54},{t:this.instance_53},{t:this.instance_52},{t:this.instance_51},{t:this.instance_50},{t:this.instance_49},{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40},{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36},{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]},1).to({state:[]},24).wait(10));

	// Layer 1
	this.instance_61 = new lib.煙火7("synched",0);
	this.instance_61.setTransform(-29.9,32.6,0.467,0.467);

	this.instance_62 = new lib.煙火6("synched",0);
	this.instance_62.setTransform(-29.6,-20.3,0.205,0.188,105);

	this.instance_63 = new lib.煙火6("synched",0);
	this.instance_63.setTransform(-29.6,-20.3,0.205,0.188,75);

	this.instance_64 = new lib.煙火6("synched",0);
	this.instance_64.setTransform(-29.6,-20.3,0.178,0.163,15);

	this.instance_65 = new lib.煙火6("synched",0);
	this.instance_65.setTransform(-29.6,-20.3,0.191,0.175,-44.9);

	this.instance_66 = new lib.煙火6("synched",0);
	this.instance_66.setTransform(-29.6,-20.3,0.191,0.175,-44.9);

	this.instance_67 = new lib.煙火6("synched",0);
	this.instance_67.setTransform(-29.6,-20.3,0.173,0.159,-119.9);

	this.instance_68 = new lib.煙火6("synched",0);
	this.instance_68.setTransform(-29.6,-20.3,0.2,0.184,180);

	this.instance_69 = new lib.煙火6("synched",0);
	this.instance_69.setTransform(-29.6,-20.3,0.316,0.29,120);

	this.instance_70 = new lib.煙火6("synched",0);
	this.instance_70.setTransform(-29.6,-20.3,0.263,0.241,150);

	this.instance_71 = new lib.煙火6("synched",0);
	this.instance_71.setTransform(-29.6,-20.3,0.239,0.226,0,-179.9,180);

	this.instance_72 = new lib.煙火6("synched",0);
	this.instance_72.setTransform(-29.6,-20.3,0.256,0.256,-149.9);

	this.instance_73 = new lib.煙火6("synched",0);
	this.instance_73.setTransform(-29.6,-20.3,0.366,0.366,-119.9);

	this.instance_74 = new lib.煙火6("synched",0);
	this.instance_74.setTransform(-29.6,-20.3,0.309,0.309,-74.9);

	this.instance_75 = new lib.煙火6("synched",0);
	this.instance_75.setTransform(-29.5,-20.4,0.294,0.294,-14.9);

	this.instance_76 = new lib.煙火6("synched",0);
	this.instance_76.setTransform(-29.5,-20.4,0.346,0.346,30);

	this.instance_77 = new lib.煙火6("synched",0);
	this.instance_77.setTransform(-29.6,-20.3,0.246,0.226,45);

	this.instance_78 = new lib.煙火6("synched",0);
	this.instance_78.setTransform(-29.6,-20.3,0.246,0.226,15);

	this.instance_79 = new lib.煙火6("synched",0);
	this.instance_79.setTransform(-29.6,-20.3,0.214,0.196,-44.9);

	this.instance_80 = new lib.煙火6("synched",0);
	this.instance_80.setTransform(-29.6,-20.3,0.229,0.211,-104.9);

	this.instance_81 = new lib.煙火6("synched",0);
	this.instance_81.setTransform(-29.6,-20.3,0.229,0.211,-104.9);

	this.instance_82 = new lib.煙火6("synched",0);
	this.instance_82.setTransform(-29.6,-20.3,0.209,0.191,0,-179.9,180);

	this.instance_83 = new lib.煙火6("synched",0);
	this.instance_83.setTransform(-29.6,-20.3,0.241,0.221,120);

	this.instance_84 = new lib.煙火6("synched",0);
	this.instance_84.setTransform(-29.6,-20.3,0.38,0.349,60);

	this.instance_85 = new lib.煙火6("synched",0);
	this.instance_85.setTransform(-29.6,-20.3,0.317,0.291,90);

	this.instance_86 = new lib.煙火6("synched",0);
	this.instance_86.setTransform(-29.6,-20.3,0.288,0.272,120);

	this.instance_87 = new lib.煙火6("synched",0);
	this.instance_87.setTransform(-29.6,-20.3,0.308,0.308,150);

	this.instance_88 = new lib.煙火6("synched",0);
	this.instance_88.setTransform(-29.6,-20.3,0.441,0.441,180);

	this.instance_89 = new lib.煙火6("synched",0);
	this.instance_89.setTransform(-29.6,-20.3,0.371,0.371,-134.9);

	this.instance_90 = new lib.煙火6("synched",0);
	this.instance_90.setTransform(-29.6,-20.3,0.354,0.354,-74.9);

	this.instance_91 = new lib.煙火6("synched",0);
	this.instance_91.setTransform(-29.6,-20.3,0.416,0.416,-29.9);

	this.instance_92 = new lib.煙火6("synched",0);
	this.instance_92.setTransform(-29.6,-21.1,0.343,0.315,135);

	this.instance_93 = new lib.煙火6("synched",0);
	this.instance_93.setTransform(-29.6,-21.1,0.343,0.315,105);

	this.instance_94 = new lib.煙火6("synched",0);
	this.instance_94.setTransform(-29.6,-21.1,0.298,0.274,45);

	this.instance_95 = new lib.煙火6("synched",0);
	this.instance_95.setTransform(-29.6,-21.1,0.319,0.293,-14.9);

	this.instance_96 = new lib.煙火6("synched",0);
	this.instance_96.setTransform(-29.6,-21.1,0.319,0.293,-14.9);

	this.instance_97 = new lib.煙火6("synched",0);
	this.instance_97.setTransform(-29.6,-21.1,0.29,0.267,-89.9);

	this.instance_98 = new lib.煙火6("synched",0);
	this.instance_98.setTransform(-29.6,-21.1,0.335,0.308,-149.9);

	this.instance_99 = new lib.煙火6("synched",0);
	this.instance_99.setTransform(-29.6,-21.1,0.529,0.486,150);

	this.instance_100 = new lib.煙火6("synched",0);
	this.instance_100.setTransform(-29.6,-21.1,0.441,0.405,-179.9);

	this.instance_101 = new lib.煙火6("synched",0);
	this.instance_101.setTransform(-29.6,-21.1,0.401,0.379,-149.9);

	this.instance_102 = new lib.煙火6("synched",0);
	this.instance_102.setTransform(-29.6,-21.1,0.429,0.429,-119.9);

	this.instance_103 = new lib.煙火6("synched",0);
	this.instance_103.setTransform(-29.6,-21.1,0.614,0.614,-89.9);

	this.instance_104 = new lib.煙火6("synched",0);
	this.instance_104.setTransform(-29.6,-21.1,0.517,0.517,-44.9);

	this.instance_105 = new lib.煙火6("synched",0);
	this.instance_105.setTransform(-29.5,-21.1,0.493,0.493,15);

	this.instance_106 = new lib.煙火6("synched",0);
	this.instance_106.setTransform(-29.5,-21.1,0.579,0.579,60);

	this.instance_107 = new lib.煙火6("synched",0);
	this.instance_107.setTransform(-29.6,-21.1,0.413,0.379,75);

	this.instance_108 = new lib.煙火6("synched",0);
	this.instance_108.setTransform(-29.6,-21.1,0.413,0.379,45);

	this.instance_109 = new lib.煙火6("synched",0);
	this.instance_109.setTransform(-29.6,-21.1,0.359,0.329,-14.9);

	this.instance_110 = new lib.煙火6("synched",0);
	this.instance_110.setTransform(-29.6,-21.1,0.384,0.353,-74.9);

	this.instance_111 = new lib.煙火6("synched",0);
	this.instance_111.setTransform(-29.6,-21.1,0.384,0.353,-74.9);

	this.instance_112 = new lib.煙火6("synched",0);
	this.instance_112.setTransform(-29.6,-21.1,0.349,0.321,-149.9);

	this.instance_113 = new lib.煙火6("synched",0);
	this.instance_113.setTransform(-29.6,-21.1,0.403,0.37,150);

	this.instance_114 = new lib.煙火6("synched",0);
	this.instance_114.setTransform(-29.6,-21.1,0.637,0.584,90);

	this.instance_115 = new lib.煙火6("synched",0);
	this.instance_115.setTransform(-29.6,-21.1,0.531,0.487,120);

	this.instance_116 = new lib.煙火6("synched",0);
	this.instance_116.setTransform(-29.6,-21.1,0.482,0.456,150);

	this.instance_117 = new lib.煙火6("synched",0);
	this.instance_117.setTransform(-29.6,-21.1,0.517,0.517,-179.9);

	this.instance_118 = new lib.煙火6("synched",0);
	this.instance_118.setTransform(-29.6,-21.1,0.738,0.738,-149.9);

	this.instance_119 = new lib.煙火6("synched",0);
	this.instance_119.setTransform(-29.6,-21.1,0.622,0.622,-104.9);

	this.instance_120 = new lib.煙火6("synched",0);
	this.instance_120.setTransform(-29.6,-21.1,0.593,0.593,-44.9);

	this.instance_121 = new lib.煙火6("synched",0);
	this.instance_121.setTransform(-29.6,-21.1,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_61,p:{x:-29.9,y:32.6}}]},3).to({state:[{t:this.instance_61,p:{x:-29.8,y:26.6}}]},1).to({state:[{t:this.instance_61,p:{x:-29.8,y:20.7}}]},1).to({state:[{t:this.instance_61,p:{x:-29.7,y:14.7}}]},1).to({state:[{t:this.instance_61,p:{x:-29.7,y:8.7}}]},1).to({state:[{t:this.instance_61,p:{x:-29.7,y:2.7}}]},1).to({state:[{t:this.instance_61,p:{x:-29.6,y:-3.1}}]},1).to({state:[{t:this.instance_61,p:{x:-29.6,y:-9.1}}]},1).to({state:[{t:this.instance_61,p:{x:-29.5,y:-15.1}}]},1).to({state:[{t:this.instance_61,p:{x:-29.5,y:-21.1}}]},1).to({state:[{t:this.instance_121},{t:this.instance_120},{t:this.instance_119},{t:this.instance_118},{t:this.instance_117},{t:this.instance_116},{t:this.instance_115},{t:this.instance_114},{t:this.instance_113},{t:this.instance_112},{t:this.instance_111},{t:this.instance_110},{t:this.instance_109},{t:this.instance_108},{t:this.instance_107},{t:this.instance_106},{t:this.instance_105},{t:this.instance_104},{t:this.instance_103},{t:this.instance_102},{t:this.instance_101},{t:this.instance_100},{t:this.instance_99},{t:this.instance_98},{t:this.instance_97},{t:this.instance_96},{t:this.instance_95},{t:this.instance_94},{t:this.instance_93},{t:this.instance_92},{t:this.instance_91},{t:this.instance_90},{t:this.instance_89},{t:this.instance_88},{t:this.instance_87},{t:this.instance_86},{t:this.instance_85},{t:this.instance_84},{t:this.instance_83},{t:this.instance_82},{t:this.instance_81},{t:this.instance_80},{t:this.instance_79},{t:this.instance_78},{t:this.instance_77},{t:this.instance_76},{t:this.instance_75},{t:this.instance_74},{t:this.instance_73},{t:this.instance_72},{t:this.instance_71},{t:this.instance_70},{t:this.instance_69},{t:this.instance_68},{t:this.instance_67},{t:this.instance_66},{t:this.instance_65},{t:this.instance_64},{t:this.instance_63},{t:this.instance_62}]},1).to({state:[]},26).wait(5));

	// Layer 1
	this.instance_122 = new lib.煙火7("synched",0);
	this.instance_122.setTransform(39.8,50.8,0.467,0.467);

	this.instance_123 = new lib.煙火6("synched",0);
	this.instance_123.setTransform(40.1,-2.1,0.205,0.188,105);

	this.instance_124 = new lib.煙火6("synched",0);
	this.instance_124.setTransform(40.1,-2.1,0.205,0.188,75);

	this.instance_125 = new lib.煙火6("synched",0);
	this.instance_125.setTransform(40.1,-2.1,0.178,0.163,15);

	this.instance_126 = new lib.煙火6("synched",0);
	this.instance_126.setTransform(40.1,-2.1,0.191,0.175,-44.9);

	this.instance_127 = new lib.煙火6("synched",0);
	this.instance_127.setTransform(40.1,-2.1,0.191,0.175,-44.9);

	this.instance_128 = new lib.煙火6("synched",0);
	this.instance_128.setTransform(40.1,-2.1,0.173,0.159,-119.9);

	this.instance_129 = new lib.煙火6("synched",0);
	this.instance_129.setTransform(40.1,-2.1,0.2,0.184,180);

	this.instance_130 = new lib.煙火6("synched",0);
	this.instance_130.setTransform(40.1,-2.1,0.316,0.29,120);

	this.instance_131 = new lib.煙火6("synched",0);
	this.instance_131.setTransform(40.1,-2.1,0.263,0.241,150);

	this.instance_132 = new lib.煙火6("synched",0);
	this.instance_132.setTransform(40.1,-2.1,0.239,0.226,0,-179.9,180);

	this.instance_133 = new lib.煙火6("synched",0);
	this.instance_133.setTransform(40.1,-2.1,0.256,0.256,-149.9);

	this.instance_134 = new lib.煙火6("synched",0);
	this.instance_134.setTransform(40.1,-2.1,0.366,0.366,-119.9);

	this.instance_135 = new lib.煙火6("synched",0);
	this.instance_135.setTransform(40.1,-2.1,0.309,0.309,-74.9);

	this.instance_136 = new lib.煙火6("synched",0);
	this.instance_136.setTransform(40.1,-2.2,0.294,0.294,-14.9);

	this.instance_137 = new lib.煙火6("synched",0);
	this.instance_137.setTransform(40.1,-2.2,0.346,0.346,30);

	this.instance_138 = new lib.煙火6("synched",0);
	this.instance_138.setTransform(40.1,-2.1,0.246,0.226,45);

	this.instance_139 = new lib.煙火6("synched",0);
	this.instance_139.setTransform(40.1,-2.1,0.246,0.226,15);

	this.instance_140 = new lib.煙火6("synched",0);
	this.instance_140.setTransform(40.1,-2.1,0.214,0.196,-44.9);

	this.instance_141 = new lib.煙火6("synched",0);
	this.instance_141.setTransform(40.1,-2.1,0.229,0.211,-104.9);

	this.instance_142 = new lib.煙火6("synched",0);
	this.instance_142.setTransform(40.1,-2.1,0.229,0.211,-104.9);

	this.instance_143 = new lib.煙火6("synched",0);
	this.instance_143.setTransform(40.1,-2.1,0.209,0.191,0,-179.9,180);

	this.instance_144 = new lib.煙火6("synched",0);
	this.instance_144.setTransform(40.1,-2.1,0.241,0.221,120);

	this.instance_145 = new lib.煙火6("synched",0);
	this.instance_145.setTransform(40.1,-2.1,0.38,0.349,60);

	this.instance_146 = new lib.煙火6("synched",0);
	this.instance_146.setTransform(40.1,-2.1,0.317,0.291,90);

	this.instance_147 = new lib.煙火6("synched",0);
	this.instance_147.setTransform(40.1,-2.1,0.288,0.272,120);

	this.instance_148 = new lib.煙火6("synched",0);
	this.instance_148.setTransform(40.1,-2.1,0.308,0.308,150);

	this.instance_149 = new lib.煙火6("synched",0);
	this.instance_149.setTransform(40.1,-2.1,0.441,0.441,180);

	this.instance_150 = new lib.煙火6("synched",0);
	this.instance_150.setTransform(40.1,-2.1,0.371,0.371,-134.9);

	this.instance_151 = new lib.煙火6("synched",0);
	this.instance_151.setTransform(40,-2.1,0.354,0.354,-74.9);

	this.instance_152 = new lib.煙火6("synched",0);
	this.instance_152.setTransform(40,-2.1,0.416,0.416,-29.9);

	this.instance_153 = new lib.煙火6("synched",0);
	this.instance_153.setTransform(40.1,-2.9,0.343,0.315,135);

	this.instance_154 = new lib.煙火6("synched",0);
	this.instance_154.setTransform(40.1,-2.9,0.343,0.315,105);

	this.instance_155 = new lib.煙火6("synched",0);
	this.instance_155.setTransform(40.1,-2.9,0.298,0.274,45);

	this.instance_156 = new lib.煙火6("synched",0);
	this.instance_156.setTransform(40.1,-2.9,0.319,0.293,-14.9);

	this.instance_157 = new lib.煙火6("synched",0);
	this.instance_157.setTransform(40.1,-2.9,0.319,0.293,-14.9);

	this.instance_158 = new lib.煙火6("synched",0);
	this.instance_158.setTransform(40.1,-2.9,0.29,0.267,-89.9);

	this.instance_159 = new lib.煙火6("synched",0);
	this.instance_159.setTransform(40.1,-2.9,0.335,0.308,-149.9);

	this.instance_160 = new lib.煙火6("synched",0);
	this.instance_160.setTransform(40.1,-2.9,0.529,0.486,150);

	this.instance_161 = new lib.煙火6("synched",0);
	this.instance_161.setTransform(40.1,-2.9,0.441,0.405,-179.9);

	this.instance_162 = new lib.煙火6("synched",0);
	this.instance_162.setTransform(40.1,-2.9,0.401,0.379,-149.9);

	this.instance_163 = new lib.煙火6("synched",0);
	this.instance_163.setTransform(40.1,-2.9,0.429,0.429,-119.9);

	this.instance_164 = new lib.煙火6("synched",0);
	this.instance_164.setTransform(40.1,-2.9,0.614,0.614,-89.9);

	this.instance_165 = new lib.煙火6("synched",0);
	this.instance_165.setTransform(40.1,-2.9,0.517,0.517,-44.9);

	this.instance_166 = new lib.煙火6("synched",0);
	this.instance_166.setTransform(40.1,-2.9,0.493,0.493,15);

	this.instance_167 = new lib.煙火6("synched",0);
	this.instance_167.setTransform(40.1,-2.9,0.579,0.579,60);

	this.instance_168 = new lib.煙火6("synched",0);
	this.instance_168.setTransform(40.1,-2.9,0.413,0.379,75);

	this.instance_169 = new lib.煙火6("synched",0);
	this.instance_169.setTransform(40.1,-2.9,0.413,0.379,45);

	this.instance_170 = new lib.煙火6("synched",0);
	this.instance_170.setTransform(40.1,-2.9,0.359,0.329,-14.9);

	this.instance_171 = new lib.煙火6("synched",0);
	this.instance_171.setTransform(40.1,-2.9,0.384,0.353,-74.9);

	this.instance_172 = new lib.煙火6("synched",0);
	this.instance_172.setTransform(40.1,-2.9,0.384,0.353,-74.9);

	this.instance_173 = new lib.煙火6("synched",0);
	this.instance_173.setTransform(40.1,-2.9,0.349,0.321,-149.9);

	this.instance_174 = new lib.煙火6("synched",0);
	this.instance_174.setTransform(40.1,-2.9,0.403,0.37,150);

	this.instance_175 = new lib.煙火6("synched",0);
	this.instance_175.setTransform(40.1,-2.9,0.637,0.584,90);

	this.instance_176 = new lib.煙火6("synched",0);
	this.instance_176.setTransform(40.1,-2.9,0.531,0.487,120);

	this.instance_177 = new lib.煙火6("synched",0);
	this.instance_177.setTransform(40.1,-2.9,0.482,0.456,150);

	this.instance_178 = new lib.煙火6("synched",0);
	this.instance_178.setTransform(40.1,-2.9,0.517,0.517,-179.9);

	this.instance_179 = new lib.煙火6("synched",0);
	this.instance_179.setTransform(40.1,-2.9,0.738,0.738,-149.9);

	this.instance_180 = new lib.煙火6("synched",0);
	this.instance_180.setTransform(40.1,-2.9,0.622,0.622,-104.9);

	this.instance_181 = new lib.煙火6("synched",0);
	this.instance_181.setTransform(40.1,-2.9,0.593,0.593,-44.9);

	this.instance_182 = new lib.煙火6("synched",0);
	this.instance_182.setTransform(40.1,-2.9,0.697,0.697);

	this.rest = new lib.重播鈕();
	this.rest.setTransform(-1.5,29.7,0.296,0.296);
	new cjs.ButtonHelper(this.rest, 0, 1, 2, false, new lib.重播鈕(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_122,p:{y:50.8,x:39.8}}]},4).to({state:[{t:this.instance_122,p:{y:44.8,x:39.8}}]},1).to({state:[{t:this.instance_122,p:{y:38.9,x:39.8}}]},1).to({state:[{t:this.instance_122,p:{y:32.9,x:39.9}}]},1).to({state:[{t:this.instance_122,p:{y:26.9,x:39.9}}]},1).to({state:[{t:this.instance_122,p:{y:20.9,x:39.9}}]},1).to({state:[{t:this.instance_122,p:{y:15,x:40}}]},1).to({state:[{t:this.instance_122,p:{y:9,x:40}}]},1).to({state:[{t:this.instance_122,p:{y:3,x:40.1}}]},1).to({state:[{t:this.instance_122,p:{y:-2.9,x:40.1}}]},1).to({state:[{t:this.instance_182},{t:this.instance_181},{t:this.instance_180},{t:this.instance_179},{t:this.instance_178},{t:this.instance_177},{t:this.instance_176},{t:this.instance_175},{t:this.instance_174},{t:this.instance_173},{t:this.instance_172},{t:this.instance_171},{t:this.instance_170},{t:this.instance_169},{t:this.instance_168},{t:this.instance_167},{t:this.instance_166},{t:this.instance_165},{t:this.instance_164},{t:this.instance_163},{t:this.instance_162},{t:this.instance_161},{t:this.instance_160},{t:this.instance_159},{t:this.instance_158},{t:this.instance_157},{t:this.instance_156},{t:this.instance_155},{t:this.instance_154},{t:this.instance_153},{t:this.instance_152},{t:this.instance_151},{t:this.instance_150},{t:this.instance_149},{t:this.instance_148},{t:this.instance_147},{t:this.instance_146},{t:this.instance_145},{t:this.instance_144},{t:this.instance_143},{t:this.instance_142},{t:this.instance_141},{t:this.instance_140},{t:this.instance_139},{t:this.instance_138},{t:this.instance_137},{t:this.instance_136},{t:this.instance_135},{t:this.instance_134},{t:this.instance_133},{t:this.instance_132},{t:this.instance_131},{t:this.instance_130},{t:this.instance_129},{t:this.instance_128},{t:this.instance_127},{t:this.instance_126},{t:this.instance_125},{t:this.instance_124},{t:this.instance_123}]},1).to({state:[]},24).to({state:[{t:this.rest}]},5).wait(1));

	// Layer 1
	this.instance_183 = new lib.煙火7("synched",0);
	this.instance_183.setTransform(51.3,46.7,0.467,0.467);

	this.instance_184 = new lib.煙火6("synched",0);
	this.instance_184.setTransform(51.6,-6.3,0.205,0.188,105);

	this.instance_185 = new lib.煙火6("synched",0);
	this.instance_185.setTransform(51.6,-6.3,0.205,0.188,75);

	this.instance_186 = new lib.煙火6("synched",0);
	this.instance_186.setTransform(51.6,-6.3,0.178,0.163,15);

	this.instance_187 = new lib.煙火6("synched",0);
	this.instance_187.setTransform(51.6,-6.3,0.191,0.175,-44.9);

	this.instance_188 = new lib.煙火6("synched",0);
	this.instance_188.setTransform(51.6,-6.3,0.191,0.175,-44.9);

	this.instance_189 = new lib.煙火6("synched",0);
	this.instance_189.setTransform(51.6,-6.3,0.173,0.159,-119.9);

	this.instance_190 = new lib.煙火6("synched",0);
	this.instance_190.setTransform(51.6,-6.3,0.2,0.184,180);

	this.instance_191 = new lib.煙火6("synched",0);
	this.instance_191.setTransform(51.6,-6.3,0.316,0.29,120);

	this.instance_192 = new lib.煙火6("synched",0);
	this.instance_192.setTransform(51.6,-6.3,0.263,0.241,150);

	this.instance_193 = new lib.煙火6("synched",0);
	this.instance_193.setTransform(51.6,-6.3,0.239,0.226,0,-179.9,180);

	this.instance_194 = new lib.煙火6("synched",0);
	this.instance_194.setTransform(51.6,-6.3,0.256,0.256,-149.9);

	this.instance_195 = new lib.煙火6("synched",0);
	this.instance_195.setTransform(51.6,-6.3,0.366,0.366,-119.9);

	this.instance_196 = new lib.煙火6("synched",0);
	this.instance_196.setTransform(51.6,-6.3,0.309,0.309,-74.9);

	this.instance_197 = new lib.煙火6("synched",0);
	this.instance_197.setTransform(51.7,-6.3,0.294,0.294,-14.9);

	this.instance_198 = new lib.煙火6("synched",0);
	this.instance_198.setTransform(51.7,-6.3,0.346,0.346,30);

	this.instance_199 = new lib.煙火6("synched",0);
	this.instance_199.setTransform(51.6,-6.3,0.246,0.226,45);

	this.instance_200 = new lib.煙火6("synched",0);
	this.instance_200.setTransform(51.6,-6.3,0.246,0.226,15);

	this.instance_201 = new lib.煙火6("synched",0);
	this.instance_201.setTransform(51.6,-6.3,0.214,0.196,-44.9);

	this.instance_202 = new lib.煙火6("synched",0);
	this.instance_202.setTransform(51.6,-6.3,0.229,0.211,-104.9);

	this.instance_203 = new lib.煙火6("synched",0);
	this.instance_203.setTransform(51.6,-6.3,0.229,0.211,-104.9);

	this.instance_204 = new lib.煙火6("synched",0);
	this.instance_204.setTransform(51.6,-6.3,0.209,0.191,0,-179.9,180);

	this.instance_205 = new lib.煙火6("synched",0);
	this.instance_205.setTransform(51.6,-6.3,0.241,0.221,120);

	this.instance_206 = new lib.煙火6("synched",0);
	this.instance_206.setTransform(51.6,-6.3,0.38,0.349,60);

	this.instance_207 = new lib.煙火6("synched",0);
	this.instance_207.setTransform(51.6,-6.3,0.317,0.291,90);

	this.instance_208 = new lib.煙火6("synched",0);
	this.instance_208.setTransform(51.6,-6.3,0.288,0.272,120);

	this.instance_209 = new lib.煙火6("synched",0);
	this.instance_209.setTransform(51.6,-6.3,0.308,0.308,150);

	this.instance_210 = new lib.煙火6("synched",0);
	this.instance_210.setTransform(51.6,-6.3,0.441,0.441,180);

	this.instance_211 = new lib.煙火6("synched",0);
	this.instance_211.setTransform(51.6,-6.3,0.371,0.371,-134.9);

	this.instance_212 = new lib.煙火6("synched",0);
	this.instance_212.setTransform(51.6,-6.3,0.354,0.354,-74.9);

	this.instance_213 = new lib.煙火6("synched",0);
	this.instance_213.setTransform(51.6,-6.3,0.416,0.416,-29.9);

	this.instance_214 = new lib.煙火6("synched",0);
	this.instance_214.setTransform(51.6,-7,0.343,0.315,135);

	this.instance_215 = new lib.煙火6("synched",0);
	this.instance_215.setTransform(51.6,-7,0.343,0.315,105);

	this.instance_216 = new lib.煙火6("synched",0);
	this.instance_216.setTransform(51.6,-7,0.298,0.274,45);

	this.instance_217 = new lib.煙火6("synched",0);
	this.instance_217.setTransform(51.6,-7,0.319,0.293,-14.9);

	this.instance_218 = new lib.煙火6("synched",0);
	this.instance_218.setTransform(51.6,-7,0.319,0.293,-14.9);

	this.instance_219 = new lib.煙火6("synched",0);
	this.instance_219.setTransform(51.6,-7,0.29,0.267,-89.9);

	this.instance_220 = new lib.煙火6("synched",0);
	this.instance_220.setTransform(51.6,-7,0.335,0.308,-149.9);

	this.instance_221 = new lib.煙火6("synched",0);
	this.instance_221.setTransform(51.6,-7,0.529,0.486,150);

	this.instance_222 = new lib.煙火6("synched",0);
	this.instance_222.setTransform(51.6,-7,0.441,0.405,-179.9);

	this.instance_223 = new lib.煙火6("synched",0);
	this.instance_223.setTransform(51.6,-7,0.401,0.379,-149.9);

	this.instance_224 = new lib.煙火6("synched",0);
	this.instance_224.setTransform(51.6,-7,0.429,0.429,-119.9);

	this.instance_225 = new lib.煙火6("synched",0);
	this.instance_225.setTransform(51.6,-7,0.614,0.614,-89.9);

	this.instance_226 = new lib.煙火6("synched",0);
	this.instance_226.setTransform(51.6,-7,0.517,0.517,-44.9);

	this.instance_227 = new lib.煙火6("synched",0);
	this.instance_227.setTransform(51.7,-7,0.493,0.493,15);

	this.instance_228 = new lib.煙火6("synched",0);
	this.instance_228.setTransform(51.7,-7,0.579,0.579,60);

	this.instance_229 = new lib.煙火6("synched",0);
	this.instance_229.setTransform(51.6,-7,0.413,0.379,75);

	this.instance_230 = new lib.煙火6("synched",0);
	this.instance_230.setTransform(51.6,-7,0.413,0.379,45);

	this.instance_231 = new lib.煙火6("synched",0);
	this.instance_231.setTransform(51.6,-7,0.359,0.329,-14.9);

	this.instance_232 = new lib.煙火6("synched",0);
	this.instance_232.setTransform(51.6,-7,0.384,0.353,-74.9);

	this.instance_233 = new lib.煙火6("synched",0);
	this.instance_233.setTransform(51.6,-7,0.384,0.353,-74.9);

	this.instance_234 = new lib.煙火6("synched",0);
	this.instance_234.setTransform(51.6,-7,0.349,0.321,-149.9);

	this.instance_235 = new lib.煙火6("synched",0);
	this.instance_235.setTransform(51.6,-7,0.403,0.37,150);

	this.instance_236 = new lib.煙火6("synched",0);
	this.instance_236.setTransform(51.6,-7,0.637,0.584,90);

	this.instance_237 = new lib.煙火6("synched",0);
	this.instance_237.setTransform(51.6,-7,0.531,0.487,120);

	this.instance_238 = new lib.煙火6("synched",0);
	this.instance_238.setTransform(51.6,-7,0.482,0.456,150);

	this.instance_239 = new lib.煙火6("synched",0);
	this.instance_239.setTransform(51.6,-7,0.517,0.517,-179.9);

	this.instance_240 = new lib.煙火6("synched",0);
	this.instance_240.setTransform(51.6,-7,0.738,0.738,-149.9);

	this.instance_241 = new lib.煙火6("synched",0);
	this.instance_241.setTransform(51.6,-7,0.622,0.622,-104.9);

	this.instance_242 = new lib.煙火6("synched",0);
	this.instance_242.setTransform(51.6,-7.1,0.593,0.593,-44.9);

	this.instance_243 = new lib.煙火6("synched",0);
	this.instance_243.setTransform(51.6,-7.1,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_183,p:{y:46.7,x:51.3}}]},7).to({state:[{t:this.instance_183,p:{y:40.7,x:51.3}}]},1).to({state:[{t:this.instance_183,p:{y:34.7,x:51.4}}]},1).to({state:[{t:this.instance_183,p:{y:28.7,x:51.4}}]},1).to({state:[{t:this.instance_183,p:{y:22.8,x:51.5}}]},1).to({state:[{t:this.instance_183,p:{y:16.8,x:51.5}}]},1).to({state:[{t:this.instance_183,p:{y:10.8,x:51.5}}]},1).to({state:[{t:this.instance_183,p:{y:4.8,x:51.6}}]},1).to({state:[{t:this.instance_183,p:{y:-1,x:51.6}}]},1).to({state:[{t:this.instance_183,p:{y:-7,x:51.7}}]},1).to({state:[{t:this.instance_243},{t:this.instance_242},{t:this.instance_241},{t:this.instance_240},{t:this.instance_239},{t:this.instance_238},{t:this.instance_237},{t:this.instance_236},{t:this.instance_235},{t:this.instance_234},{t:this.instance_233},{t:this.instance_232},{t:this.instance_231},{t:this.instance_230},{t:this.instance_229},{t:this.instance_228},{t:this.instance_227},{t:this.instance_226},{t:this.instance_225},{t:this.instance_224},{t:this.instance_223},{t:this.instance_222},{t:this.instance_221},{t:this.instance_220},{t:this.instance_219},{t:this.instance_218},{t:this.instance_217},{t:this.instance_216},{t:this.instance_215},{t:this.instance_214},{t:this.instance_213},{t:this.instance_212},{t:this.instance_211},{t:this.instance_210},{t:this.instance_209},{t:this.instance_208},{t:this.instance_207},{t:this.instance_206},{t:this.instance_205},{t:this.instance_204},{t:this.instance_203},{t:this.instance_202},{t:this.instance_201},{t:this.instance_200},{t:this.instance_199},{t:this.instance_198},{t:this.instance_197},{t:this.instance_196},{t:this.instance_195},{t:this.instance_194},{t:this.instance_193},{t:this.instance_192},{t:this.instance_191},{t:this.instance_190},{t:this.instance_189},{t:this.instance_188},{t:this.instance_187},{t:this.instance_186},{t:this.instance_185},{t:this.instance_184}]},1).to({state:[]},24).wait(3));

	// Layer 1
	this.instance_244 = new lib.煙火7("synched",0);
	this.instance_244.setTransform(-62.4,56.8,0.467,0.467);

	this.instance_245 = new lib.煙火6("synched",0);
	this.instance_245.setTransform(-62.1,3.8,0.205,0.188,105);

	this.instance_246 = new lib.煙火6("synched",0);
	this.instance_246.setTransform(-62.1,3.8,0.205,0.188,75);

	this.instance_247 = new lib.煙火6("synched",0);
	this.instance_247.setTransform(-62.1,3.8,0.178,0.163,15);

	this.instance_248 = new lib.煙火6("synched",0);
	this.instance_248.setTransform(-62.1,3.8,0.191,0.175,-44.9);

	this.instance_249 = new lib.煙火6("synched",0);
	this.instance_249.setTransform(-62.1,3.8,0.191,0.175,-44.9);

	this.instance_250 = new lib.煙火6("synched",0);
	this.instance_250.setTransform(-62.1,3.8,0.173,0.159,-119.9);

	this.instance_251 = new lib.煙火6("synched",0);
	this.instance_251.setTransform(-62.1,3.8,0.2,0.184,180);

	this.instance_252 = new lib.煙火6("synched",0);
	this.instance_252.setTransform(-62.1,3.8,0.316,0.29,120);

	this.instance_253 = new lib.煙火6("synched",0);
	this.instance_253.setTransform(-62.1,3.8,0.263,0.241,150);

	this.instance_254 = new lib.煙火6("synched",0);
	this.instance_254.setTransform(-62.1,3.8,0.239,0.226,0,-179.9,180);

	this.instance_255 = new lib.煙火6("synched",0);
	this.instance_255.setTransform(-62.1,3.8,0.256,0.256,-149.9);

	this.instance_256 = new lib.煙火6("synched",0);
	this.instance_256.setTransform(-62.1,3.8,0.366,0.366,-119.9);

	this.instance_257 = new lib.煙火6("synched",0);
	this.instance_257.setTransform(-62.1,3.8,0.309,0.309,-74.9);

	this.instance_258 = new lib.煙火6("synched",0);
	this.instance_258.setTransform(-62,3.7,0.294,0.294,-14.9);

	this.instance_259 = new lib.煙火6("synched",0);
	this.instance_259.setTransform(-62,3.7,0.346,0.346,30);

	this.instance_260 = new lib.煙火6("synched",0);
	this.instance_260.setTransform(-62.1,3.8,0.246,0.226,45);

	this.instance_261 = new lib.煙火6("synched",0);
	this.instance_261.setTransform(-62.1,3.8,0.246,0.226,15);

	this.instance_262 = new lib.煙火6("synched",0);
	this.instance_262.setTransform(-62.1,3.8,0.214,0.196,-44.9);

	this.instance_263 = new lib.煙火6("synched",0);
	this.instance_263.setTransform(-62.1,3.8,0.229,0.211,-104.9);

	this.instance_264 = new lib.煙火6("synched",0);
	this.instance_264.setTransform(-62.1,3.8,0.229,0.211,-104.9);

	this.instance_265 = new lib.煙火6("synched",0);
	this.instance_265.setTransform(-62.1,3.8,0.209,0.191,0,-179.9,180);

	this.instance_266 = new lib.煙火6("synched",0);
	this.instance_266.setTransform(-62.1,3.8,0.241,0.221,120);

	this.instance_267 = new lib.煙火6("synched",0);
	this.instance_267.setTransform(-62.1,3.8,0.38,0.349,60);

	this.instance_268 = new lib.煙火6("synched",0);
	this.instance_268.setTransform(-62.1,3.8,0.317,0.291,90);

	this.instance_269 = new lib.煙火6("synched",0);
	this.instance_269.setTransform(-62.1,3.8,0.288,0.272,120);

	this.instance_270 = new lib.煙火6("synched",0);
	this.instance_270.setTransform(-62.1,3.8,0.308,0.308,150);

	this.instance_271 = new lib.煙火6("synched",0);
	this.instance_271.setTransform(-62.1,3.8,0.441,0.441,180);

	this.instance_272 = new lib.煙火6("synched",0);
	this.instance_272.setTransform(-62.1,3.8,0.371,0.371,-134.9);

	this.instance_273 = new lib.煙火6("synched",0);
	this.instance_273.setTransform(-62.1,3.8,0.354,0.354,-74.9);

	this.instance_274 = new lib.煙火6("synched",0);
	this.instance_274.setTransform(-62.1,3.8,0.416,0.416,-29.9);

	this.instance_275 = new lib.煙火6("synched",0);
	this.instance_275.setTransform(-62.1,3,0.343,0.315,135);

	this.instance_276 = new lib.煙火6("synched",0);
	this.instance_276.setTransform(-62.1,3,0.343,0.315,105);

	this.instance_277 = new lib.煙火6("synched",0);
	this.instance_277.setTransform(-62.1,3,0.298,0.274,45);

	this.instance_278 = new lib.煙火6("synched",0);
	this.instance_278.setTransform(-62.1,3,0.319,0.293,-14.9);

	this.instance_279 = new lib.煙火6("synched",0);
	this.instance_279.setTransform(-62.1,3,0.319,0.293,-14.9);

	this.instance_280 = new lib.煙火6("synched",0);
	this.instance_280.setTransform(-62.1,3,0.29,0.267,-89.9);

	this.instance_281 = new lib.煙火6("synched",0);
	this.instance_281.setTransform(-62.1,3,0.335,0.308,-149.9);

	this.instance_282 = new lib.煙火6("synched",0);
	this.instance_282.setTransform(-62.1,3,0.529,0.486,150);

	this.instance_283 = new lib.煙火6("synched",0);
	this.instance_283.setTransform(-62.1,3,0.441,0.405,-179.9);

	this.instance_284 = new lib.煙火6("synched",0);
	this.instance_284.setTransform(-62.1,3,0.401,0.379,-149.9);

	this.instance_285 = new lib.煙火6("synched",0);
	this.instance_285.setTransform(-62.1,3,0.429,0.429,-119.9);

	this.instance_286 = new lib.煙火6("synched",0);
	this.instance_286.setTransform(-62.1,3,0.614,0.614,-89.9);

	this.instance_287 = new lib.煙火6("synched",0);
	this.instance_287.setTransform(-62.1,3,0.517,0.517,-44.9);

	this.instance_288 = new lib.煙火6("synched",0);
	this.instance_288.setTransform(-62,3,0.493,0.493,15);

	this.instance_289 = new lib.煙火6("synched",0);
	this.instance_289.setTransform(-62,3,0.579,0.579,60);

	this.instance_290 = new lib.煙火6("synched",0);
	this.instance_290.setTransform(-62.1,3,0.413,0.379,75);

	this.instance_291 = new lib.煙火6("synched",0);
	this.instance_291.setTransform(-62.1,3,0.413,0.379,45);

	this.instance_292 = new lib.煙火6("synched",0);
	this.instance_292.setTransform(-62.1,3,0.359,0.329,-14.9);

	this.instance_293 = new lib.煙火6("synched",0);
	this.instance_293.setTransform(-62.1,3,0.384,0.353,-74.9);

	this.instance_294 = new lib.煙火6("synched",0);
	this.instance_294.setTransform(-62.1,3,0.384,0.353,-74.9);

	this.instance_295 = new lib.煙火6("synched",0);
	this.instance_295.setTransform(-62.1,3,0.349,0.321,-149.9);

	this.instance_296 = new lib.煙火6("synched",0);
	this.instance_296.setTransform(-62.1,3,0.403,0.37,150);

	this.instance_297 = new lib.煙火6("synched",0);
	this.instance_297.setTransform(-62.1,3,0.637,0.584,90);

	this.instance_298 = new lib.煙火6("synched",0);
	this.instance_298.setTransform(-62.1,3,0.531,0.487,120);

	this.instance_299 = new lib.煙火6("synched",0);
	this.instance_299.setTransform(-62.1,3,0.482,0.456,150);

	this.instance_300 = new lib.煙火6("synched",0);
	this.instance_300.setTransform(-62.1,3,0.517,0.517,-179.9);

	this.instance_301 = new lib.煙火6("synched",0);
	this.instance_301.setTransform(-62.1,3,0.738,0.738,-149.9);

	this.instance_302 = new lib.煙火6("synched",0);
	this.instance_302.setTransform(-62.1,3,0.622,0.622,-104.9);

	this.instance_303 = new lib.煙火6("synched",0);
	this.instance_303.setTransform(-62.1,3,0.593,0.593,-44.9);

	this.instance_304 = new lib.煙火6("synched",0);
	this.instance_304.setTransform(-62.1,3,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_244,p:{x:-62.4,y:56.8}}]},8).to({state:[{t:this.instance_244,p:{x:-62.3,y:50.8}}]},1).to({state:[{t:this.instance_244,p:{x:-62.3,y:44.8}}]},1).to({state:[{t:this.instance_244,p:{x:-62.2,y:38.8}}]},1).to({state:[{t:this.instance_244,p:{x:-62.2,y:32.9}}]},1).to({state:[{t:this.instance_244,p:{x:-62.2,y:26.9}}]},1).to({state:[{t:this.instance_244,p:{x:-62.1,y:20.9}}]},1).to({state:[{t:this.instance_244,p:{x:-62.1,y:14.9}}]},1).to({state:[{t:this.instance_244,p:{x:-62,y:9}}]},1).to({state:[{t:this.instance_244,p:{x:-62,y:3}}]},1).to({state:[{t:this.instance_304},{t:this.instance_303},{t:this.instance_302},{t:this.instance_301},{t:this.instance_300},{t:this.instance_299},{t:this.instance_298},{t:this.instance_297},{t:this.instance_296},{t:this.instance_295},{t:this.instance_294},{t:this.instance_293},{t:this.instance_292},{t:this.instance_291},{t:this.instance_290},{t:this.instance_289},{t:this.instance_288},{t:this.instance_287},{t:this.instance_286},{t:this.instance_285},{t:this.instance_284},{t:this.instance_283},{t:this.instance_282},{t:this.instance_281},{t:this.instance_280},{t:this.instance_279},{t:this.instance_278},{t:this.instance_277},{t:this.instance_276},{t:this.instance_275},{t:this.instance_274},{t:this.instance_273},{t:this.instance_272},{t:this.instance_271},{t:this.instance_270},{t:this.instance_269},{t:this.instance_268},{t:this.instance_267},{t:this.instance_266},{t:this.instance_265},{t:this.instance_264},{t:this.instance_263},{t:this.instance_262},{t:this.instance_261},{t:this.instance_260},{t:this.instance_259},{t:this.instance_258},{t:this.instance_257},{t:this.instance_256},{t:this.instance_255},{t:this.instance_254},{t:this.instance_253},{t:this.instance_252},{t:this.instance_251},{t:this.instance_250},{t:this.instance_249},{t:this.instance_248},{t:this.instance_247},{t:this.instance_246},{t:this.instance_245}]},1).to({state:[]},24).wait(2));

	// Layer 1
	this.instance_305 = new lib.煙火7("synched",0);
	this.instance_305.setTransform(-4.7,48.2,0.467,0.467);

	this.instance_306 = new lib.煙火6("synched",0);
	this.instance_306.setTransform(-4.4,-4.7,0.205,0.188,105);

	this.instance_307 = new lib.煙火6("synched",0);
	this.instance_307.setTransform(-4.4,-4.7,0.205,0.188,75);

	this.instance_308 = new lib.煙火6("synched",0);
	this.instance_308.setTransform(-4.4,-4.7,0.178,0.163,15);

	this.instance_309 = new lib.煙火6("synched",0);
	this.instance_309.setTransform(-4.4,-4.7,0.191,0.175,-44.9);

	this.instance_310 = new lib.煙火6("synched",0);
	this.instance_310.setTransform(-4.4,-4.7,0.191,0.175,-44.9);

	this.instance_311 = new lib.煙火6("synched",0);
	this.instance_311.setTransform(-4.4,-4.7,0.173,0.159,-119.9);

	this.instance_312 = new lib.煙火6("synched",0);
	this.instance_312.setTransform(-4.4,-4.7,0.2,0.184,180);

	this.instance_313 = new lib.煙火6("synched",0);
	this.instance_313.setTransform(-4.4,-4.7,0.316,0.29,120);

	this.instance_314 = new lib.煙火6("synched",0);
	this.instance_314.setTransform(-4.4,-4.7,0.263,0.241,150);

	this.instance_315 = new lib.煙火6("synched",0);
	this.instance_315.setTransform(-4.4,-4.7,0.239,0.226,0,-179.9,180);

	this.instance_316 = new lib.煙火6("synched",0);
	this.instance_316.setTransform(-4.4,-4.7,0.256,0.256,-149.9);

	this.instance_317 = new lib.煙火6("synched",0);
	this.instance_317.setTransform(-4.4,-4.7,0.366,0.366,-119.9);

	this.instance_318 = new lib.煙火6("synched",0);
	this.instance_318.setTransform(-4.4,-4.7,0.309,0.309,-74.9);

	this.instance_319 = new lib.煙火6("synched",0);
	this.instance_319.setTransform(-4.3,-4.8,0.294,0.294,-14.9);

	this.instance_320 = new lib.煙火6("synched",0);
	this.instance_320.setTransform(-4.3,-4.8,0.346,0.346,30);

	this.instance_321 = new lib.煙火6("synched",0);
	this.instance_321.setTransform(-4.4,-4.7,0.246,0.226,45);

	this.instance_322 = new lib.煙火6("synched",0);
	this.instance_322.setTransform(-4.4,-4.7,0.246,0.226,15);

	this.instance_323 = new lib.煙火6("synched",0);
	this.instance_323.setTransform(-4.4,-4.7,0.214,0.196,-44.9);

	this.instance_324 = new lib.煙火6("synched",0);
	this.instance_324.setTransform(-4.4,-4.7,0.229,0.211,-104.9);

	this.instance_325 = new lib.煙火6("synched",0);
	this.instance_325.setTransform(-4.4,-4.7,0.229,0.211,-104.9);

	this.instance_326 = new lib.煙火6("synched",0);
	this.instance_326.setTransform(-4.4,-4.7,0.209,0.191,0,-179.9,180);

	this.instance_327 = new lib.煙火6("synched",0);
	this.instance_327.setTransform(-4.4,-4.7,0.241,0.221,120);

	this.instance_328 = new lib.煙火6("synched",0);
	this.instance_328.setTransform(-4.4,-4.7,0.38,0.349,60);

	this.instance_329 = new lib.煙火6("synched",0);
	this.instance_329.setTransform(-4.4,-4.7,0.317,0.291,90);

	this.instance_330 = new lib.煙火6("synched",0);
	this.instance_330.setTransform(-4.4,-4.7,0.288,0.272,120);

	this.instance_331 = new lib.煙火6("synched",0);
	this.instance_331.setTransform(-4.4,-4.7,0.308,0.308,150);

	this.instance_332 = new lib.煙火6("synched",0);
	this.instance_332.setTransform(-4.4,-4.7,0.441,0.441,180);

	this.instance_333 = new lib.煙火6("synched",0);
	this.instance_333.setTransform(-4.4,-4.7,0.371,0.371,-134.9);

	this.instance_334 = new lib.煙火6("synched",0);
	this.instance_334.setTransform(-4.4,-4.7,0.354,0.354,-74.9);

	this.instance_335 = new lib.煙火6("synched",0);
	this.instance_335.setTransform(-4.4,-4.7,0.416,0.416,-29.9);

	this.instance_336 = new lib.煙火6("synched",0);
	this.instance_336.setTransform(-4.4,-5.5,0.343,0.315,135);

	this.instance_337 = new lib.煙火6("synched",0);
	this.instance_337.setTransform(-4.4,-5.5,0.343,0.315,105);

	this.instance_338 = new lib.煙火6("synched",0);
	this.instance_338.setTransform(-4.4,-5.5,0.298,0.274,45);

	this.instance_339 = new lib.煙火6("synched",0);
	this.instance_339.setTransform(-4.4,-5.5,0.319,0.293,-14.9);

	this.instance_340 = new lib.煙火6("synched",0);
	this.instance_340.setTransform(-4.4,-5.5,0.319,0.293,-14.9);

	this.instance_341 = new lib.煙火6("synched",0);
	this.instance_341.setTransform(-4.4,-5.5,0.29,0.267,-89.9);

	this.instance_342 = new lib.煙火6("synched",0);
	this.instance_342.setTransform(-4.4,-5.5,0.335,0.308,-149.9);

	this.instance_343 = new lib.煙火6("synched",0);
	this.instance_343.setTransform(-4.4,-5.5,0.529,0.486,150);

	this.instance_344 = new lib.煙火6("synched",0);
	this.instance_344.setTransform(-4.4,-5.5,0.441,0.405,-179.9);

	this.instance_345 = new lib.煙火6("synched",0);
	this.instance_345.setTransform(-4.4,-5.5,0.401,0.379,-149.9);

	this.instance_346 = new lib.煙火6("synched",0);
	this.instance_346.setTransform(-4.4,-5.5,0.429,0.429,-119.9);

	this.instance_347 = new lib.煙火6("synched",0);
	this.instance_347.setTransform(-4.4,-5.5,0.614,0.614,-89.9);

	this.instance_348 = new lib.煙火6("synched",0);
	this.instance_348.setTransform(-4.4,-5.5,0.517,0.517,-44.9);

	this.instance_349 = new lib.煙火6("synched",0);
	this.instance_349.setTransform(-4.3,-5.5,0.493,0.493,15);

	this.instance_350 = new lib.煙火6("synched",0);
	this.instance_350.setTransform(-4.3,-5.5,0.579,0.579,60);

	this.instance_351 = new lib.煙火6("synched",0);
	this.instance_351.setTransform(-4.4,-5.5,0.413,0.379,75);

	this.instance_352 = new lib.煙火6("synched",0);
	this.instance_352.setTransform(-4.4,-5.5,0.413,0.379,45);

	this.instance_353 = new lib.煙火6("synched",0);
	this.instance_353.setTransform(-4.4,-5.5,0.359,0.329,-14.9);

	this.instance_354 = new lib.煙火6("synched",0);
	this.instance_354.setTransform(-4.4,-5.5,0.384,0.353,-74.9);

	this.instance_355 = new lib.煙火6("synched",0);
	this.instance_355.setTransform(-4.4,-5.5,0.384,0.353,-74.9);

	this.instance_356 = new lib.煙火6("synched",0);
	this.instance_356.setTransform(-4.4,-5.5,0.349,0.321,-149.9);

	this.instance_357 = new lib.煙火6("synched",0);
	this.instance_357.setTransform(-4.4,-5.5,0.403,0.37,150);

	this.instance_358 = new lib.煙火6("synched",0);
	this.instance_358.setTransform(-4.4,-5.5,0.637,0.584,90);

	this.instance_359 = new lib.煙火6("synched",0);
	this.instance_359.setTransform(-4.4,-5.5,0.531,0.487,120);

	this.instance_360 = new lib.煙火6("synched",0);
	this.instance_360.setTransform(-4.4,-5.5,0.482,0.456,150);

	this.instance_361 = new lib.煙火6("synched",0);
	this.instance_361.setTransform(-4.4,-5.5,0.517,0.517,-179.9);

	this.instance_362 = new lib.煙火6("synched",0);
	this.instance_362.setTransform(-4.4,-5.5,0.738,0.738,-149.9);

	this.instance_363 = new lib.煙火6("synched",0);
	this.instance_363.setTransform(-4.4,-5.5,0.622,0.622,-104.9);

	this.instance_364 = new lib.煙火6("synched",0);
	this.instance_364.setTransform(-4.4,-5.5,0.593,0.593,-44.9);

	this.instance_365 = new lib.煙火6("synched",0);
	this.instance_365.setTransform(-4.4,-5.5,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_305,p:{x:-4.7,y:48.2}}]},9).to({state:[{t:this.instance_305,p:{x:-4.6,y:42.2}}]},1).to({state:[{t:this.instance_305,p:{x:-4.6,y:36.3}}]},1).to({state:[{t:this.instance_305,p:{x:-4.5,y:30.3}}]},1).to({state:[{t:this.instance_305,p:{x:-4.5,y:24.3}}]},1).to({state:[{t:this.instance_305,p:{x:-4.5,y:18.3}}]},1).to({state:[{t:this.instance_305,p:{x:-4.4,y:12.4}}]},1).to({state:[{t:this.instance_305,p:{x:-4.4,y:6.4}}]},1).to({state:[{t:this.instance_305,p:{x:-4.3,y:0.4}}]},1).to({state:[{t:this.instance_305,p:{x:-4.3,y:-5.5}}]},1).to({state:[{t:this.instance_365},{t:this.instance_364},{t:this.instance_363},{t:this.instance_362},{t:this.instance_361},{t:this.instance_360},{t:this.instance_359},{t:this.instance_358},{t:this.instance_357},{t:this.instance_356},{t:this.instance_355},{t:this.instance_354},{t:this.instance_353},{t:this.instance_352},{t:this.instance_351},{t:this.instance_350},{t:this.instance_349},{t:this.instance_348},{t:this.instance_347},{t:this.instance_346},{t:this.instance_345},{t:this.instance_344},{t:this.instance_343},{t:this.instance_342},{t:this.instance_341},{t:this.instance_340},{t:this.instance_339},{t:this.instance_338},{t:this.instance_337},{t:this.instance_336},{t:this.instance_335},{t:this.instance_334},{t:this.instance_333},{t:this.instance_332},{t:this.instance_331},{t:this.instance_330},{t:this.instance_329},{t:this.instance_328},{t:this.instance_327},{t:this.instance_326},{t:this.instance_325},{t:this.instance_324},{t:this.instance_323},{t:this.instance_322},{t:this.instance_321},{t:this.instance_320},{t:this.instance_319},{t:this.instance_318},{t:this.instance_317},{t:this.instance_316},{t:this.instance_315},{t:this.instance_314},{t:this.instance_313},{t:this.instance_312},{t:this.instance_311},{t:this.instance_310},{t:this.instance_309},{t:this.instance_308},{t:this.instance_307},{t:this.instance_306}]},1).to({state:[]},24).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(21.2,38.7,2.8,2.8);
...
(lib.男做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#990000").s().p("");
	this.shape_1.setTransform(110.8,215.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFE2C6").s().p("AhZA5QgUgSgPgUQgqg2AmgzQAGgKANgDQAJgDAJAAIBbgMQBcASAsBeQAbA4glAwQgIAJgOACQgUACgTAAQhWAAhEg6g");
	this.shape_2.setTransform(144.9,159.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFE2C6").s().p("Ah0BlQgNgEgHgKQgfg0Aig0QA4hXBdgGIBaAYQAIACAJAEQAMAFAFALQAfA3gxAwQgRASgXAPQg9AnhCAAQgjAAgkgKg");
	this.shape_3.setTransform(78.5,159.7,1,1,0,0,0,-0.3,0);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#FF9900").ss(3,1,1).p("APEItI+HAAIAAxZIeHAAg");
	this.shape_4.setTransform(109.5,215.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AvDItIAAxZIeHAAIAARZg");
	this.shape_5.setTransform(109.5,215.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]},14).wait(1));

	// 圖層 1
	this.instance = new lib.粉紅桌();
	this.instance.setTransform(114.8,233.7,0.947,1.103,0,0,0,114.4,48.6);

	this.instance_1 = new lib.西瓜弟弟做答();
	this.instance_1.setTransform(107,110.4,0.947,1.103);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1,p:{mode:"independent",startPosition:undefined}},{t:this.instance}]}).to({state:[{t:this.instance_1,p:{mode:"single",startPosition:14}},{t:this.instance}]},14).wait(1));
...
(lib.男做答5 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#990000").s().p("");
	this.shape_1.setTransform(110.1,215.2);
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#FF9900").ss(3,1,1).p("APEosIAARZI+HAAIAAxZg");
	this.shape_4.setTransform(109.5,215.5);
...
(lib.男做答4 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#990000").s().p("");
	this.shape_1.setTransform(116,214.9);
	...
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#FF9900").ss(3,1,1).p("AvDItIAAxZIeHAAIAARZg");
	this.shape_4.setTransform(109.5,215.5);
...
(lib.男做答3 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#CCCCCC").ss(10,1,1).p("AFLiCIlDEHAAICAIlSkE");
	this.shape_1.setTransform(112.6,215.6);
...
(lib.男做答2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(66.9,175.1,1.131,1.131);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.instance}]},14).wait(1));
...
(lib.題目 = function(mode,startPosition,loop) {
	...
	// 圖層 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFF00").s().p("");
	this.shape.setTransform(220.1,-207.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFF00").s().p("");
	this.shape_1.setTransform(220.2,-205.4);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFF00").s().p("");
	this.shape_2.setTransform(211.3,-202.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFF00").s().p("");
	this.shape_3.setTransform(221.9,-205.8);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#FFFF00").s().p("");
	this.shape_4.setTransform(221.9,-206.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[]},1).wait(1));
	...
	// 圖層 8
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("rgba(0,0,0,0.302)").s().p("");
	this.shape_5.setTransform(237.2,175.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5}]}).wait(7));
