...
(lib.game2 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(680.6,62.2);

	this.star = new lib.星星燈號組正式();
	this.star.setTransform(746.1,37.1,1,1,0,0,0,5.7,4);
	...
	this.instance_4.setTransform(879.6,58.6,1.998,1.636,0,0,0,140.3,15.7);
...
(lib.課程 = function() {
	...
	// 圖層 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
...
p.nominalBounds = new cjs.Rectangle(-76.3,-55,152.9,110.2);
...
p.nominalBounds = new cjs.Rectangle(-56.9,-30,114,60.1);
...
(lib.男2做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("一起按", "bold 40px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 45;
	this.text_1.lineWidth = 166;
	this.text_1.setTransform(104.7,209.1);

	this.text_2 = new cjs.Text("左右鍵", "bold 40px Microsoft JhengHei", "#990000");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 45;
	this.text_2.lineWidth = 166;
	this.text_2.setTransform(104.7,163.9);
...
(lib.女做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.text_1 = new cjs.Text("左鍵", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(112.7,181.5);
...
p.nominalBounds = new cjs.Rectangle(-175,-172.6,330.5,345.8);
...
(lib.煙花點 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(10).call(this.frame_10).wait(5).call(this.frame_15).wait(24).call(this.frame_39));

	// Layer 1
	this.instance = new lib.煙火7("synched",0);
	this.instance.setTransform(-21.5,48.5,0.467,0.467);

	this.instance_1 = new lib.煙火6("synched",0);
	this.instance_1.setTransform(-21.2,-4.5,0.205,0.188,105);

	this.instance_2 = new lib.煙火6("synched",0);
	this.instance_2.setTransform(-21.2,-4.5,0.205,0.188,75);

	this.instance_3 = new lib.煙火6("synched",0);
	this.instance_3.setTransform(-21.2,-4.5,0.178,0.163,15);

	this.instance_4 = new lib.煙火6("synched",0);
	this.instance_4.setTransform(-21.2,-4.5,0.191,0.175,-44.9);

	this.instance_5 = new lib.煙火6("synched",0);
	this.instance_5.setTransform(-21.2,-4.5,0.191,0.175,-44.9);

	this.instance_6 = new lib.煙火6("synched",0);
	this.instance_6.setTransform(-21.2,-4.5,0.173,0.159,-119.9);

	this.instance_7 = new lib.煙火6("synched",0);
	this.instance_7.setTransform(-21.2,-4.5,0.2,0.184,180);

	this.instance_8 = new lib.煙火6("synched",0);
	this.instance_8.setTransform(-21.2,-4.5,0.316,0.29,120);

	this.instance_9 = new lib.煙火6("synched",0);
	this.instance_9.setTransform(-21.2,-4.5,0.263,0.241,150);

	this.instance_10 = new lib.煙火6("synched",0);
	this.instance_10.setTransform(-21.2,-4.5,0.239,0.226,0,-179.9,180);

	this.instance_11 = new lib.煙火6("synched",0);
	this.instance_11.setTransform(-21.2,-4.5,0.256,0.256,-149.9);

	this.instance_12 = new lib.煙火6("synched",0);
	this.instance_12.setTransform(-21.2,-4.5,0.366,0.366,-119.9);

	this.instance_13 = new lib.煙火6("synched",0);
	this.instance_13.setTransform(-21.2,-4.5,0.309,0.309,-74.9);

	this.instance_14 = new lib.煙火6("synched",0);
	this.instance_14.setTransform(-21.1,-4.5,0.294,0.294,-14.9);

	this.instance_15 = new lib.煙火6("synched",0);
	this.instance_15.setTransform(-21.1,-4.5,0.346,0.346,30);

	this.instance_16 = new lib.煙火6("synched",0);
	this.instance_16.setTransform(-21.2,-4.5,0.246,0.226,45);

	this.instance_17 = new lib.煙火6("synched",0);
	this.instance_17.setTransform(-21.2,-4.5,0.246,0.226,15);

	this.instance_18 = new lib.煙火6("synched",0);
	this.instance_18.setTransform(-21.2,-4.5,0.214,0.196,-44.9);

	this.instance_19 = new lib.煙火6("synched",0);
	this.instance_19.setTransform(-21.2,-4.5,0.229,0.211,-104.9);

	this.instance_20 = new lib.煙火6("synched",0);
	this.instance_20.setTransform(-21.2,-4.5,0.229,0.211,-104.9);

	this.instance_21 = new lib.煙火6("synched",0);
	this.instance_21.setTransform(-21.2,-4.5,0.209,0.191,0,-179.9,180);

	this.instance_22 = new lib.煙火6("synched",0);
	this.instance_22.setTransform(-21.2,-4.5,0.241,0.221,120);

	this.instance_23 = new lib.煙火6("synched",0);
	this.instance_23.setTransform(-21.2,-4.5,0.38,0.349,60);

	this.instance_24 = new lib.煙火6("synched",0);
	this.instance_24.setTransform(-21.2,-4.5,0.317,0.291,90);

	this.instance_25 = new lib.煙火6("synched",0);
	this.instance_25.setTransform(-21.2,-4.5,0.288,0.272,120);

	this.instance_26 = new lib.煙火6("synched",0);
	this.instance_26.setTransform(-21.2,-4.5,0.308,0.308,150);

	this.instance_27 = new lib.煙火6("synched",0);
	this.instance_27.setTransform(-21.2,-4.5,0.441,0.441,180);

	this.instance_28 = new lib.煙火6("synched",0);
	this.instance_28.setTransform(-21.2,-4.5,0.371,0.371,-134.9);

	this.instance_29 = new lib.煙火6("synched",0);
	this.instance_29.setTransform(-21.2,-4.5,0.354,0.354,-74.9);

	this.instance_30 = new lib.煙火6("synched",0);
	this.instance_30.setTransform(-21.2,-4.5,0.416,0.416,-29.9);

	this.instance_31 = new lib.煙火6("synched",0);
	this.instance_31.setTransform(-21.2,-5.2,0.343,0.315,135);

	this.instance_32 = new lib.煙火6("synched",0);
	this.instance_32.setTransform(-21.2,-5.2,0.343,0.315,105);

	this.instance_33 = new lib.煙火6("synched",0);
	this.instance_33.setTransform(-21.2,-5.2,0.298,0.274,45);

	this.instance_34 = new lib.煙火6("synched",0);
	this.instance_34.setTransform(-21.2,-5.2,0.319,0.293,-14.9);

	this.instance_35 = new lib.煙火6("synched",0);
	this.instance_35.setTransform(-21.2,-5.2,0.319,0.293,-14.9);

	this.instance_36 = new lib.煙火6("synched",0);
	this.instance_36.setTransform(-21.2,-5.2,0.29,0.267,-89.9);

	this.instance_37 = new lib.煙火6("synched",0);
	this.instance_37.setTransform(-21.2,-5.2,0.335,0.308,-149.9);

	this.instance_38 = new lib.煙火6("synched",0);
	this.instance_38.setTransform(-21.2,-5.2,0.529,0.486,150);

	this.instance_39 = new lib.煙火6("synched",0);
	this.instance_39.setTransform(-21.2,-5.2,0.441,0.405,-179.9);

	this.instance_40 = new lib.煙火6("synched",0);
	this.instance_40.setTransform(-21.2,-5.2,0.401,0.379,-149.9);

	this.instance_41 = new lib.煙火6("synched",0);
	this.instance_41.setTransform(-21.2,-5.2,0.429,0.429,-119.9);

	this.instance_42 = new lib.煙火6("synched",0);
	this.instance_42.setTransform(-21.2,-5.2,0.614,0.614,-89.9);

	this.instance_43 = new lib.煙火6("synched",0);
	this.instance_43.setTransform(-21.2,-5.2,0.517,0.517,-44.9);

	this.instance_44 = new lib.煙火6("synched",0);
	this.instance_44.setTransform(-21.1,-5.2,0.493,0.493,15);

	this.instance_45 = new lib.煙火6("synched",0);
	this.instance_45.setTransform(-21.1,-5.2,0.579,0.579,60);

	this.instance_46 = new lib.煙火6("synched",0);
	this.instance_46.setTransform(-21.2,-5.2,0.413,0.379,75);

	this.instance_47 = new lib.煙火6("synched",0);
	this.instance_47.setTransform(-21.2,-5.2,0.413,0.379,45);

	this.instance_48 = new lib.煙火6("synched",0);
	this.instance_48.setTransform(-21.2,-5.2,0.359,0.329,-14.9);

	this.instance_49 = new lib.煙火6("synched",0);
	this.instance_49.setTransform(-21.2,-5.2,0.384,0.353,-74.9);

	this.instance_50 = new lib.煙火6("synched",0);
	this.instance_50.setTransform(-21.2,-5.2,0.384,0.353,-74.9);

	this.instance_51 = new lib.煙火6("synched",0);
	this.instance_51.setTransform(-21.2,-5.2,0.349,0.321,-149.9);

	this.instance_52 = new lib.煙火6("synched",0);
	this.instance_52.setTransform(-21.2,-5.2,0.403,0.37,150);

	this.instance_53 = new lib.煙火6("synched",0);
	this.instance_53.setTransform(-21.2,-5.2,0.637,0.584,90);

	this.instance_54 = new lib.煙火6("synched",0);
	this.instance_54.setTransform(-21.2,-5.2,0.531,0.487,120);

	this.instance_55 = new lib.煙火6("synched",0);
	this.instance_55.setTransform(-21.2,-5.2,0.482,0.456,150);

	this.instance_56 = new lib.煙火6("synched",0);
	this.instance_56.setTransform(-21.2,-5.2,0.517,0.517,-179.9);

	this.instance_57 = new lib.煙火6("synched",0);
	this.instance_57.setTransform(-21.2,-5.2,0.738,0.738,-149.9);

	this.instance_58 = new lib.煙火6("synched",0);
	this.instance_58.setTransform(-21.2,-5.2,0.622,0.622,-104.9);

	this.instance_59 = new lib.煙火6("synched",0);
	this.instance_59.setTransform(-21.2,-5.3,0.593,0.593,-44.9);

	this.instance_60 = new lib.煙火6("synched",0);
	this.instance_60.setTransform(-21.2,-5.3,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{x:-21.5,y:48.5}}]}).to({state:[{t:this.instance,p:{x:-21.4,y:42.5}}]},1).to({state:[{t:this.instance,p:{x:-21.4,y:36.5}}]},1).to({state:[{t:this.instance,p:{x:-21.3,y:30.5}}]},1).to({state:[{t:this.instance,p:{x:-21.3,y:24.6}}]},1).to({state:[{t:this.instance,p:{x:-21.3,y:18.6}}]},1).to({state:[{t:this.instance,p:{x:-21.2,y:12.6}}]},1).to({state:[{t:this.instance,p:{x:-21.2,y:6.6}}]},1).to({state:[{t:this.instance,p:{x:-21.1,y:0.7}}]},1).to({state:[{t:this.instance,p:{x:-21.1,y:-5.2}}]},1).to({state:[{t:this.instance_60},{t:this.instance_59},{t:this.instance_58},{t:this.instance_57},{t:this.instance_56},{t:this.instance_55},{t:this.instance_54},{t:this.instance_53},{t:this.instance_52},{t:this.instance_51},{t:this.instance_50},{t:this.instance_49},{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40},{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36},{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]},1).to({state:[]},24).wait(6));

	// Layer 1
	this.instance_61 = new lib.煙火7("synched",0);
	this.instance_61.setTransform(19.9,61.1,0.467,0.467);

	this.instance_62 = new lib.煙火6("synched",0);
	this.instance_62.setTransform(20.2,8.1,0.205,0.188,105);

	this.instance_63 = new lib.煙火6("synched",0);
	this.instance_63.setTransform(20.2,8.1,0.205,0.188,75);

	this.instance_64 = new lib.煙火6("synched",0);
	this.instance_64.setTransform(20.2,8.1,0.178,0.163,15);

	this.instance_65 = new lib.煙火6("synched",0);
	this.instance_65.setTransform(20.2,8.1,0.191,0.175,-44.9);

	this.instance_66 = new lib.煙火6("synched",0);
	this.instance_66.setTransform(20.2,8.1,0.191,0.175,-44.9);

	this.instance_67 = new lib.煙火6("synched",0);
	this.instance_67.setTransform(20.2,8.1,0.173,0.159,-119.9);

	this.instance_68 = new lib.煙火6("synched",0);
	this.instance_68.setTransform(20.2,8.1,0.2,0.184,180);

	this.instance_69 = new lib.煙火6("synched",0);
	this.instance_69.setTransform(20.2,8.1,0.316,0.29,120);

	this.instance_70 = new lib.煙火6("synched",0);
	this.instance_70.setTransform(20.2,8.1,0.263,0.241,150);

	this.instance_71 = new lib.煙火6("synched",0);
	this.instance_71.setTransform(20.2,8.1,0.239,0.226,0,-179.9,180);

	this.instance_72 = new lib.煙火6("synched",0);
	this.instance_72.setTransform(20.2,8.1,0.256,0.256,-149.9);

	this.instance_73 = new lib.煙火6("synched",0);
	this.instance_73.setTransform(20.2,8.1,0.366,0.366,-119.9);

	this.instance_74 = new lib.煙火6("synched",0);
	this.instance_74.setTransform(20.2,8.1,0.309,0.309,-74.9);

	this.instance_75 = new lib.煙火6("synched",0);
	this.instance_75.setTransform(20.3,8,0.294,0.294,-14.9);

	this.instance_76 = new lib.煙火6("synched",0);
	this.instance_76.setTransform(20.3,8,0.346,0.346,30);

	this.instance_77 = new lib.煙火6("synched",0);
	this.instance_77.setTransform(20.2,8.1,0.246,0.226,45);

	this.instance_78 = new lib.煙火6("synched",0);
	this.instance_78.setTransform(20.2,8.1,0.246,0.226,15);

	this.instance_79 = new lib.煙火6("synched",0);
	this.instance_79.setTransform(20.2,8.1,0.214,0.196,-44.9);

	this.instance_80 = new lib.煙火6("synched",0);
	this.instance_80.setTransform(20.2,8.1,0.229,0.211,-104.9);

	this.instance_81 = new lib.煙火6("synched",0);
	this.instance_81.setTransform(20.2,8.1,0.229,0.211,-104.9);

	this.instance_82 = new lib.煙火6("synched",0);
	this.instance_82.setTransform(20.2,8.1,0.209,0.191,0,-179.9,180);

	this.instance_83 = new lib.煙火6("synched",0);
	this.instance_83.setTransform(20.2,8.1,0.241,0.221,120);

	this.instance_84 = new lib.煙火6("synched",0);
	this.instance_84.setTransform(20.2,8.1,0.38,0.349,60);

	this.instance_85 = new lib.煙火6("synched",0);
	this.instance_85.setTransform(20.2,8.1,0.317,0.291,90);

	this.instance_86 = new lib.煙火6("synched",0);
	this.instance_86.setTransform(20.2,8.1,0.288,0.272,120);

	this.instance_87 = new lib.煙火6("synched",0);
	this.instance_87.setTransform(20.2,8.1,0.308,0.308,150);

	this.instance_88 = new lib.煙火6("synched",0);
	this.instance_88.setTransform(20.2,8.1,0.441,0.441,180);

	this.instance_89 = new lib.煙火6("synched",0);
	this.instance_89.setTransform(20.2,8.1,0.371,0.371,-134.9);

	this.instance_90 = new lib.煙火6("synched",0);
	this.instance_90.setTransform(20.2,8.1,0.354,0.354,-74.9);

	this.instance_91 = new lib.煙火6("synched",0);
	this.instance_91.setTransform(20.2,8.1,0.416,0.416,-29.9);

	this.instance_92 = new lib.煙火6("synched",0);
	this.instance_92.setTransform(20.2,7.3,0.343,0.315,135);

	this.instance_93 = new lib.煙火6("synched",0);
	this.instance_93.setTransform(20.2,7.3,0.343,0.315,105);

	this.instance_94 = new lib.煙火6("synched",0);
	this.instance_94.setTransform(20.2,7.3,0.298,0.274,45);

	this.instance_95 = new lib.煙火6("synched",0);
	this.instance_95.setTransform(20.2,7.3,0.319,0.293,-14.9);

	this.instance_96 = new lib.煙火6("synched",0);
	this.instance_96.setTransform(20.2,7.3,0.319,0.293,-14.9);

	this.instance_97 = new lib.煙火6("synched",0);
	this.instance_97.setTransform(20.2,7.3,0.29,0.267,-89.9);

	this.instance_98 = new lib.煙火6("synched",0);
	this.instance_98.setTransform(20.2,7.3,0.335,0.308,-149.9);

	this.instance_99 = new lib.煙火6("synched",0);
	this.instance_99.setTransform(20.2,7.3,0.529,0.486,150);

	this.instance_100 = new lib.煙火6("synched",0);
	this.instance_100.setTransform(20.2,7.3,0.441,0.405,-179.9);

	this.instance_101 = new lib.煙火6("synched",0);
	this.instance_101.setTransform(20.2,7.3,0.401,0.379,-149.9);

	this.instance_102 = new lib.煙火6("synched",0);
	this.instance_102.setTransform(20.2,7.3,0.429,0.429,-119.9);

	this.instance_103 = new lib.煙火6("synched",0);
	this.instance_103.setTransform(20.2,7.3,0.614,0.614,-89.9);

	this.instance_104 = new lib.煙火6("synched",0);
	this.instance_104.setTransform(20.2,7.3,0.517,0.517,-44.9);

	this.instance_105 = new lib.煙火6("synched",0);
	this.instance_105.setTransform(20.3,7.3,0.493,0.493,15);

	this.instance_106 = new lib.煙火6("synched",0);
	this.instance_106.setTransform(20.3,7.3,0.579,0.579,60);

	this.instance_107 = new lib.煙火6("synched",0);
	this.instance_107.setTransform(20.2,7.3,0.413,0.379,75);

	this.instance_108 = new lib.煙火6("synched",0);
	this.instance_108.setTransform(20.2,7.3,0.413,0.379,45);

	this.instance_109 = new lib.煙火6("synched",0);
	this.instance_109.setTransform(20.2,7.3,0.359,0.329,-14.9);

	this.instance_110 = new lib.煙火6("synched",0);
	this.instance_110.setTransform(20.2,7.3,0.384,0.353,-74.9);

	this.instance_111 = new lib.煙火6("synched",0);
	this.instance_111.setTransform(20.2,7.3,0.384,0.353,-74.9);

	this.instance_112 = new lib.煙火6("synched",0);
	this.instance_112.setTransform(20.2,7.3,0.349,0.321,-149.9);

	this.instance_113 = new lib.煙火6("synched",0);
	this.instance_113.setTransform(20.2,7.3,0.403,0.37,150);

	this.instance_114 = new lib.煙火6("synched",0);
	this.instance_114.setTransform(20.2,7.3,0.637,0.584,90);

	this.instance_115 = new lib.煙火6("synched",0);
	this.instance_115.setTransform(20.2,7.3,0.531,0.487,120);

	this.instance_116 = new lib.煙火6("synched",0);
	this.instance_116.setTransform(20.2,7.3,0.482,0.456,150);

	this.instance_117 = new lib.煙火6("synched",0);
	this.instance_117.setTransform(20.2,7.3,0.517,0.517,-179.9);

	this.instance_118 = new lib.煙火6("synched",0);
	this.instance_118.setTransform(20.2,7.3,0.738,0.738,-149.9);

	this.instance_119 = new lib.煙火6("synched",0);
	this.instance_119.setTransform(20.2,7.3,0.622,0.622,-104.9);

	this.instance_120 = new lib.煙火6("synched",0);
	this.instance_120.setTransform(20.2,7.3,0.593,0.593,-44.9);

	this.instance_121 = new lib.煙火6("synched",0);
	this.instance_121.setTransform(20.2,7.3,0.697,0.697);

	this.rest = new lib.重播鈕();
	this.rest.setTransform(-1.5,29.7,0.296,0.296);
	new cjs.ButtonHelper(this.rest, 0, 1, 2, false, new lib.重播鈕(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_61,p:{y:61.1,x:19.9}}]},5).to({state:[{t:this.instance_61,p:{y:55.1,x:19.9}}]},1).to({state:[{t:this.instance_61,p:{y:49.1,x:20}}]},1).to({state:[{t:this.instance_61,p:{y:43.1,x:20}}]},1).to({state:[{t:this.instance_61,p:{y:37.2,x:20.1}}]},1).to({state:[{t:this.instance_61,p:{y:31.2,x:20.1}}]},1).to({state:[{t:this.instance_61,p:{y:25.2,x:20.1}}]},1).to({state:[{t:this.instance_61,p:{y:19.2,x:20.2}}]},1).to({state:[{t:this.instance_61,p:{y:13.3,x:20.2}}]},1).to({state:[{t:this.instance_61,p:{y:7.3,x:20.3}}]},1).to({state:[{t:this.instance_121},{t:this.instance_120},{t:this.instance_119},{t:this.instance_118},{t:this.instance_117},{t:this.instance_116},{t:this.instance_115},{t:this.instance_114},{t:this.instance_113},{t:this.instance_112},{t:this.instance_111},{t:this.instance_110},{t:this.instance_109},{t:this.instance_108},{t:this.instance_107},{t:this.instance_106},{t:this.instance_105},{t:this.instance_104},{t:this.instance_103},{t:this.instance_102},{t:this.instance_101},{t:this.instance_100},{t:this.instance_99},{t:this.instance_98},{t:this.instance_97},{t:this.instance_96},{t:this.instance_95},{t:this.instance_94},{t:this.instance_93},{t:this.instance_92},{t:this.instance_91},{t:this.instance_90},{t:this.instance_89},{t:this.instance_88},{t:this.instance_87},{t:this.instance_86},{t:this.instance_85},{t:this.instance_84},{t:this.instance_83},{t:this.instance_82},{t:this.instance_81},{t:this.instance_80},{t:this.instance_79},{t:this.instance_78},{t:this.instance_77},{t:this.instance_76},{t:this.instance_75},{t:this.instance_74},{t:this.instance_73},{t:this.instance_72},{t:this.instance_71},{t:this.instance_70},{t:this.instance_69},{t:this.instance_68},{t:this.instance_67},{t:this.instance_66},{t:this.instance_65},{t:this.instance_64},{t:this.instance_63},{t:this.instance_62}]},1).to({state:[{t:this.rest}]},24).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-22.9,47.1,2.8,2.8);
...
(lib.男做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("右鍵", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(108.1,182.2);
...
(lib.男做答2 = function(mode,startPosition,loop) {
	...
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 166;
	this.text_1.setTransform(104.7,182.7);
...
(lib.題目 = function(mode,startPosition,loop) {
	...
	// 圖層 1
	this.text = new cjs.Text("哪個鍵？", "bold 48px Microsoft JhengHei", "#FFFF00");
	this.text.lineHeight = 53;
	this.text.lineWidth = 508;
	this.text.setTransform(-21.7,-208.3);

	this.text_1 = new cjs.Text("想點選物件，要按一下", "bold 48px Microsoft JhengHei", "#FFFF00");
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 508;
	this.text_1.setTransform(-21.7,-266.4);

	this.instance = new lib.file();
	this.instance.setTransform(361.2,-256.2,1.5,1.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.text_1,p:{text:"想點選物件，要按一下",lineWidth:508}},{t:this.text,p:{y:-208.3,text:"哪個鍵？",lineWidth:508}}]},1).to({state:[{t:this.text_1,p:{text:"想開啟工作列上的　，",lineWidth:508}},{t:this.text,p:{y:-214.7,text:"要按幾下左鍵？",lineWidth:508}},{t:this.instance}]},1).to({state:[{t:this.text_1,p:{text:"想開啟快捷功能表，要",lineWidth:500}},{t:this.text,p:{y:-209.8,text:"按一下哪個鍵？",lineWidth:500}}]},1).to({state:[{t:this.text_1,p:{text:"想移動物件，要按住哪",lineWidth:500}},{t:this.text,p:{y:-206.6,text:"個鍵拖曳？",lineWidth:500}}]},1).to({state:[{t:this.text_1,p:{text:"想複選物件，要按住哪",lineWidth:500}},{t:this.text,p:{y:-211.5,text:"個鍵來框選？",lineWidth:500}}]},1).to({state:[]},1).wait(1));

	// 圖層 2
	this.instance_1 = new lib.男2做答1("single",0);
	this.instance_1.setTransform(365,-82.8,0.9,0.9);

	this.instance_2 = new lib.男做答1("single",0);
	this.instance_2.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_3 = new lib.女做答1("single",0);
	this.instance_3.setTransform(-92.4,-81.1,0.9,0.9);

	this.instance_4 = new lib.男2做答2("single",14);
	this.instance_4.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_5 = new lib.男做答2("single",14);
	this.instance_5.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_6 = new lib.女做答2("single",15);
	this.instance_6.setTransform(-92.4,-82.9,0.9,0.9);

	this.instance_7 = new lib.男2做答3("single",14);
	this.instance_7.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_8 = new lib.男做答3("single",14);
	this.instance_8.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_9 = new lib.女做答3("single",15);
	this.instance_9.setTransform(-92.4,-82.9,0.9,0.9);

	this.instance_10 = new lib.男2做答4("single",14);
	this.instance_10.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_11 = new lib.男做答4("single",14);
	this.instance_11.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_12 = new lib.女做答4("single",15);
	this.instance_12.setTransform(-92.4,-82.9,0.9,0.9);

	this.instance_13 = new lib.男2做答5("single",14);
	this.instance_13.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_14 = new lib.男做答5("single",14);
	this.instance_14.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_15 = new lib.女做答5("single",15);
	this.instance_15.setTransform(-92.4,-82.9,0.9,0.9);

	this.instance_16 = new lib.男2做答6("single",14);
	this.instance_16.setTransform(364.9,-82.6,0.9,0.9);

	this.instance_17 = new lib.男做答6("single",14);
	this.instance_17.setTransform(135.8,-82.6,0.9,0.9);

	this.instance_18 = new lib.女做答6("single",15);
	this.instance_18.setTransform(-92.4,-82.9,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_3,p:{y:-81.1}},{t:this.instance_2},{t:this.instance_1,p:{x:365,y:-82.8}}]}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},1).to({state:[{t:this.instance_9},{t:this.instance_8},{t:this.instance_7}]},1).to({state:[{t:this.instance_12},{t:this.instance_11},{t:this.instance_10}]},1).to({state:[{t:this.instance_15},{t:this.instance_14},{t:this.instance_13}]},1).to({state:[{t:this.instance_18},{t:this.instance_17},{t:this.instance_16}]},1).to({state:[{t:this.instance_3,p:{y:-82.9}},{t:this.instance_2},{t:this.instance_1,p:{x:364.9,y:-82.6}}]},1).wait(1));
