...
(lib.課程 = function() {
	...
	// 圖層 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
...
(lib.男2做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("選取", "bold 48px Microsoft JhengHei", "#CC0000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.setTransform(108.4,180.1);
...
(lib.男2做答5 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.instance = new lib.img18();
	this.instance.setTransform(79.2,181.8,1.328,1.328);
...
(lib.男2做答3 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("WordPad", "bold 30px Microsoft JhengHei", "#CC0000");
	this.text_1.lineHeight = 35;
	this.text_1.setTransform(46.7,193.5);
...
(lib.男2做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("螢幕", "bold 48px Microsoft JhengHei", "#CC0000");
	this.text_1.lineHeight = 53;
...
(lib.女做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.text_1 = new cjs.Text("調整大小", "bold 48px Microsoft JhengHei", "#CC0000");
	this.text_1.lineHeight = 53;
	this.text_1.setTransform(16.6,180.1);
...
(lib.女做答5 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.instance = new lib.img16();
	this.instance.setTransform(75,180.1,1.328,1.328);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#CC6699").ss(3,1,1).p("AvEIpIAAxRIeJAAIAARRg");
	this.shape_2.setTransform(114.4,213.4);
...
(lib.女做答4 = function(mode,startPosition,loop) {
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#CC6699").ss(3,1,1).p("AvEooIeJAAIAARRI+JAAg");
	this.shape_2.setTransform(114.4,213.4);
...
(lib.女做答3 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.text_1 = new cjs.Text("PowerPoint", "bold 30px Microsoft JhengHei", "#CC0000");
	this.text_1.lineHeight = 35;
	this.text_1.setTransform(28.3,192.7);
...
(lib.女做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.text_1 = new cjs.Text("鍵盤", "bold 48px Microsoft JhengHei", "#CC0000");
	this.text_1.lineHeight = 53;
	this.text_1.setTransform(61.4,180.1);
...
(lib.煙花點 = function(mode,startPosition,loop) {
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(10).call(this.frame_10).wait(2).call(this.frame_12).wait(1).call(this.frame_13).wait(1).call(this.frame_14).wait(2).call(this.frame_16).wait(1).call(this.frame_17).wait(25).call(this.frame_42));

	// Layer 1
	this.instance = new lib.煙火7("synched",0);
	this.instance.setTransform(-0.1,51.9,0.467,0.467);

	this.instance_1 = new lib.煙火6("synched",0);
	this.instance_1.setTransform(0.1,-1.1,0.205,0.188,105);

	this.instance_2 = new lib.煙火6("synched",0);
	this.instance_2.setTransform(0.1,-1.1,0.205,0.188,75);

	this.instance_3 = new lib.煙火6("synched",0);
	this.instance_3.setTransform(0.1,-1.1,0.178,0.163,15);

	this.instance_4 = new lib.煙火6("synched",0);
	this.instance_4.setTransform(0.1,-1.1,0.191,0.175,-44.9);

	this.instance_5 = new lib.煙火6("synched",0);
	this.instance_5.setTransform(0.1,-1.1,0.191,0.175,-44.9);

	this.instance_6 = new lib.煙火6("synched",0);
	this.instance_6.setTransform(0.1,-1.1,0.173,0.159,-119.9);

	this.instance_7 = new lib.煙火6("synched",0);
	this.instance_7.setTransform(0.1,-1.1,0.2,0.184,180);

	this.instance_8 = new lib.煙火6("synched",0);
	this.instance_8.setTransform(0.1,-1.1,0.316,0.29,120);

	this.instance_9 = new lib.煙火6("synched",0);
	this.instance_9.setTransform(0.1,-1.1,0.263,0.241,150);

	this.instance_10 = new lib.煙火6("synched",0);
	this.instance_10.setTransform(0.1,-1.1,0.239,0.226,0,-179.9,180);

	this.instance_11 = new lib.煙火6("synched",0);
	this.instance_11.setTransform(0.1,-1.1,0.256,0.256,-149.9);

	this.instance_12 = new lib.煙火6("synched",0);
	this.instance_12.setTransform(0.1,-1.1,0.366,0.366,-119.9);

	this.instance_13 = new lib.煙火6("synched",0);
	this.instance_13.setTransform(0.1,-1.1,0.309,0.309,-74.9);

	this.instance_14 = new lib.煙火6("synched",0);
	this.instance_14.setTransform(0.2,-1.1,0.294,0.294,-14.9);

	this.instance_15 = new lib.煙火6("synched",0);
	this.instance_15.setTransform(0.2,-1.1,0.346,0.346,30);

	this.instance_16 = new lib.煙火6("synched",0);
	this.instance_16.setTransform(0.1,-1.1,0.246,0.226,45);

	this.instance_17 = new lib.煙火6("synched",0);
	this.instance_17.setTransform(0.1,-1.1,0.246,0.226,15);

	this.instance_18 = new lib.煙火6("synched",0);
	this.instance_18.setTransform(0.1,-1.1,0.214,0.196,-44.9);

	this.instance_19 = new lib.煙火6("synched",0);
	this.instance_19.setTransform(0.1,-1.1,0.229,0.211,-104.9);

	this.instance_20 = new lib.煙火6("synched",0);
	this.instance_20.setTransform(0.1,-1.1,0.229,0.211,-104.9);

	this.instance_21 = new lib.煙火6("synched",0);
	this.instance_21.setTransform(0.1,-1.1,0.209,0.191,0,-179.9,180);

	this.instance_22 = new lib.煙火6("synched",0);
	this.instance_22.setTransform(0.1,-1.1,0.241,0.221,120);

	this.instance_23 = new lib.煙火6("synched",0);
	this.instance_23.setTransform(0.1,-1.1,0.38,0.349,60);

	this.instance_24 = new lib.煙火6("synched",0);
	this.instance_24.setTransform(0.1,-1.1,0.317,0.291,90);

	this.instance_25 = new lib.煙火6("synched",0);
	this.instance_25.setTransform(0.1,-1.1,0.288,0.272,120);

	this.instance_26 = new lib.煙火6("synched",0);
	this.instance_26.setTransform(0.1,-1.1,0.308,0.308,150);

	this.instance_27 = new lib.煙火6("synched",0);
	this.instance_27.setTransform(0.1,-1.1,0.441,0.441,180);

	this.instance_28 = new lib.煙火6("synched",0);
	this.instance_28.setTransform(0.1,-1.1,0.371,0.371,-134.9);

	this.instance_29 = new lib.煙火6("synched",0);
	this.instance_29.setTransform(0.1,-1.1,0.354,0.354,-74.9);

	this.instance_30 = new lib.煙火6("synched",0);
	this.instance_30.setTransform(0.1,-1.1,0.416,0.416,-29.9);

	this.instance_31 = new lib.煙火6("synched",0);
	this.instance_31.setTransform(0.1,-1.8,0.343,0.315,135);

	this.instance_32 = new lib.煙火6("synched",0);
	this.instance_32.setTransform(0.1,-1.8,0.343,0.315,105);

	this.instance_33 = new lib.煙火6("synched",0);
	this.instance_33.setTransform(0.1,-1.8,0.298,0.274,45);

	this.instance_34 = new lib.煙火6("synched",0);
	this.instance_34.setTransform(0.1,-1.8,0.319,0.293,-14.9);

	this.instance_35 = new lib.煙火6("synched",0);
	this.instance_35.setTransform(0.1,-1.8,0.319,0.293,-14.9);

	this.instance_36 = new lib.煙火6("synched",0);
	this.instance_36.setTransform(0.1,-1.8,0.29,0.267,-89.9);

	this.instance_37 = new lib.煙火6("synched",0);
	this.instance_37.setTransform(0.1,-1.8,0.335,0.308,-149.9);

	this.instance_38 = new lib.煙火6("synched",0);
	this.instance_38.setTransform(0.1,-1.8,0.529,0.486,150);

	this.instance_39 = new lib.煙火6("synched",0);
	this.instance_39.setTransform(0.1,-1.8,0.441,0.405,-179.9);

	this.instance_40 = new lib.煙火6("synched",0);
	this.instance_40.setTransform(0.1,-1.8,0.401,0.379,-149.9);

	this.instance_41 = new lib.煙火6("synched",0);
	this.instance_41.setTransform(0.1,-1.8,0.429,0.429,-119.9);

	this.instance_42 = new lib.煙火6("synched",0);
	this.instance_42.setTransform(0.1,-1.8,0.614,0.614,-89.9);

	this.instance_43 = new lib.煙火6("synched",0);
	this.instance_43.setTransform(0.1,-1.8,0.517,0.517,-44.9);

	this.instance_44 = new lib.煙火6("synched",0);
	this.instance_44.setTransform(0.2,-1.8,0.493,0.493,15);

	this.instance_45 = new lib.煙火6("synched",0);
	this.instance_45.setTransform(0.2,-1.8,0.579,0.579,60);

	this.instance_46 = new lib.煙火6("synched",0);
	this.instance_46.setTransform(0.1,-1.8,0.413,0.379,75);

	this.instance_47 = new lib.煙火6("synched",0);
	this.instance_47.setTransform(0.1,-1.8,0.413,0.379,45);

	this.instance_48 = new lib.煙火6("synched",0);
	this.instance_48.setTransform(0.1,-1.8,0.359,0.329,-14.9);

	this.instance_49 = new lib.煙火6("synched",0);
	this.instance_49.setTransform(0.1,-1.8,0.384,0.353,-74.9);

	this.instance_50 = new lib.煙火6("synched",0);
	this.instance_50.setTransform(0.1,-1.8,0.384,0.353,-74.9);

	this.instance_51 = new lib.煙火6("synched",0);
	this.instance_51.setTransform(0.1,-1.8,0.349,0.321,-149.9);

	this.instance_52 = new lib.煙火6("synched",0);
	this.instance_52.setTransform(0.1,-1.8,0.403,0.37,150);

	this.instance_53 = new lib.煙火6("synched",0);
	this.instance_53.setTransform(0.1,-1.8,0.637,0.584,90);

	this.instance_54 = new lib.煙火6("synched",0);
	this.instance_54.setTransform(0.1,-1.8,0.531,0.487,120);

	this.instance_55 = new lib.煙火6("synched",0);
	this.instance_55.setTransform(0.1,-1.8,0.482,0.456,150);

	this.instance_56 = new lib.煙火6("synched",0);
	this.instance_56.setTransform(0.1,-1.8,0.517,0.517,-179.9);

	this.instance_57 = new lib.煙火6("synched",0);
	this.instance_57.setTransform(0.1,-1.8,0.738,0.738,-149.9);

	this.instance_58 = new lib.煙火6("synched",0);
	this.instance_58.setTransform(0.1,-1.8,0.622,0.622,-104.9);

	this.instance_59 = new lib.煙火6("synched",0);
	this.instance_59.setTransform(0.1,-1.9,0.593,0.593,-44.9);

	this.instance_60 = new lib.煙火6("synched",0);
	this.instance_60.setTransform(0.1,-1.9,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{y:51.9,x:-0.1}}]}).to({state:[{t:this.instance,p:{y:45.9,x:-0.1}}]},1).to({state:[{t:this.instance,p:{y:39.9,x:0}}]},1).to({state:[{t:this.instance,p:{y:33.9,x:0}}]},1).to({state:[{t:this.instance,p:{y:28,x:0}}]},1).to({state:[{t:this.instance,p:{y:22,x:0}}]},1).to({state:[{t:this.instance,p:{y:16,x:0}}]},1).to({state:[{t:this.instance,p:{y:10,x:0.1}}]},1).to({state:[{t:this.instance,p:{y:4.1,x:0.1}}]},1).to({state:[{t:this.instance,p:{y:-1.8,x:0.2}}]},1).to({state:[{t:this.instance_60},{t:this.instance_59},{t:this.instance_58},{t:this.instance_57},{t:this.instance_56},{t:this.instance_55},{t:this.instance_54},{t:this.instance_53},{t:this.instance_52},{t:this.instance_51},{t:this.instance_50},{t:this.instance_49},{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40},{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36},{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]},1).to({state:[]},24).wait(9));

	// Layer 1
	this.instance_61 = new lib.煙火7("synched",0);
	this.instance_61.setTransform(50.7,49.9,0.467,0.467);

	this.instance_62 = new lib.煙火6("synched",0);
	this.instance_62.setTransform(51,-3.1,0.205,0.188,105);

	this.instance_63 = new lib.煙火6("synched",0);
	this.instance_63.setTransform(51,-3.1,0.205,0.188,75);

	this.instance_64 = new lib.煙火6("synched",0);
	this.instance_64.setTransform(51,-3.1,0.178,0.163,15);

	this.instance_65 = new lib.煙火6("synched",0);
	this.instance_65.setTransform(51,-3.1,0.191,0.175,-44.9);

	this.instance_66 = new lib.煙火6("synched",0);
	this.instance_66.setTransform(51,-3.1,0.191,0.175,-44.9);

	this.instance_67 = new lib.煙火6("synched",0);
	this.instance_67.setTransform(51,-3.1,0.173,0.159,-119.9);

	this.instance_68 = new lib.煙火6("synched",0);
	this.instance_68.setTransform(51,-3.1,0.2,0.184,180);

	this.instance_69 = new lib.煙火6("synched",0);
	this.instance_69.setTransform(51,-3.1,0.316,0.29,120);

	this.instance_70 = new lib.煙火6("synched",0);
	this.instance_70.setTransform(51,-3.1,0.263,0.241,150);

	this.instance_71 = new lib.煙火6("synched",0);
	this.instance_71.setTransform(51,-3.1,0.239,0.226,0,-179.9,180);

	this.instance_72 = new lib.煙火6("synched",0);
	this.instance_72.setTransform(51,-3.1,0.256,0.256,-149.9);

	this.instance_73 = new lib.煙火6("synched",0);
	this.instance_73.setTransform(51,-3.1,0.366,0.366,-119.9);

	this.instance_74 = new lib.煙火6("synched",0);
	this.instance_74.setTransform(51,-3.1,0.309,0.309,-74.9);

	this.instance_75 = new lib.煙火6("synched",0);
	this.instance_75.setTransform(51.1,-3.1,0.294,0.294,-14.9);

	this.instance_76 = new lib.煙火6("synched",0);
	this.instance_76.setTransform(51.1,-3.1,0.346,0.346,30);

	this.instance_77 = new lib.煙火6("synched",0);
	this.instance_77.setTransform(51,-3.1,0.246,0.226,45);

	this.instance_78 = new lib.煙火6("synched",0);
	this.instance_78.setTransform(51,-3.1,0.246,0.226,15);

	this.instance_79 = new lib.煙火6("synched",0);
	this.instance_79.setTransform(51,-3.1,0.214,0.196,-44.9);

	this.instance_80 = new lib.煙火6("synched",0);
	this.instance_80.setTransform(51,-3.1,0.229,0.211,-104.9);

	this.instance_81 = new lib.煙火6("synched",0);
	this.instance_81.setTransform(51,-3.1,0.229,0.211,-104.9);

	this.instance_82 = new lib.煙火6("synched",0);
	this.instance_82.setTransform(51,-3.1,0.209,0.191,0,-179.9,180);

	this.instance_83 = new lib.煙火6("synched",0);
	this.instance_83.setTransform(51,-3.1,0.241,0.221,120);

	this.instance_84 = new lib.煙火6("synched",0);
	this.instance_84.setTransform(51,-3.1,0.38,0.349,60);

	this.instance_85 = new lib.煙火6("synched",0);
	this.instance_85.setTransform(51,-3.1,0.317,0.291,90);

	this.instance_86 = new lib.煙火6("synched",0);
	this.instance_86.setTransform(51,-3.1,0.288,0.272,120);

	this.instance_87 = new lib.煙火6("synched",0);
	this.instance_87.setTransform(51,-3.1,0.308,0.308,150);

	this.instance_88 = new lib.煙火6("synched",0);
	this.instance_88.setTransform(51,-3.1,0.441,0.441,180);

	this.instance_89 = new lib.煙火6("synched",0);
	this.instance_89.setTransform(51,-3.1,0.371,0.371,-134.9);

	this.instance_90 = new lib.煙火6("synched",0);
	this.instance_90.setTransform(51,-3.1,0.354,0.354,-74.9);

	this.instance_91 = new lib.煙火6("synched",0);
	this.instance_91.setTransform(51,-3.1,0.416,0.416,-29.9);

	this.instance_92 = new lib.煙火6("synched",0);
	this.instance_92.setTransform(51,-3.8,0.343,0.315,135);

	this.instance_93 = new lib.煙火6("synched",0);
	this.instance_93.setTransform(51,-3.8,0.343,0.315,105);

	this.instance_94 = new lib.煙火6("synched",0);
	this.instance_94.setTransform(51,-3.8,0.298,0.274,45);

	this.instance_95 = new lib.煙火6("synched",0);
	this.instance_95.setTransform(51,-3.8,0.319,0.293,-14.9);

	this.instance_96 = new lib.煙火6("synched",0);
	this.instance_96.setTransform(51,-3.8,0.319,0.293,-14.9);

	this.instance_97 = new lib.煙火6("synched",0);
	this.instance_97.setTransform(51,-3.8,0.29,0.267,-89.9);

	this.instance_98 = new lib.煙火6("synched",0);
	this.instance_98.setTransform(51,-3.8,0.335,0.308,-149.9);

	this.instance_99 = new lib.煙火6("synched",0);
	this.instance_99.setTransform(51,-3.8,0.529,0.486,150);

	this.instance_100 = new lib.煙火6("synched",0);
	this.instance_100.setTransform(51,-3.8,0.441,0.405,-179.9);

	this.instance_101 = new lib.煙火6("synched",0);
	this.instance_101.setTransform(51,-3.8,0.401,0.379,-149.9);

	this.instance_102 = new lib.煙火6("synched",0);
	this.instance_102.setTransform(51,-3.8,0.429,0.429,-119.9);

	this.instance_103 = new lib.煙火6("synched",0);
	this.instance_103.setTransform(51,-3.8,0.614,0.614,-89.9);

	this.instance_104 = new lib.煙火6("synched",0);
	this.instance_104.setTransform(51,-3.8,0.517,0.517,-44.9);

	this.instance_105 = new lib.煙火6("synched",0);
	this.instance_105.setTransform(51.1,-3.8,0.493,0.493,15);

	this.instance_106 = new lib.煙火6("synched",0);
	this.instance_106.setTransform(51.1,-3.8,0.579,0.579,60);

	this.instance_107 = new lib.煙火6("synched",0);
	this.instance_107.setTransform(51,-3.8,0.413,0.379,75);

	this.instance_108 = new lib.煙火6("synched",0);
	this.instance_108.setTransform(51,-3.8,0.413,0.379,45);

	this.instance_109 = new lib.煙火6("synched",0);
	this.instance_109.setTransform(51,-3.8,0.359,0.329,-14.9);

	this.instance_110 = new lib.煙火6("synched",0);
	this.instance_110.setTransform(51,-3.8,0.384,0.353,-74.9);

	this.instance_111 = new lib.煙火6("synched",0);
	this.instance_111.setTransform(51,-3.8,0.384,0.353,-74.9);

	this.instance_112 = new lib.煙火6("synched",0);
	this.instance_112.setTransform(51,-3.8,0.349,0.321,-149.9);

	this.instance_113 = new lib.煙火6("synched",0);
	this.instance_113.setTransform(51,-3.8,0.403,0.37,150);

	this.instance_114 = new lib.煙火6("synched",0);
	this.instance_114.setTransform(51,-3.8,0.637,0.584,90);

	this.instance_115 = new lib.煙火6("synched",0);
	this.instance_115.setTransform(51,-3.8,0.531,0.487,120);

	this.instance_116 = new lib.煙火6("synched",0);
	this.instance_116.setTransform(51,-3.8,0.482,0.456,150);

	this.instance_117 = new lib.煙火6("synched",0);
	this.instance_117.setTransform(51,-3.8,0.517,0.517,-179.9);

	this.instance_118 = new lib.煙火6("synched",0);
	this.instance_118.setTransform(51,-3.8,0.738,0.738,-149.9);

	this.instance_119 = new lib.煙火6("synched",0);
	this.instance_119.setTransform(51,-3.8,0.622,0.622,-104.9);

	this.instance_120 = new lib.煙火6("synched",0);
	this.instance_120.setTransform(51,-3.9,0.593,0.593,-44.9);

	this.instance_121 = new lib.煙火6("synched",0);
	this.instance_121.setTransform(51,-3.9,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_61,p:{y:49.9,x:50.7}}]},2).to({state:[{t:this.instance_61,p:{y:43.9,x:50.7}}]},1).to({state:[{t:this.instance_61,p:{y:37.9,x:50.8}}]},1).to({state:[{t:this.instance_61,p:{y:31.9,x:50.8}}]},1).to({state:[{t:this.instance_61,p:{y:26,x:50.9}}]},1).to({state:[{t:this.instance_61,p:{y:20,x:50.9}}]},1).to({state:[{t:this.instance_61,p:{y:14,x:50.9}}]},1).to({state:[{t:this.instance_61,p:{y:8,x:51}}]},1).to({state:[{t:this.instance_61,p:{y:2.1,x:51}}]},1).to({state:[{t:this.instance_61,p:{y:-3.8,x:51.1}}]},1).to({state:[{t:this.instance_121},{t:this.instance_120},{t:this.instance_119},{t:this.instance_118},{t:this.instance_117},{t:this.instance_116},{t:this.instance_115},{t:this.instance_114},{t:this.instance_113},{t:this.instance_112},{t:this.instance_111},{t:this.instance_110},{t:this.instance_109},{t:this.instance_108},{t:this.instance_107},{t:this.instance_106},{t:this.instance_105},{t:this.instance_104},{t:this.instance_103},{t:this.instance_102},{t:this.instance_101},{t:this.instance_100},{t:this.instance_99},{t:this.instance_98},{t:this.instance_97},{t:this.instance_96},{t:this.instance_95},{t:this.instance_94},{t:this.instance_93},{t:this.instance_92},{t:this.instance_91},{t:this.instance_90},{t:this.instance_89},{t:this.instance_88},{t:this.instance_87},{t:this.instance_86},{t:this.instance_85},{t:this.instance_84},{t:this.instance_83},{t:this.instance_82},{t:this.instance_81},{t:this.instance_80},{t:this.instance_79},{t:this.instance_78},{t:this.instance_77},{t:this.instance_76},{t:this.instance_75},{t:this.instance_74},{t:this.instance_73},{t:this.instance_72},{t:this.instance_71},{t:this.instance_70},{t:this.instance_69},{t:this.instance_68},{t:this.instance_67},{t:this.instance_66},{t:this.instance_65},{t:this.instance_64},{t:this.instance_63},{t:this.instance_62}]},1).to({state:[]},24).wait(7));

	// Layer 1
	this.instance_122 = new lib.煙火7("synched",0);
	this.instance_122.setTransform(-49.6,24.5,0.467,0.467);

	this.instance_123 = new lib.煙火6("synched",0);
	this.instance_123.setTransform(-49.3,-28.5,0.205,0.188,105);

	this.instance_124 = new lib.煙火6("synched",0);
	this.instance_124.setTransform(-49.3,-28.5,0.205,0.188,75);

	this.instance_125 = new lib.煙火6("synched",0);
	this.instance_125.setTransform(-49.3,-28.5,0.178,0.163,15);

	this.instance_126 = new lib.煙火6("synched",0);
	this.instance_126.setTransform(-49.3,-28.5,0.191,0.175,-44.9);

	this.instance_127 = new lib.煙火6("synched",0);
	this.instance_127.setTransform(-49.3,-28.5,0.191,0.175,-44.9);

	this.instance_128 = new lib.煙火6("synched",0);
	this.instance_128.setTransform(-49.3,-28.5,0.173,0.159,-119.9);

	this.instance_129 = new lib.煙火6("synched",0);
	this.instance_129.setTransform(-49.3,-28.5,0.2,0.184,180);

	this.instance_130 = new lib.煙火6("synched",0);
	this.instance_130.setTransform(-49.3,-28.5,0.316,0.29,120);

	this.instance_131 = new lib.煙火6("synched",0);
	this.instance_131.setTransform(-49.3,-28.5,0.263,0.241,150);

	this.instance_132 = new lib.煙火6("synched",0);
	this.instance_132.setTransform(-49.3,-28.5,0.239,0.226,0,-179.9,180);

	this.instance_133 = new lib.煙火6("synched",0);
	this.instance_133.setTransform(-49.3,-28.5,0.256,0.256,-149.9);

	this.instance_134 = new lib.煙火6("synched",0);
	this.instance_134.setTransform(-49.3,-28.5,0.366,0.366,-119.9);

	this.instance_135 = new lib.煙火6("synched",0);
	this.instance_135.setTransform(-49.3,-28.5,0.309,0.309,-74.9);

	this.instance_136 = new lib.煙火6("synched",0);
	this.instance_136.setTransform(-49.2,-28.5,0.294,0.294,-14.9);

	this.instance_137 = new lib.煙火6("synched",0);
	this.instance_137.setTransform(-49.2,-28.5,0.346,0.346,30);

	this.instance_138 = new lib.煙火6("synched",0);
	this.instance_138.setTransform(-49.3,-28.5,0.246,0.226,45);

	this.instance_139 = new lib.煙火6("synched",0);
	this.instance_139.setTransform(-49.3,-28.5,0.246,0.226,15);

	this.instance_140 = new lib.煙火6("synched",0);
	this.instance_140.setTransform(-49.3,-28.5,0.214,0.196,-44.9);

	this.instance_141 = new lib.煙火6("synched",0);
	this.instance_141.setTransform(-49.3,-28.5,0.229,0.211,-104.9);

	this.instance_142 = new lib.煙火6("synched",0);
	this.instance_142.setTransform(-49.3,-28.5,0.229,0.211,-104.9);

	this.instance_143 = new lib.煙火6("synched",0);
	this.instance_143.setTransform(-49.3,-28.5,0.209,0.191,0,-179.9,180);

	this.instance_144 = new lib.煙火6("synched",0);
	this.instance_144.setTransform(-49.3,-28.5,0.241,0.221,120);

	this.instance_145 = new lib.煙火6("synched",0);
	this.instance_145.setTransform(-49.3,-28.5,0.38,0.349,60);

	this.instance_146 = new lib.煙火6("synched",0);
	this.instance_146.setTransform(-49.3,-28.5,0.317,0.291,90);

	this.instance_147 = new lib.煙火6("synched",0);
	this.instance_147.setTransform(-49.3,-28.5,0.288,0.272,120);

	this.instance_148 = new lib.煙火6("synched",0);
	this.instance_148.setTransform(-49.3,-28.5,0.308,0.308,150);

	this.instance_149 = new lib.煙火6("synched",0);
	this.instance_149.setTransform(-49.3,-28.5,0.441,0.441,180);

	this.instance_150 = new lib.煙火6("synched",0);
	this.instance_150.setTransform(-49.3,-28.5,0.371,0.371,-134.9);

	this.instance_151 = new lib.煙火6("synched",0);
	this.instance_151.setTransform(-49.3,-28.5,0.354,0.354,-74.9);

	this.instance_152 = new lib.煙火6("synched",0);
	this.instance_152.setTransform(-49.3,-28.5,0.416,0.416,-29.9);

	this.instance_153 = new lib.煙火6("synched",0);
	this.instance_153.setTransform(-49.3,-29.2,0.343,0.315,135);

	this.instance_154 = new lib.煙火6("synched",0);
	this.instance_154.setTransform(-49.3,-29.2,0.343,0.315,105);

	this.instance_155 = new lib.煙火6("synched",0);
	this.instance_155.setTransform(-49.3,-29.2,0.298,0.274,45);

	this.instance_156 = new lib.煙火6("synched",0);
	this.instance_156.setTransform(-49.3,-29.2,0.319,0.293,-14.9);

	this.instance_157 = new lib.煙火6("synched",0);
	this.instance_157.setTransform(-49.3,-29.2,0.319,0.293,-14.9);

	this.instance_158 = new lib.煙火6("synched",0);
	this.instance_158.setTransform(-49.3,-29.2,0.29,0.267,-89.9);

	this.instance_159 = new lib.煙火6("synched",0);
	this.instance_159.setTransform(-49.3,-29.2,0.335,0.308,-149.9);

	this.instance_160 = new lib.煙火6("synched",0);
	this.instance_160.setTransform(-49.3,-29.2,0.529,0.486,150);

	this.instance_161 = new lib.煙火6("synched",0);
	this.instance_161.setTransform(-49.3,-29.2,0.441,0.405,-179.9);

	this.instance_162 = new lib.煙火6("synched",0);
	this.instance_162.setTransform(-49.3,-29.2,0.401,0.379,-149.9);

	this.instance_163 = new lib.煙火6("synched",0);
	this.instance_163.setTransform(-49.3,-29.2,0.429,0.429,-119.9);

	this.instance_164 = new lib.煙火6("synched",0);
	this.instance_164.setTransform(-49.3,-29.2,0.614,0.614,-89.9);

	this.instance_165 = new lib.煙火6("synched",0);
	this.instance_165.setTransform(-49.3,-29.2,0.517,0.517,-44.9);

	this.instance_166 = new lib.煙火6("synched",0);
	this.instance_166.setTransform(-49.2,-29.2,0.493,0.493,15);

	this.instance_167 = new lib.煙火6("synched",0);
	this.instance_167.setTransform(-49.2,-29.2,0.579,0.579,60);

	this.instance_168 = new lib.煙火6("synched",0);
	this.instance_168.setTransform(-49.3,-29.2,0.413,0.379,75);

	this.instance_169 = new lib.煙火6("synched",0);
	this.instance_169.setTransform(-49.3,-29.2,0.413,0.379,45);

	this.instance_170 = new lib.煙火6("synched",0);
	this.instance_170.setTransform(-49.3,-29.2,0.359,0.329,-14.9);

	this.instance_171 = new lib.煙火6("synched",0);
	this.instance_171.setTransform(-49.3,-29.2,0.384,0.353,-74.9);

	this.instance_172 = new lib.煙火6("synched",0);
	this.instance_172.setTransform(-49.3,-29.2,0.384,0.353,-74.9);

	this.instance_173 = new lib.煙火6("synched",0);
	this.instance_173.setTransform(-49.3,-29.2,0.349,0.321,-149.9);

	this.instance_174 = new lib.煙火6("synched",0);
	this.instance_174.setTransform(-49.3,-29.2,0.403,0.37,150);

	this.instance_175 = new lib.煙火6("synched",0);
	this.instance_175.setTransform(-49.3,-29.2,0.637,0.584,90);

	this.instance_176 = new lib.煙火6("synched",0);
	this.instance_176.setTransform(-49.3,-29.2,0.531,0.487,120);

	this.instance_177 = new lib.煙火6("synched",0);
	this.instance_177.setTransform(-49.3,-29.2,0.482,0.456,150);

	this.instance_178 = new lib.煙火6("synched",0);
	this.instance_178.setTransform(-49.3,-29.2,0.517,0.517,-179.9);

	this.instance_179 = new lib.煙火6("synched",0);
	this.instance_179.setTransform(-49.3,-29.2,0.738,0.738,-149.9);

	this.instance_180 = new lib.煙火6("synched",0);
	this.instance_180.setTransform(-49.3,-29.2,0.622,0.622,-104.9);

	this.instance_181 = new lib.煙火6("synched",0);
	this.instance_181.setTransform(-49.3,-29.3,0.593,0.593,-44.9);

	this.instance_182 = new lib.煙火6("synched",0);
	this.instance_182.setTransform(-49.3,-29.3,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_122,p:{x:-49.6,y:24.5}}]},3).to({state:[{t:this.instance_122,p:{x:-49.5,y:18.5}}]},1).to({state:[{t:this.instance_122,p:{x:-49.5,y:12.5}}]},1).to({state:[{t:this.instance_122,p:{x:-49.4,y:6.5}}]},1).to({state:[{t:this.instance_122,p:{x:-49.4,y:0.6}}]},1).to({state:[{t:this.instance_122,p:{x:-49.4,y:-5.3}}]},1).to({state:[{t:this.instance_122,p:{x:-49.3,y:-11.3}}]},1).to({state:[{t:this.instance_122,p:{x:-49.3,y:-17.3}}]},1).to({state:[{t:this.instance_122,p:{x:-49.2,y:-23.2}}]},1).to({state:[{t:this.instance_122,p:{x:-49.2,y:-29.2}}]},1).to({state:[{t:this.instance_182},{t:this.instance_181},{t:this.instance_180},{t:this.instance_179},{t:this.instance_178},{t:this.instance_177},{t:this.instance_176},{t:this.instance_175},{t:this.instance_174},{t:this.instance_173},{t:this.instance_172},{t:this.instance_171},{t:this.instance_170},{t:this.instance_169},{t:this.instance_168},{t:this.instance_167},{t:this.instance_166},{t:this.instance_165},{t:this.instance_164},{t:this.instance_163},{t:this.instance_162},{t:this.instance_161},{t:this.instance_160},{t:this.instance_159},{t:this.instance_158},{t:this.instance_157},{t:this.instance_156},{t:this.instance_155},{t:this.instance_154},{t:this.instance_153},{t:this.instance_152},{t:this.instance_151},{t:this.instance_150},{t:this.instance_149},{t:this.instance_148},{t:this.instance_147},{t:this.instance_146},{t:this.instance_145},{t:this.instance_144},{t:this.instance_143},{t:this.instance_142},{t:this.instance_141},{t:this.instance_140},{t:this.instance_139},{t:this.instance_138},{t:this.instance_137},{t:this.instance_136},{t:this.instance_135},{t:this.instance_134},{t:this.instance_133},{t:this.instance_132},{t:this.instance_131},{t:this.instance_130},{t:this.instance_129},{t:this.instance_128},{t:this.instance_127},{t:this.instance_126},{t:this.instance_125},{t:this.instance_124},{t:this.instance_123}]},1).to({state:[]},24).wait(6));

	// Layer 1
	this.instance_183 = new lib.煙火7("synched",0);
	this.instance_183.setTransform(-4.8,35.9,0.467,0.467);

	this.instance_184 = new lib.煙火6("synched",0);
	this.instance_184.setTransform(-4.5,-17.1,0.205,0.188,105);

	this.instance_185 = new lib.煙火6("synched",0);
	this.instance_185.setTransform(-4.5,-17.1,0.205,0.188,75);

	this.instance_186 = new lib.煙火6("synched",0);
	this.instance_186.setTransform(-4.5,-17.1,0.178,0.163,15);

	this.instance_187 = new lib.煙火6("synched",0);
	this.instance_187.setTransform(-4.5,-17.1,0.191,0.175,-44.9);

	this.instance_188 = new lib.煙火6("synched",0);
	this.instance_188.setTransform(-4.5,-17.1,0.191,0.175,-44.9);

	this.instance_189 = new lib.煙火6("synched",0);
	this.instance_189.setTransform(-4.5,-17.1,0.173,0.159,-119.9);

	this.instance_190 = new lib.煙火6("synched",0);
	this.instance_190.setTransform(-4.5,-17.1,0.2,0.184,180);

	this.instance_191 = new lib.煙火6("synched",0);
	this.instance_191.setTransform(-4.5,-17.1,0.316,0.29,120);

	this.instance_192 = new lib.煙火6("synched",0);
	this.instance_192.setTransform(-4.5,-17.1,0.263,0.241,150);

	this.instance_193 = new lib.煙火6("synched",0);
	this.instance_193.setTransform(-4.5,-17.1,0.239,0.226,0,-179.9,180);

	this.instance_194 = new lib.煙火6("synched",0);
	this.instance_194.setTransform(-4.5,-17.1,0.256,0.256,-149.9);

	this.instance_195 = new lib.煙火6("synched",0);
	this.instance_195.setTransform(-4.5,-17.1,0.366,0.366,-119.9);

	this.instance_196 = new lib.煙火6("synched",0);
	this.instance_196.setTransform(-4.5,-17.1,0.309,0.309,-74.9);

	this.instance_197 = new lib.煙火6("synched",0);
	this.instance_197.setTransform(-4.4,-17.1,0.294,0.294,-14.9);

	this.instance_198 = new lib.煙火6("synched",0);
	this.instance_198.setTransform(-4.4,-17.1,0.346,0.346,30);

	this.instance_199 = new lib.煙火6("synched",0);
	this.instance_199.setTransform(-4.5,-17.1,0.246,0.226,45);

	this.instance_200 = new lib.煙火6("synched",0);
	this.instance_200.setTransform(-4.5,-17.1,0.246,0.226,15);

	this.instance_201 = new lib.煙火6("synched",0);
	this.instance_201.setTransform(-4.5,-17.1,0.214,0.196,-44.9);

	this.instance_202 = new lib.煙火6("synched",0);
	this.instance_202.setTransform(-4.5,-17.1,0.229,0.211,-104.9);

	this.instance_203 = new lib.煙火6("synched",0);
	this.instance_203.setTransform(-4.5,-17.1,0.229,0.211,-104.9);

	this.instance_204 = new lib.煙火6("synched",0);
	this.instance_204.setTransform(-4.5,-17.1,0.209,0.191,0,-179.9,180);

	this.instance_205 = new lib.煙火6("synched",0);
	this.instance_205.setTransform(-4.5,-17.1,0.241,0.221,120);

	this.instance_206 = new lib.煙火6("synched",0);
	this.instance_206.setTransform(-4.5,-17.1,0.38,0.349,60);

	this.instance_207 = new lib.煙火6("synched",0);
	this.instance_207.setTransform(-4.5,-17.1,0.317,0.291,90);

	this.instance_208 = new lib.煙火6("synched",0);
	this.instance_208.setTransform(-4.5,-17.1,0.288,0.272,120);

	this.instance_209 = new lib.煙火6("synched",0);
	this.instance_209.setTransform(-4.5,-17.1,0.308,0.308,150);

	this.instance_210 = new lib.煙火6("synched",0);
	this.instance_210.setTransform(-4.5,-17.1,0.441,0.441,180);

	this.instance_211 = new lib.煙火6("synched",0);
	this.instance_211.setTransform(-4.5,-17.1,0.371,0.371,-134.9);

	this.instance_212 = new lib.煙火6("synched",0);
	this.instance_212.setTransform(-4.5,-17.1,0.354,0.354,-74.9);

	this.instance_213 = new lib.煙火6("synched",0);
	this.instance_213.setTransform(-4.5,-17.1,0.416,0.416,-29.9);

	this.instance_214 = new lib.煙火6("synched",0);
	this.instance_214.setTransform(-4.5,-17.8,0.343,0.315,135);

	this.instance_215 = new lib.煙火6("synched",0);
	this.instance_215.setTransform(-4.5,-17.8,0.343,0.315,105);

	this.instance_216 = new lib.煙火6("synched",0);
	this.instance_216.setTransform(-4.5,-17.8,0.298,0.274,45);

	this.instance_217 = new lib.煙火6("synched",0);
	this.instance_217.setTransform(-4.5,-17.8,0.319,0.293,-14.9);

	this.instance_218 = new lib.煙火6("synched",0);
	this.instance_218.setTransform(-4.5,-17.8,0.319,0.293,-14.9);

	this.instance_219 = new lib.煙火6("synched",0);
	this.instance_219.setTransform(-4.5,-17.8,0.29,0.267,-89.9);

	this.instance_220 = new lib.煙火6("synched",0);
	this.instance_220.setTransform(-4.5,-17.8,0.335,0.308,-149.9);

	this.instance_221 = new lib.煙火6("synched",0);
	this.instance_221.setTransform(-4.5,-17.8,0.529,0.486,150);

	this.instance_222 = new lib.煙火6("synched",0);
	this.instance_222.setTransform(-4.5,-17.8,0.441,0.405,-179.9);

	this.instance_223 = new lib.煙火6("synched",0);
	this.instance_223.setTransform(-4.5,-17.8,0.401,0.379,-149.9);

	this.instance_224 = new lib.煙火6("synched",0);
	this.instance_224.setTransform(-4.5,-17.8,0.429,0.429,-119.9);

	this.instance_225 = new lib.煙火6("synched",0);
	this.instance_225.setTransform(-4.5,-17.8,0.614,0.614,-89.9);

	this.instance_226 = new lib.煙火6("synched",0);
	this.instance_226.setTransform(-4.5,-17.8,0.517,0.517,-44.9);

	this.instance_227 = new lib.煙火6("synched",0);
	this.instance_227.setTransform(-4.4,-17.8,0.493,0.493,15);

	this.instance_228 = new lib.煙火6("synched",0);
	this.instance_228.setTransform(-4.4,-17.8,0.579,0.579,60);

	this.instance_229 = new lib.煙火6("synched",0);
	this.instance_229.setTransform(-4.5,-17.8,0.413,0.379,75);

	this.instance_230 = new lib.煙火6("synched",0);
	this.instance_230.setTransform(-4.5,-17.8,0.413,0.379,45);

	this.instance_231 = new lib.煙火6("synched",0);
	this.instance_231.setTransform(-4.5,-17.8,0.359,0.329,-14.9);

	this.instance_232 = new lib.煙火6("synched",0);
	this.instance_232.setTransform(-4.5,-17.8,0.384,0.353,-74.9);

	this.instance_233 = new lib.煙火6("synched",0);
	this.instance_233.setTransform(-4.5,-17.8,0.384,0.353,-74.9);

	this.instance_234 = new lib.煙火6("synched",0);
	this.instance_234.setTransform(-4.5,-17.8,0.349,0.321,-149.9);

	this.instance_235 = new lib.煙火6("synched",0);
	this.instance_235.setTransform(-4.5,-17.8,0.403,0.37,150);

	this.instance_236 = new lib.煙火6("synched",0);
	this.instance_236.setTransform(-4.5,-17.8,0.637,0.584,90);

	this.instance_237 = new lib.煙火6("synched",0);
	this.instance_237.setTransform(-4.5,-17.8,0.531,0.487,120);

	this.instance_238 = new lib.煙火6("synched",0);
	this.instance_238.setTransform(-4.5,-17.8,0.482,0.456,150);

	this.instance_239 = new lib.煙火6("synched",0);
	this.instance_239.setTransform(-4.5,-17.8,0.517,0.517,-179.9);

	this.instance_240 = new lib.煙火6("synched",0);
	this.instance_240.setTransform(-4.5,-17.8,0.738,0.738,-149.9);

	this.instance_241 = new lib.煙火6("synched",0);
	this.instance_241.setTransform(-4.5,-17.8,0.622,0.622,-104.9);

	this.instance_242 = new lib.煙火6("synched",0);
	this.instance_242.setTransform(-4.5,-17.9,0.593,0.593,-44.9);

	this.instance_243 = new lib.煙火6("synched",0);
	this.instance_243.setTransform(-4.5,-17.9,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_183,p:{x:-4.8,y:35.9}}]},4).to({state:[{t:this.instance_183,p:{x:-4.7,y:29.9}}]},1).to({state:[{t:this.instance_183,p:{x:-4.7,y:23.9}}]},1).to({state:[{t:this.instance_183,p:{x:-4.6,y:17.9}}]},1).to({state:[{t:this.instance_183,p:{x:-4.6,y:12}}]},1).to({state:[{t:this.instance_183,p:{x:-4.6,y:6}}]},1).to({state:[{t:this.instance_183,p:{x:-4.5,y:0}}]},1).to({state:[{t:this.instance_183,p:{x:-4.5,y:-5.9}}]},1).to({state:[{t:this.instance_183,p:{x:-4.4,y:-11.8}}]},1).to({state:[{t:this.instance_183,p:{x:-4.4,y:-17.8}}]},1).to({state:[{t:this.instance_243},{t:this.instance_242},{t:this.instance_241},{t:this.instance_240},{t:this.instance_239},{t:this.instance_238},{t:this.instance_237},{t:this.instance_236},{t:this.instance_235},{t:this.instance_234},{t:this.instance_233},{t:this.instance_232},{t:this.instance_231},{t:this.instance_230},{t:this.instance_229},{t:this.instance_228},{t:this.instance_227},{t:this.instance_226},{t:this.instance_225},{t:this.instance_224},{t:this.instance_223},{t:this.instance_222},{t:this.instance_221},{t:this.instance_220},{t:this.instance_219},{t:this.instance_218},{t:this.instance_217},{t:this.instance_216},{t:this.instance_215},{t:this.instance_214},{t:this.instance_213},{t:this.instance_212},{t:this.instance_211},{t:this.instance_210},{t:this.instance_209},{t:this.instance_208},{t:this.instance_207},{t:this.instance_206},{t:this.instance_205},{t:this.instance_204},{t:this.instance_203},{t:this.instance_202},{t:this.instance_201},{t:this.instance_200},{t:this.instance_199},{t:this.instance_198},{t:this.instance_197},{t:this.instance_196},{t:this.instance_195},{t:this.instance_194},{t:this.instance_193},{t:this.instance_192},{t:this.instance_191},{t:this.instance_190},{t:this.instance_189},{t:this.instance_188},{t:this.instance_187},{t:this.instance_186},{t:this.instance_185},{t:this.instance_184}]},1).to({state:[]},24).wait(5));

	// Layer 1
	this.instance_244 = new lib.煙火7("synched",0);
	this.instance_244.setTransform(-53.4,55.4,0.467,0.467);

	this.instance_245 = new lib.煙火6("synched",0);
	this.instance_245.setTransform(-53.1,2.4,0.205,0.188,105);

	this.instance_246 = new lib.煙火6("synched",0);
	this.instance_246.setTransform(-53.1,2.4,0.205,0.188,75);

	this.instance_247 = new lib.煙火6("synched",0);
	this.instance_247.setTransform(-53.1,2.4,0.178,0.163,15);

	this.instance_248 = new lib.煙火6("synched",0);
	this.instance_248.setTransform(-53.1,2.4,0.191,0.175,-44.9);

	this.instance_249 = new lib.煙火6("synched",0);
	this.instance_249.setTransform(-53.1,2.4,0.191,0.175,-44.9);

	this.instance_250 = new lib.煙火6("synched",0);
	this.instance_250.setTransform(-53.1,2.4,0.173,0.159,-119.9);

	this.instance_251 = new lib.煙火6("synched",0);
	this.instance_251.setTransform(-53.1,2.4,0.2,0.184,180);

	this.instance_252 = new lib.煙火6("synched",0);
	this.instance_252.setTransform(-53.1,2.4,0.316,0.29,120);

	this.instance_253 = new lib.煙火6("synched",0);
	this.instance_253.setTransform(-53.1,2.4,0.263,0.241,150);

	this.instance_254 = new lib.煙火6("synched",0);
	this.instance_254.setTransform(-53.1,2.4,0.239,0.226,0,-179.9,180);

	this.instance_255 = new lib.煙火6("synched",0);
	this.instance_255.setTransform(-53.1,2.4,0.256,0.256,-149.9);

	this.instance_256 = new lib.煙火6("synched",0);
	this.instance_256.setTransform(-53.1,2.4,0.366,0.366,-119.9);

	this.instance_257 = new lib.煙火6("synched",0);
	this.instance_257.setTransform(-53.1,2.4,0.309,0.309,-74.9);

	this.instance_258 = new lib.煙火6("synched",0);
	this.instance_258.setTransform(-53.1,2.4,0.294,0.294,-14.9);

	this.instance_259 = new lib.煙火6("synched",0);
	this.instance_259.setTransform(-53.1,2.4,0.346,0.346,30);

	this.instance_260 = new lib.煙火6("synched",0);
	this.instance_260.setTransform(-53.1,2.4,0.246,0.226,45);

	this.instance_261 = new lib.煙火6("synched",0);
	this.instance_261.setTransform(-53.1,2.4,0.246,0.226,15);

	this.instance_262 = new lib.煙火6("synched",0);
	this.instance_262.setTransform(-53.1,2.4,0.214,0.196,-44.9);

	this.instance_263 = new lib.煙火6("synched",0);
	this.instance_263.setTransform(-53.1,2.4,0.229,0.211,-104.9);

	this.instance_264 = new lib.煙火6("synched",0);
	this.instance_264.setTransform(-53.1,2.4,0.229,0.211,-104.9);

	this.instance_265 = new lib.煙火6("synched",0);
	this.instance_265.setTransform(-53.1,2.4,0.209,0.191,0,-179.9,180);

	this.instance_266 = new lib.煙火6("synched",0);
	this.instance_266.setTransform(-53.1,2.4,0.241,0.221,120);

	this.instance_267 = new lib.煙火6("synched",0);
	this.instance_267.setTransform(-53.1,2.4,0.38,0.349,60);

	this.instance_268 = new lib.煙火6("synched",0);
	this.instance_268.setTransform(-53.1,2.4,0.317,0.291,90);

	this.instance_269 = new lib.煙火6("synched",0);
	this.instance_269.setTransform(-53.1,2.4,0.288,0.272,120);

	this.instance_270 = new lib.煙火6("synched",0);
	this.instance_270.setTransform(-53.1,2.4,0.308,0.308,150);

	this.instance_271 = new lib.煙火6("synched",0);
	this.instance_271.setTransform(-53.1,2.4,0.441,0.441,180);

	this.instance_272 = new lib.煙火6("synched",0);
	this.instance_272.setTransform(-53.1,2.4,0.371,0.371,-134.9);

	this.instance_273 = new lib.煙火6("synched",0);
	this.instance_273.setTransform(-53.2,2.4,0.354,0.354,-74.9);

	this.instance_274 = new lib.煙火6("synched",0);
	this.instance_274.setTransform(-53.2,2.4,0.416,0.416,-29.9);

	this.instance_275 = new lib.煙火6("synched",0);
	this.instance_275.setTransform(-53.1,1.7,0.343,0.315,135);

	this.instance_276 = new lib.煙火6("synched",0);
	this.instance_276.setTransform(-53.1,1.7,0.343,0.315,105);

	this.instance_277 = new lib.煙火6("synched",0);
	this.instance_277.setTransform(-53.1,1.7,0.298,0.274,45);

	this.instance_278 = new lib.煙火6("synched",0);
	this.instance_278.setTransform(-53.1,1.7,0.319,0.293,-14.9);

	this.instance_279 = new lib.煙火6("synched",0);
	this.instance_279.setTransform(-53.1,1.7,0.319,0.293,-14.9);

	this.instance_280 = new lib.煙火6("synched",0);
	this.instance_280.setTransform(-53.1,1.7,0.29,0.267,-89.9);

	this.instance_281 = new lib.煙火6("synched",0);
	this.instance_281.setTransform(-53.1,1.7,0.335,0.308,-149.9);

	this.instance_282 = new lib.煙火6("synched",0);
	this.instance_282.setTransform(-53.1,1.7,0.529,0.486,150);

	this.instance_283 = new lib.煙火6("synched",0);
	this.instance_283.setTransform(-53.1,1.7,0.441,0.405,-179.9);

	this.instance_284 = new lib.煙火6("synched",0);
	this.instance_284.setTransform(-53.1,1.7,0.401,0.379,-149.9);

	this.instance_285 = new lib.煙火6("synched",0);
	this.instance_285.setTransform(-53.1,1.7,0.429,0.429,-119.9);

	this.instance_286 = new lib.煙火6("synched",0);
	this.instance_286.setTransform(-53.1,1.7,0.614,0.614,-89.9);

	this.instance_287 = new lib.煙火6("synched",0);
	this.instance_287.setTransform(-53.1,1.7,0.517,0.517,-44.9);

	this.instance_288 = new lib.煙火6("synched",0);
	this.instance_288.setTransform(-53.1,1.7,0.493,0.493,15);

	this.instance_289 = new lib.煙火6("synched",0);
	this.instance_289.setTransform(-53.1,1.7,0.579,0.579,60);

	this.instance_290 = new lib.煙火6("synched",0);
	this.instance_290.setTransform(-53.1,1.7,0.413,0.379,75);

	this.instance_291 = new lib.煙火6("synched",0);
	this.instance_291.setTransform(-53.1,1.7,0.413,0.379,45);

	this.instance_292 = new lib.煙火6("synched",0);
	this.instance_292.setTransform(-53.1,1.7,0.359,0.329,-14.9);

	this.instance_293 = new lib.煙火6("synched",0);
	this.instance_293.setTransform(-53.1,1.7,0.384,0.353,-74.9);

	this.instance_294 = new lib.煙火6("synched",0);
	this.instance_294.setTransform(-53.1,1.7,0.384,0.353,-74.9);

	this.instance_295 = new lib.煙火6("synched",0);
	this.instance_295.setTransform(-53.1,1.7,0.349,0.321,-149.9);

	this.instance_296 = new lib.煙火6("synched",0);
	this.instance_296.setTransform(-53.1,1.7,0.403,0.37,150);

	this.instance_297 = new lib.煙火6("synched",0);
	this.instance_297.setTransform(-53.1,1.7,0.637,0.584,90);

	this.instance_298 = new lib.煙火6("synched",0);
	this.instance_298.setTransform(-53.1,1.7,0.531,0.487,120);

	this.instance_299 = new lib.煙火6("synched",0);
	this.instance_299.setTransform(-53.1,1.7,0.482,0.456,150);

	this.instance_300 = new lib.煙火6("synched",0);
	this.instance_300.setTransform(-53.1,1.7,0.517,0.517,-179.9);

	this.instance_301 = new lib.煙火6("synched",0);
	this.instance_301.setTransform(-53.1,1.7,0.738,0.738,-149.9);

	this.instance_302 = new lib.煙火6("synched",0);
	this.instance_302.setTransform(-53.1,1.7,0.622,0.622,-104.9);

	this.instance_303 = new lib.煙火6("synched",0);
	this.instance_303.setTransform(-53.1,1.6,0.593,0.593,-44.9);

	this.instance_304 = new lib.煙火6("synched",0);
	this.instance_304.setTransform(-53.1,1.6,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_244,p:{y:55.4,x:-53.4}}]},6).to({state:[{t:this.instance_244,p:{y:49.4,x:-53.4}}]},1).to({state:[{t:this.instance_244,p:{y:43.5,x:-53.3}}]},1).to({state:[{t:this.instance_244,p:{y:37.5,x:-53.3}}]},1).to({state:[{t:this.instance_244,p:{y:31.5,x:-53.2}}]},1).to({state:[{t:this.instance_244,p:{y:25.5,x:-53.2}}]},1).to({state:[{t:this.instance_244,p:{y:19.6,x:-53.2}}]},1).to({state:[{t:this.instance_244,p:{y:13.6,x:-53.1}}]},1).to({state:[{t:this.instance_244,p:{y:7.6,x:-53.1}}]},1).to({state:[{t:this.instance_244,p:{y:1.7,x:-53.1}}]},1).to({state:[{t:this.instance_304},{t:this.instance_303},{t:this.instance_302},{t:this.instance_301},{t:this.instance_300},{t:this.instance_299},{t:this.instance_298},{t:this.instance_297},{t:this.instance_296},{t:this.instance_295},{t:this.instance_294},{t:this.instance_293},{t:this.instance_292},{t:this.instance_291},{t:this.instance_290},{t:this.instance_289},{t:this.instance_288},{t:this.instance_287},{t:this.instance_286},{t:this.instance_285},{t:this.instance_284},{t:this.instance_283},{t:this.instance_282},{t:this.instance_281},{t:this.instance_280},{t:this.instance_279},{t:this.instance_278},{t:this.instance_277},{t:this.instance_276},{t:this.instance_275},{t:this.instance_274},{t:this.instance_273},{t:this.instance_272},{t:this.instance_271},{t:this.instance_270},{t:this.instance_269},{t:this.instance_268},{t:this.instance_267},{t:this.instance_266},{t:this.instance_265},{t:this.instance_264},{t:this.instance_263},{t:this.instance_262},{t:this.instance_261},{t:this.instance_260},{t:this.instance_259},{t:this.instance_258},{t:this.instance_257},{t:this.instance_256},{t:this.instance_255},{t:this.instance_254},{t:this.instance_253},{t:this.instance_252},{t:this.instance_251},{t:this.instance_250},{t:this.instance_249},{t:this.instance_248},{t:this.instance_247},{t:this.instance_246},{t:this.instance_245}]},1).to({state:[]},25).wait(2));

	// Layer 1
	this.instance_305 = new lib.煙火7("synched",0);
	this.instance_305.setTransform(51.6,44.9,0.467,0.467);

	this.instance_306 = new lib.煙火6("synched",0);
	this.instance_306.setTransform(51.9,-8.1,0.205,0.188,105);

	this.instance_307 = new lib.煙火6("synched",0);
	this.instance_307.setTransform(51.9,-8.1,0.205,0.188,75);

	this.instance_308 = new lib.煙火6("synched",0);
	this.instance_308.setTransform(51.9,-8.1,0.178,0.163,15);

	this.instance_309 = new lib.煙火6("synched",0);
	this.instance_309.setTransform(51.9,-8.1,0.191,0.175,-44.9);

	this.instance_310 = new lib.煙火6("synched",0);
	this.instance_310.setTransform(51.9,-8.1,0.191,0.175,-44.9);

	this.instance_311 = new lib.煙火6("synched",0);
	this.instance_311.setTransform(51.9,-8.1,0.173,0.159,-119.9);

	this.instance_312 = new lib.煙火6("synched",0);
	this.instance_312.setTransform(51.9,-8.1,0.2,0.184,180);

	this.instance_313 = new lib.煙火6("synched",0);
	this.instance_313.setTransform(51.9,-8.1,0.316,0.29,120);

	this.instance_314 = new lib.煙火6("synched",0);
	this.instance_314.setTransform(51.9,-8.1,0.263,0.241,150);

	this.instance_315 = new lib.煙火6("synched",0);
	this.instance_315.setTransform(51.9,-8.1,0.239,0.226,0,-179.9,180);

	this.instance_316 = new lib.煙火6("synched",0);
	this.instance_316.setTransform(51.9,-8.1,0.256,0.256,-149.9);

	this.instance_317 = new lib.煙火6("synched",0);
	this.instance_317.setTransform(51.9,-8.1,0.366,0.366,-119.9);

	this.instance_318 = new lib.煙火6("synched",0);
	this.instance_318.setTransform(51.9,-8.1,0.309,0.309,-74.9);

	this.instance_319 = new lib.煙火6("synched",0);
	this.instance_319.setTransform(51.9,-8.1,0.294,0.294,-14.9);

	this.instance_320 = new lib.煙火6("synched",0);
	this.instance_320.setTransform(51.9,-8.1,0.346,0.346,30);

	this.instance_321 = new lib.煙火6("synched",0);
	this.instance_321.setTransform(51.9,-8.1,0.246,0.226,45);

	this.instance_322 = new lib.煙火6("synched",0);
	this.instance_322.setTransform(51.9,-8.1,0.246,0.226,15);

	this.instance_323 = new lib.煙火6("synched",0);
	this.instance_323.setTransform(51.9,-8.1,0.214,0.196,-44.9);

	this.instance_324 = new lib.煙火6("synched",0);
	this.instance_324.setTransform(51.9,-8.1,0.229,0.211,-104.9);

	this.instance_325 = new lib.煙火6("synched",0);
	this.instance_325.setTransform(51.9,-8.1,0.229,0.211,-104.9);

	this.instance_326 = new lib.煙火6("synched",0);
	this.instance_326.setTransform(51.9,-8.1,0.209,0.191,0,-179.9,180);

	this.instance_327 = new lib.煙火6("synched",0);
	this.instance_327.setTransform(51.9,-8.1,0.241,0.221,120);

	this.instance_328 = new lib.煙火6("synched",0);
	this.instance_328.setTransform(51.9,-8.1,0.38,0.349,60);

	this.instance_329 = new lib.煙火6("synched",0);
	this.instance_329.setTransform(51.9,-8.1,0.317,0.291,90);

	this.instance_330 = new lib.煙火6("synched",0);
	this.instance_330.setTransform(51.9,-8.1,0.288,0.272,120);

	this.instance_331 = new lib.煙火6("synched",0);
	this.instance_331.setTransform(51.9,-8.1,0.308,0.308,150);

	this.instance_332 = new lib.煙火6("synched",0);
	this.instance_332.setTransform(51.9,-8.1,0.441,0.441,180);

	this.instance_333 = new lib.煙火6("synched",0);
	this.instance_333.setTransform(51.9,-8.1,0.371,0.371,-134.9);

	this.instance_334 = new lib.煙火6("synched",0);
	this.instance_334.setTransform(51.8,-8.1,0.354,0.354,-74.9);

	this.instance_335 = new lib.煙火6("synched",0);
	this.instance_335.setTransform(51.8,-8.1,0.416,0.416,-29.9);

	this.instance_336 = new lib.煙火6("synched",0);
	this.instance_336.setTransform(51.9,-8.8,0.343,0.315,135);

	this.instance_337 = new lib.煙火6("synched",0);
	this.instance_337.setTransform(51.9,-8.8,0.343,0.315,105);

	this.instance_338 = new lib.煙火6("synched",0);
	this.instance_338.setTransform(51.9,-8.8,0.298,0.274,45);

	this.instance_339 = new lib.煙火6("synched",0);
	this.instance_339.setTransform(51.9,-8.8,0.319,0.293,-14.9);

	this.instance_340 = new lib.煙火6("synched",0);
	this.instance_340.setTransform(51.9,-8.8,0.319,0.293,-14.9);

	this.instance_341 = new lib.煙火6("synched",0);
	this.instance_341.setTransform(51.9,-8.8,0.29,0.267,-89.9);

	this.instance_342 = new lib.煙火6("synched",0);
	this.instance_342.setTransform(51.9,-8.8,0.335,0.308,-149.9);

	this.instance_343 = new lib.煙火6("synched",0);
	this.instance_343.setTransform(51.9,-8.8,0.529,0.486,150);

	this.instance_344 = new lib.煙火6("synched",0);
	this.instance_344.setTransform(51.9,-8.8,0.441,0.405,-179.9);

	this.instance_345 = new lib.煙火6("synched",0);
	this.instance_345.setTransform(51.9,-8.8,0.401,0.379,-149.9);

	this.instance_346 = new lib.煙火6("synched",0);
	this.instance_346.setTransform(51.9,-8.8,0.429,0.429,-119.9);

	this.instance_347 = new lib.煙火6("synched",0);
	this.instance_347.setTransform(51.9,-8.8,0.614,0.614,-89.9);

	this.instance_348 = new lib.煙火6("synched",0);
	this.instance_348.setTransform(51.9,-8.8,0.517,0.517,-44.9);

	this.instance_349 = new lib.煙火6("synched",0);
	this.instance_349.setTransform(51.9,-8.8,0.493,0.493,15);

	this.instance_350 = new lib.煙火6("synched",0);
	this.instance_350.setTransform(51.9,-8.8,0.579,0.579,60);

	this.instance_351 = new lib.煙火6("synched",0);
	this.instance_351.setTransform(51.9,-8.8,0.413,0.379,75);

	this.instance_352 = new lib.煙火6("synched",0);
	this.instance_352.setTransform(51.9,-8.8,0.413,0.379,45);

	this.instance_353 = new lib.煙火6("synched",0);
	this.instance_353.setTransform(51.9,-8.8,0.359,0.329,-14.9);

	this.instance_354 = new lib.煙火6("synched",0);
	this.instance_354.setTransform(51.9,-8.8,0.384,0.353,-74.9);

	this.instance_355 = new lib.煙火6("synched",0);
	this.instance_355.setTransform(51.9,-8.8,0.384,0.353,-74.9);

	this.instance_356 = new lib.煙火6("synched",0);
	this.instance_356.setTransform(51.9,-8.8,0.349,0.321,-149.9);

	this.instance_357 = new lib.煙火6("synched",0);
	this.instance_357.setTransform(51.9,-8.8,0.403,0.37,150);

	this.instance_358 = new lib.煙火6("synched",0);
	this.instance_358.setTransform(51.9,-8.8,0.637,0.584,90);

	this.instance_359 = new lib.煙火6("synched",0);
	this.instance_359.setTransform(51.9,-8.8,0.531,0.487,120);

	this.instance_360 = new lib.煙火6("synched",0);
	this.instance_360.setTransform(51.9,-8.8,0.482,0.456,150);

	this.instance_361 = new lib.煙火6("synched",0);
	this.instance_361.setTransform(51.9,-8.8,0.517,0.517,-179.9);

	this.instance_362 = new lib.煙火6("synched",0);
	this.instance_362.setTransform(51.9,-8.8,0.738,0.738,-149.9);

	this.instance_363 = new lib.煙火6("synched",0);
	this.instance_363.setTransform(51.9,-8.8,0.622,0.622,-104.9);

	this.instance_364 = new lib.煙火6("synched",0);
	this.instance_364.setTransform(51.9,-8.9,0.593,0.593,-44.9);

	this.instance_365 = new lib.煙火6("synched",0);
	this.instance_365.setTransform(51.9,-8.9,0.697,0.697);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_305,p:{y:44.9,x:51.6}}]},7).to({state:[{t:this.instance_305,p:{y:38.9,x:51.6}}]},1).to({state:[{t:this.instance_305,p:{y:32.9,x:51.6}}]},1).to({state:[{t:this.instance_305,p:{y:26.9,x:51.7}}]},1).to({state:[{t:this.instance_305,p:{y:21,x:51.7}}]},1).to({state:[{t:this.instance_305,p:{y:15,x:51.7}}]},1).to({state:[{t:this.instance_305,p:{y:9,x:51.8}}]},1).to({state:[{t:this.instance_305,p:{y:3,x:51.8}}]},1).to({state:[{t:this.instance_305,p:{y:-2.8,x:51.9}}]},1).to({state:[{t:this.instance_305,p:{y:-8.8,x:51.9}}]},1).to({state:[{t:this.instance_365},{t:this.instance_364},{t:this.instance_363},{t:this.instance_362},{t:this.instance_361},{t:this.instance_360},{t:this.instance_359},{t:this.instance_358},{t:this.instance_357},{t:this.instance_356},{t:this.instance_355},{t:this.instance_354},{t:this.instance_353},{t:this.instance_352},{t:this.instance_351},{t:this.instance_350},{t:this.instance_349},{t:this.instance_348},{t:this.instance_347},{t:this.instance_346},{t:this.instance_345},{t:this.instance_344},{t:this.instance_343},{t:this.instance_342},{t:this.instance_341},{t:this.instance_340},{t:this.instance_339},{t:this.instance_338},{t:this.instance_337},{t:this.instance_336},{t:this.instance_335},{t:this.instance_334},{t:this.instance_333},{t:this.instance_332},{t:this.instance_331},{t:this.instance_330},{t:this.instance_329},{t:this.instance_328},{t:this.instance_327},{t:this.instance_326},{t:this.instance_325},{t:this.instance_324},{t:this.instance_323},{t:this.instance_322},{t:this.instance_321},{t:this.instance_320},{t:this.instance_319},{t:this.instance_318},{t:this.instance_317},{t:this.instance_316},{t:this.instance_315},{t:this.instance_314},{t:this.instance_313},{t:this.instance_312},{t:this.instance_311},{t:this.instance_310},{t:this.instance_309},{t:this.instance_308},{t:this.instance_307},{t:this.instance_306}]},1).to({state:[]},25).wait(1));

	// Layer 1
	this.instance_366 = new lib.煙火7("synched",0);
	this.instance_366.setTransform(-9.4,43,0.467,0.467);

	this.instance_367 = new lib.煙火6("synched",0);
	this.instance_367.setTransform(-9.1,-9.9,0.205,0.188,105);

	this.instance_368 = new lib.煙火6("synched",0);
	this.instance_368.setTransform(-9.1,-9.9,0.205,0.188,75);

	this.instance_369 = new lib.煙火6("synched",0);
	this.instance_369.setTransform(-9.1,-9.9,0.178,0.163,15);

	this.instance_370 = new lib.煙火6("synched",0);
	this.instance_370.setTransform(-9.1,-9.9,0.191,0.175,-44.9);

	this.instance_371 = new lib.煙火6("synched",0);
	this.instance_371.setTransform(-9.1,-9.9,0.191,0.175,-44.9);

	this.instance_372 = new lib.煙火6("synched",0);
	this.instance_372.setTransform(-9.1,-9.9,0.173,0.159,-119.9);

	this.instance_373 = new lib.煙火6("synched",0);
	this.instance_373.setTransform(-9.1,-9.9,0.2,0.184,180);

	this.instance_374 = new lib.煙火6("synched",0);
	this.instance_374.setTransform(-9.1,-9.9,0.316,0.29,120);

	this.instance_375 = new lib.煙火6("synched",0);
	this.instance_375.setTransform(-9.1,-9.9,0.263,0.241,150);

	this.instance_376 = new lib.煙火6("synched",0);
	this.instance_376.setTransform(-9.1,-9.9,0.239,0.226,0,-179.9,180);

	this.instance_377 = new lib.煙火6("synched",0);
	this.instance_377.setTransform(-9.1,-9.9,0.256,0.256,-149.9);

	this.instance_378 = new lib.煙火6("synched",0);
	this.instance_378.setTransform(-9.1,-9.9,0.366,0.366,-119.9);

	this.instance_379 = new lib.煙火6("synched",0);
	this.instance_379.setTransform(-9.1,-9.9,0.309,0.309,-74.9);

	this.instance_380 = new lib.煙火6("synched",0);
	this.instance_380.setTransform(-9,-10,0.294,0.294,-14.9);

	this.instance_381 = new lib.煙火6("synched",0);
	this.instance_381.setTransform(-9,-10,0.346,0.346,30);

	this.instance_382 = new lib.煙火6("synched",0);
	this.instance_382.setTransform(-9.1,-9.9,0.246,0.226,45);

	this.instance_383 = new lib.煙火6("synched",0);
	this.instance_383.setTransform(-9.1,-9.9,0.246,0.226,15);

	this.instance_384 = new lib.煙火6("synched",0);
	this.instance_384.setTransform(-9.1,-9.9,0.214,0.196,-44.9);

	this.instance_385 = new lib.煙火6("synched",0);
	this.instance_385.setTransform(-9.1,-9.9,0.229,0.211,-104.9);

	this.instance_386 = new lib.煙火6("synched",0);
	this.instance_386.setTransform(-9.1,-9.9,0.229,0.211,-104.9);

	this.instance_387 = new lib.煙火6("synched",0);
	this.instance_387.setTransform(-9.1,-9.9,0.209,0.191,0,-179.9,180);

	this.instance_388 = new lib.煙火6("synched",0);
	this.instance_388.setTransform(-9.1,-9.9,0.241,0.221,120);

	this.instance_389 = new lib.煙火6("synched",0);
	this.instance_389.setTransform(-9.1,-9.9,0.38,0.349,60);

	this.instance_390 = new lib.煙火6("synched",0);
	this.instance_390.setTransform(-9.1,-9.9,0.317,0.291,90);

	this.instance_391 = new lib.煙火6("synched",0);
	this.instance_391.setTransform(-9.1,-9.9,0.288,0.272,120);

	this.instance_392 = new lib.煙火6("synched",0);
	this.instance_392.setTransform(-9.1,-9.9,0.308,0.308,150);

	this.instance_393 = new lib.煙火6("synched",0);
	this.instance_393.setTransform(-9.1,-9.9,0.441,0.441,180);

	this.instance_394 = new lib.煙火6("synched",0);
	this.instance_394.setTransform(-9.1,-9.9,0.371,0.371,-134.9);

	this.instance_395 = new lib.煙火6("synched",0);
	this.instance_395.setTransform(-9.1,-9.9,0.354,0.354,-74.9);

	this.instance_396 = new lib.煙火6("synched",0);
	this.instance_396.setTransform(-9.1,-9.9,0.416,0.416,-29.9);

	this.instance_397 = new lib.煙火6("synched",0);
	this.instance_397.setTransform(-9.1,-10.7,0.343,0.315,135);

	this.instance_398 = new lib.煙火6("synched",0);
	this.instance_398.setTransform(-9.1,-10.7,0.343,0.315,105);

	this.instance_399 = new lib.煙火6("synched",0);
	this.instance_399.setTransform(-9.1,-10.7,0.298,0.274,45);

	this.instance_400 = new lib.煙火6("synched",0);
	this.instance_400.setTransform(-9.1,-10.7,0.319,0.293,-14.9);

	this.instance_401 = new lib.煙火6("synched",0);
	this.instance_401.setTransform(-9.1,-10.7,0.319,0.293,-14.9);

	this.instance_402 = new lib.煙火6("synched",0);
	this.instance_402.setTransform(-9.1,-10.7,0.29,0.267,-89.9);

	this.instance_403 = new lib.煙火6("synched",0);
	this.instance_403.setTransform(-9.1,-10.7,0.335,0.308,-149.9);

	this.instance_404 = new lib.煙火6("synched",0);
	this.instance_404.setTransform(-9.1,-10.7,0.529,0.486,150);

	this.instance_405 = new lib.煙火6("synched",0);
	this.instance_405.setTransform(-9.1,-10.7,0.441,0.405,-179.9);

	this.instance_406 = new lib.煙火6("synched",0);
	this.instance_406.setTransform(-9.1,-10.7,0.401,0.379,-149.9);

	this.instance_407 = new lib.煙火6("synched",0);
	this.instance_407.setTransform(-9.1,-10.7,0.429,0.429,-119.9);

	this.instance_408 = new lib.煙火6("synched",0);
	this.instance_408.setTransform(-9.1,-10.7,0.614,0.614,-89.9);

	this.instance_409 = new lib.煙火6("synched",0);
	this.instance_409.setTransform(-9.1,-10.7,0.517,0.517,-44.9);

	this.instance_410 = new lib.煙火6("synched",0);
	this.instance_410.setTransform(-9,-10.7,0.493,0.493,15);

	this.instance_411 = new lib.煙火6("synched",0);
	this.instance_411.setTransform(-9,-10.7,0.579,0.579,60);

	this.instance_412 = new lib.煙火6("synched",0);
	this.instance_412.setTransform(-9.1,-10.7,0.413,0.379,75);

	this.instance_413 = new lib.煙火6("synched",0);
	this.instance_413.setTransform(-9.1,-10.7,0.413,0.379,45);

	this.instance_414 = new lib.煙火6("synched",0);
	this.instance_414.setTransform(-9.1,-10.7,0.359,0.329,-14.9);

	this.instance_415 = new lib.煙火6("synched",0);
	this.instance_415.setTransform(-9.1,-10.7,0.384,0.353,-74.9);

	this.instance_416 = new lib.煙火6("synched",0);
	this.instance_416.setTransform(-9.1,-10.7,0.384,0.353,-74.9);

	this.instance_417 = new lib.煙火6("synched",0);
	this.instance_417.setTransform(-9.1,-10.7,0.349,0.321,-149.9);

	this.instance_418 = new lib.煙火6("synched",0);
	this.instance_418.setTransform(-9.1,-10.7,0.403,0.37,150);

	this.instance_419 = new lib.煙火6("synched",0);
	this.instance_419.setTransform(-9.1,-10.7,0.637,0.584,90);

	this.instance_420 = new lib.煙火6("synched",0);
	this.instance_420.setTransform(-9.1,-10.7,0.531,0.487,120);

	this.instance_421 = new lib.煙火6("synched",0);
	this.instance_421.setTransform(-9.1,-10.7,0.482,0.456,150);

	this.instance_422 = new lib.煙火6("synched",0);
	this.instance_422.setTransform(-9.1,-10.7,0.517,0.517,-179.9);

	this.instance_423 = new lib.煙火6("synched",0);
	this.instance_423.setTransform(-9.1,-10.7,0.738,0.738,-149.9);

	this.instance_424 = new lib.煙火6("synched",0);
	this.instance_424.setTransform(-9.1,-10.7,0.622,0.622,-104.9);

	this.instance_425 = new lib.煙火6("synched",0);
	this.instance_425.setTransform(-9.1,-10.7,0.593,0.593,-44.9);

	this.instance_426 = new lib.煙火6("synched",0);
	this.instance_426.setTransform(-9.1,-10.7,0.697,0.697);

	this.rest = new lib.重播鈕();
	this.rest.setTransform(-1.5,29.7,0.296,0.296);
	new cjs.ButtonHelper(this.rest, 0, 1, 2, false, new lib.重播鈕(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_366,p:{x:-9.4,y:43}}]},7).to({state:[{t:this.instance_366,p:{x:-9.3,y:37}}]},1).to({state:[{t:this.instance_366,p:{x:-9.3,y:31.1}}]},1).to({state:[{t:this.instance_366,p:{x:-9.2,y:25.1}}]},1).to({state:[{t:this.instance_366,p:{x:-9.2,y:19.1}}]},1).to({state:[{t:this.instance_366,p:{x:-9.2,y:13.1}}]},1).to({state:[{t:this.instance_366,p:{x:-9.1,y:7.2}}]},1).to({state:[{t:this.instance_366,p:{x:-9.1,y:1.2}}]},1).to({state:[{t:this.instance_366,p:{x:-9,y:-4.7}}]},1).to({state:[{t:this.instance_366,p:{x:-9,y:-10.7}}]},1).to({state:[{t:this.instance_426},{t:this.instance_425},{t:this.instance_424},{t:this.instance_423},{t:this.instance_422},{t:this.instance_421},{t:this.instance_420},{t:this.instance_419},{t:this.instance_418},{t:this.instance_417},{t:this.instance_416},{t:this.instance_415},{t:this.instance_414},{t:this.instance_413},{t:this.instance_412},{t:this.instance_411},{t:this.instance_410},{t:this.instance_409},{t:this.instance_408},{t:this.instance_407},{t:this.instance_406},{t:this.instance_405},{t:this.instance_404},{t:this.instance_403},{t:this.instance_402},{t:this.instance_401},{t:this.instance_400},{t:this.instance_399},{t:this.instance_398},{t:this.instance_397},{t:this.instance_396},{t:this.instance_395},{t:this.instance_394},{t:this.instance_393},{t:this.instance_392},{t:this.instance_391},{t:this.instance_390},{t:this.instance_389},{t:this.instance_388},{t:this.instance_387},{t:this.instance_386},{t:this.instance_385},{t:this.instance_384},{t:this.instance_383},{t:this.instance_382},{t:this.instance_381},{t:this.instance_380},{t:this.instance_379},{t:this.instance_378},{t:this.instance_377},{t:this.instance_376},{t:this.instance_375},{t:this.instance_374},{t:this.instance_373},{t:this.instance_372},{t:this.instance_371},{t:this.instance_370},{t:this.instance_369},{t:this.instance_368},{t:this.instance_367}]},1).to({state:[{t:this.rest}]},25).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.4,20.6,2.8,2.8);
...
(lib.男做答6 = function(mode,startPosition,loop) {
	...
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.setTransform(107.9,180.1);
...
(lib.男做答5 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(77.6,178.4,1.328,1.328);
...
(lib.男做答3 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("小畫家", "bold 48px Microsoft JhengHei", "#CC0000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.setTransform(112.9,179.8);
...
(lib.男做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("滑鼠", "bold 48px Microsoft JhengHei", "#CC0000");
	this.text_1.lineHeight = 53;
	this.text_1.setTransform(61.4,180.1);
...
(lib.題目 = function(mode,startPosition,loop) {
	...
	// 圖層 1
	this.text = new cjs.Text("相當於【畫筆】？", "bold 48px Microsoft JhengHei", "#FFFF00");
	this.text.lineHeight = 53;
	this.text.lineWidth = 508;
	this.text.setTransform(-21.7,-217.6);

	this.text_1 = new cjs.Text("以電腦繪圖來說，什麼", "bold 48px Microsoft JhengHei", "#FFFF00");
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 508;
	this.text_1.setTransform(-21.7,-266.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.text_1,p:{text:"以電腦繪圖來說，什麼",lineWidth:508,x:-21.7}},{t:this.text,p:{y:-217.6,text:"相當於【畫筆】？",lineWidth:508,x:-21.7}}]},1).to({state:[{t:this.text_1,p:{text:"下面哪個是電腦繪圖軟",lineWidth:508,x:-21.7}},{t:this.text,p:{y:-214.7,text:"體？",lineWidth:508,x:-21.7}}]},1).to({state:[{t:this.text_1,p:{text:"想在區塊中填入色彩，",lineWidth:515,x:-21.7}},{t:this.text,p:{y:-209.8,text:"要用哪個工具？",lineWidth:500,x:-21.7}}]},1).to({state:[{t:this.text_1,p:{text:"想擦掉不要的線條(圖案)",lineWidth:515,x:-20.4}},{t:this.text,p:{y:-215.5,text:"要用？",lineWidth:500,x:-20.4}}]},1).to({state:[{t:this.text_1,p:{text:"想裁掉不要的畫布，可",lineWidth:500,x:-20.4}},{t:this.text,p:{y:-215.5,text:"以用？",lineWidth:500,x:-20.4}}]},1).to({state:[]},1).wait(1));
