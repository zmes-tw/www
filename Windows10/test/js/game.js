...
(lib.課程 = function() {
	...
	// 圖層 2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("");
...
(lib.播放標題面板 = function() {
	...
	// 圖層 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FF9900").ss(2,1,1).p("ASKCHQAlgmAAg1IAAhYQAAg1glgmQgkgmgzABMghlAAAQgzgBgkAmQglAmAAA1IAABYQAAA1AlAmQAkAmAzAAMAhlAAAQAzAAAkgmg");
...
p.nominalBounds = new cjs.Rectangle(-76.3,-23.9,152.9,110.2);
...
p.nominalBounds = new cjs.Rectangle(-56.9,-21.9,114,60.1);
...
(lib.男2做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("休息", "bold 36px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 41;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(109.9,211.4);

	this.text_2 = new cjs.Text("偶爾要", "bold 36px Microsoft JhengHei", "#990000");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 41;
	this.text_2.lineWidth = 173;
	this.text_2.setTransform(109.9,175.5);
...
(lib.男2做答5 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("橡皮擦", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(108.1,180.8);
...
(lib.男2做答4 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("掃描器", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 173;
...
(lib.男2做答3 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("睡眠時間", "bold 28px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 30;
	this.text_1.lineWidth = 167;
	this.text_1.setTransform(109.6,208.5);
	...
	this.text_2 = new cjs.Text("可以補充", "bold 28px Microsoft JhengHei", "#990000");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 30;
	this.text_2.lineWidth = 168;
	this.text_2.setTransform(109.6,178.6);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text_2},{t:this.instance_1},{t:this.instance},{t:this.text_1}]},14).wait(1));
...
(lib.男2做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("條碼掃描", "bold 40px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 45;
	this.text_1.lineWidth = 166;
	this.text_1.setTransform(104.7,189);
...
(lib.女做答6 = function(mode,startPosition,loop) {
	...
	this.text_1 = new cjs.Text("正確坐姿", "bold 40px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 45;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(112.7,189);
...
(lib.女做答5 = function(mode,startPosition,loop) {
	...
	this.text_1 = new cjs.Text("主機", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(109.9,180.8);
...
(lib.女做答4 = function(mode,startPosition,loop) {
	...
	this.text_1 = new cjs.Text("螢幕", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 173;
...
(lib.女做答3 = function(mode,startPosition,loop) {
	...
	this.text_1 = new cjs.Text("聽音樂、查資料", "bold 25px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 30;
	this.text_1.lineWidth = 186;
	this.text_1.setTransform(112.5,209.6);

	this.text_2 = new cjs.Text("可以寫作業、", "bold 25px Microsoft JhengHei", "#990000");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 30;
	this.text_2.lineWidth = 186;
	this.text_2.setTransform(112.5,180.6);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.text_2},{t:this.text_1},{t:this.shape}]},15).wait(1));
...
(lib.女做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.text_1 = new cjs.Text("布偶", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 173;
...
p.nominalBounds = new cjs.Rectangle(-164.9,-153.6,332.3,329.1);
...
p.nominalBounds = new cjs.Rectangle(-174.5,-174.5,349.2,349.2);
...
(lib.煙花點 = function(mode,startPosition,loop) {
	...
	this.frame_10 = function() {
		...
		this.parent.Rotation = Math.floor(Math.random()*360);
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(10).call(this.frame_10).wait(24).call(this.frame_34));

	// Layer 1
	this.instance = new lib.煙火7("synched",0);
	this.instance.setTransform(-0.2,53.8,0.467,0.467);

	this.instance_1 = new lib.煙火6("synched",0);
	this.instance_1.setTransform(0,0.8,0.205,0.188,105);

	this.instance_2 = new lib.煙火6("synched",0);
	this.instance_2.setTransform(0,0.8,0.205,0.188,75);

	this.instance_3 = new lib.煙火6("synched",0);
	this.instance_3.setTransform(0,0.8,0.178,0.163,15);

	this.instance_4 = new lib.煙火6("synched",0);
	this.instance_4.setTransform(0,0.8,0.191,0.175,-44.9);

	this.instance_5 = new lib.煙火6("synched",0);
	this.instance_5.setTransform(0,0.8,0.191,0.175,-44.9);

	this.instance_6 = new lib.煙火6("synched",0);
	this.instance_6.setTransform(0,0.8,0.173,0.159,-119.9);

	this.instance_7 = new lib.煙火6("synched",0);
	this.instance_7.setTransform(0,0.8,0.2,0.184,180);

	this.instance_8 = new lib.煙火6("synched",0);
	this.instance_8.setTransform(0,0.8,0.316,0.29,120);

	this.instance_9 = new lib.煙火6("synched",0);
	this.instance_9.setTransform(0,0.8,0.263,0.241,150);

	this.instance_10 = new lib.煙火6("synched",0);
	this.instance_10.setTransform(0,0.8,0.239,0.226,0,-179.9,180);

	this.instance_11 = new lib.煙火6("synched",0);
	this.instance_11.setTransform(0,0.8,0.256,0.256,-149.9);

	this.instance_12 = new lib.煙火6("synched",0);
	this.instance_12.setTransform(0,0.8,0.366,0.366,-119.9);

	this.instance_13 = new lib.煙火6("synched",0);
	this.instance_13.setTransform(0,0.8,0.309,0.309,-74.9);

	this.instance_14 = new lib.煙火6("synched",0);
	this.instance_14.setTransform(0.1,0.7,0.294,0.294,-14.9);

	this.instance_15 = new lib.煙火6("synched",0);
	this.instance_15.setTransform(0.1,0.7,0.346,0.346,30);

	this.instance_16 = new lib.煙火6("synched",0);
	this.instance_16.setTransform(0,0.8,0.246,0.226,45);

	this.instance_17 = new lib.煙火6("synched",0);
	this.instance_17.setTransform(0,0.8,0.246,0.226,15);

	this.instance_18 = new lib.煙火6("synched",0);
	this.instance_18.setTransform(0,0.8,0.214,0.196,-44.9);

	this.instance_19 = new lib.煙火6("synched",0);
	this.instance_19.setTransform(0,0.8,0.229,0.211,-104.9);

	this.instance_20 = new lib.煙火6("synched",0);
	this.instance_20.setTransform(0,0.8,0.229,0.211,-104.9);

	this.instance_21 = new lib.煙火6("synched",0);
	this.instance_21.setTransform(0,0.8,0.209,0.191,0,-179.9,180);

	this.instance_22 = new lib.煙火6("synched",0);
	this.instance_22.setTransform(0,0.8,0.241,0.221,120);

	this.instance_23 = new lib.煙火6("synched",0);
	this.instance_23.setTransform(0,0.8,0.38,0.349,60);

	this.instance_24 = new lib.煙火6("synched",0);
	this.instance_24.setTransform(0,0.8,0.317,0.291,90);

	this.instance_25 = new lib.煙火6("synched",0);
	this.instance_25.setTransform(0,0.8,0.288,0.272,120);

	this.instance_26 = new lib.煙火6("synched",0);
	this.instance_26.setTransform(0,0.8,0.308,0.308,150);

	this.instance_27 = new lib.煙火6("synched",0);
	this.instance_27.setTransform(0,0.8,0.441,0.441,180);

	this.instance_28 = new lib.煙火6("synched",0);
	this.instance_28.setTransform(0,0.8,0.371,0.371,-134.9);

	this.instance_29 = new lib.煙火6("synched",0);
	this.instance_29.setTransform(0,0.8,0.354,0.354,-74.9);

	this.instance_30 = new lib.煙火6("synched",0);
	this.instance_30.setTransform(0,0.8,0.416,0.416,-29.9);

	this.instance_31 = new lib.煙火6("synched",0);
	this.instance_31.setTransform(0,0,0.343,0.315,135);

	this.instance_32 = new lib.煙火6("synched",0);
	this.instance_32.setTransform(0,0,0.343,0.315,105);

	this.instance_33 = new lib.煙火6("synched",0);
	this.instance_33.setTransform(0,0,0.298,0.274,45);

	this.instance_34 = new lib.煙火6("synched",0);
	this.instance_34.setTransform(0,0,0.319,0.293,-14.9);

	this.instance_35 = new lib.煙火6("synched",0);
	this.instance_35.setTransform(0,0,0.319,0.293,-14.9);

	this.instance_36 = new lib.煙火6("synched",0);
	this.instance_36.setTransform(0,0,0.29,0.267,-89.9);

	this.instance_37 = new lib.煙火6("synched",0);
	this.instance_37.setTransform(0,0,0.335,0.308,-149.9);

	this.instance_38 = new lib.煙火6("synched",0);
	this.instance_38.setTransform(0,0,0.529,0.486,150);

	this.instance_39 = new lib.煙火6("synched",0);
	this.instance_39.setTransform(0,0,0.441,0.405,-179.9);

	this.instance_40 = new lib.煙火6("synched",0);
	this.instance_40.setTransform(0,0,0.401,0.379,-149.9);

	this.instance_41 = new lib.煙火6("synched",0);
	this.instance_41.setTransform(0,0,0.429,0.429,-119.9);

	this.instance_42 = new lib.煙火6("synched",0);
	this.instance_42.setTransform(0,0,0.614,0.614,-89.9);

	this.instance_43 = new lib.煙火6("synched",0);
	this.instance_43.setTransform(0,0,0.517,0.517,-44.9);

	this.instance_44 = new lib.煙火6("synched",0);
	this.instance_44.setTransform(0.1,0,0.493,0.493,15);

	this.instance_45 = new lib.煙火6("synched",0);
	this.instance_45.setTransform(0.1,0,0.579,0.579,60);

	this.instance_46 = new lib.煙火6("synched",0);
	this.instance_46.setTransform(0,0,0.413,0.379,75);

	this.instance_47 = new lib.煙火6("synched",0);
	this.instance_47.setTransform(0,0,0.413,0.379,45);

	this.instance_48 = new lib.煙火6("synched",0);
	this.instance_48.setTransform(0,0,0.359,0.329,-14.9);

	this.instance_49 = new lib.煙火6("synched",0);
	this.instance_49.setTransform(0,0,0.384,0.353,-74.9);

	this.instance_50 = new lib.煙火6("synched",0);
	this.instance_50.setTransform(0,0,0.384,0.353,-74.9);

	this.instance_51 = new lib.煙火6("synched",0);
	this.instance_51.setTransform(0,0,0.349,0.321,-149.9);

	this.instance_52 = new lib.煙火6("synched",0);
	this.instance_52.setTransform(0,0,0.403,0.37,150);

	this.instance_53 = new lib.煙火6("synched",0);
	this.instance_53.setTransform(0,0,0.637,0.584,90);

	this.instance_54 = new lib.煙火6("synched",0);
	this.instance_54.setTransform(0,0,0.531,0.487,120);

	this.instance_55 = new lib.煙火6("synched",0);
	this.instance_55.setTransform(0,0,0.482,0.456,150);

	this.instance_56 = new lib.煙火6("synched",0);
	this.instance_56.setTransform(0,0,0.517,0.517,-179.9);

	this.instance_57 = new lib.煙火6("synched",0);
	this.instance_57.setTransform(0,0,0.738,0.738,-149.9);

	this.instance_58 = new lib.煙火6("synched",0);
	this.instance_58.setTransform(0,0,0.622,0.622,-104.9);

	this.instance_59 = new lib.煙火6("synched",0);
	this.instance_59.setTransform(0,0,0.593,0.593,-44.9);

	this.instance_60 = new lib.煙火6("synched",0);
	this.instance_60.setTransform(0,0,0.697,0.697);

	this.rest = new lib.重播鈕();
	this.rest.setTransform(-1.5,29.7,0.296,0.296);
	new cjs.ButtonHelper(this.rest, 0, 1, 2, false, new lib.重播鈕(), 3);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance,p:{y:53.8,x:-0.2}}]}).to({state:[{t:this.instance,p:{y:47.8,x:-0.2}}]},1).to({state:[{t:this.instance,p:{y:41.8,x:-0.1}}]},1).to({state:[{t:this.instance,p:{y:35.8,x:-0.1}}]},1).to({state:[{t:this.instance,p:{y:29.9,x:0}}]},1).to({state:[{t:this.instance,p:{y:23.9,x:0}}]},1).to({state:[{t:this.instance,p:{y:17.9,x:0}}]},1).to({state:[{t:this.instance,p:{y:11.9,x:0}}]},1).to({state:[{t:this.instance,p:{y:6,x:0}}]},1).to({state:[{t:this.instance,p:{y:0,x:0.1}}]},1).to({state:[{t:this.instance_60},{t:this.instance_59},{t:this.instance_58},{t:this.instance_57},{t:this.instance_56},{t:this.instance_55},{t:this.instance_54},{t:this.instance_53},{t:this.instance_52},{t:this.instance_51},{t:this.instance_50},{t:this.instance_49},{t:this.instance_48},{t:this.instance_47},{t:this.instance_46},{t:this.instance_45},{t:this.instance_44},{t:this.instance_43},{t:this.instance_42},{t:this.instance_41},{t:this.instance_40},{t:this.instance_39},{t:this.instance_38},{t:this.instance_37},{t:this.instance_36},{t:this.instance_35},{t:this.instance_34},{t:this.instance_33},{t:this.instance_32},{t:this.instance_31},{t:this.instance_30},{t:this.instance_29},{t:this.instance_28},{t:this.instance_27},{t:this.instance_26},{t:this.instance_25},{t:this.instance_24},{t:this.instance_23},{t:this.instance_22},{t:this.instance_21},{t:this.instance_20},{t:this.instance_19},{t:this.instance_18},{t:this.instance_17},{t:this.instance_16},{t:this.instance_15},{t:this.instance_14},{t:this.instance_13},{t:this.instance_12},{t:this.instance_11},{t:this.instance_10},{t:this.instance_9},{t:this.instance_8},{t:this.instance_7},{t:this.instance_6},{t:this.instance_5},{t:this.instance_4},{t:this.instance_3},{t:this.instance_2},{t:this.instance_1}]},1).to({state:[{t:this.rest}]},24).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-1.6,52.4,2.8,2.8);
...
(lib.男做答6 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("開關", "bold 36px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 41;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(105.2,210.8);

	this.text_2 = new cjs.Text("亂按電腦", "bold 36px Microsoft JhengHei", "#990000");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 41;
	this.text_2.lineWidth = 173;
	this.text_2.setTransform(105.2,175.3);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.text_2},{t:this.text_1}]},14).wait(1));
...
(lib.男做答5 = function(mode,startPosition,loop) {
	...
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(108.1,181.5);
...
(lib.男做答4 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("遊戲搖桿", "bold 40px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 45;
	this.text_1.lineWidth = 173;
	this.text_1.setTransform(108.1,186.7);
...
(lib.男做答3 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("可以練舉重", "bold 36px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 41;
	this.text_1.lineWidth = 185;
	this.text_1.setTransform(105.4,188.7);
...
(lib.男做答2 = function(mode,startPosition,loop) {
	...
	// 圖層 2
	this.text_1 = new cjs.Text("鉛筆", "bold 48px Microsoft JhengHei", "#990000");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 166;
...
(lib.題目 = function(mode,startPosition,loop) {
	...
	// 圖層 1
	this.text = new cjs.Text("到電腦？", "bold 48px Microsoft JhengHei", "#FFFF00");
	this.text.lineHeight = 53;
	this.text.lineWidth = 508;
	this.text.setTransform(-21.7,-208.3);

	this.text_1 = new cjs.Text("以下哪一個東西有使用", "bold 48px Microsoft JhengHei", "#FFFF00");
	this.text_1.lineHeight = 53;
	this.text_1.lineWidth = 508;
	this.text_1.setTransform(-21.7,-266.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.text_1,p:{text:"以下哪一個東西有使用",lineWidth:508}},{t:this.text,p:{y:-208.3,text:"到電腦？",lineWidth:508}}]},1).to({state:[{t:this.text,p:{y:-266.4,text:"為什麼要學習電腦？",lineWidth:508}}]},1).to({state:[{t:this.text_1,p:{text:"下面哪個是桌上型電腦",lineWidth:500}},{t:this.text,p:{y:-209.8,text:"基本組合之一？",lineWidth:500}}]},1).to({state:[{t:this.text_1,p:{text:"下面哪個是電腦的周邊",lineWidth:500}},{t:this.text,p:{y:-206.6,text:"配備？",lineWidth:500}}]},1).to({state:[{t:this.text_1,p:{text:"使用電腦時，要避免什",lineWidth:500}},{t:this.text,p:{y:-211.5,text:"麼行為？",lineWidth:500}}]},1).to({state:[]},1).wait(1));
